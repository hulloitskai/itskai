...
export type CookieInput = {
  ...
  expirationDate?: InputMaybe<Scalars['Float']['input']>;
...
export type Mutation = {
  ...
  syncJournal: SyncJournalPayload;
  syncLocation: SyncLocationPayload;
...
export type MutationSyncJournalArgs = {
  input: SyncJournalInput;
};
...
/** Autogenerated input type of SyncJournal */
export type SyncJournalInput = {
  /** A unique identifier for the client performing the mutation. */
  clientMutationId?: InputMaybe<Scalars['String']['input']>;
};

/** Autogenerated return type of SyncJournal. */
export type SyncJournalPayload = {
...
export type SyncLocationPayload = {
