...
ActiveRecord::Schema[7.1].define(version: 2024_07_02_154139) do
  ...
  create_table "felt_devices", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    t.string "token"
    t.uuid "user_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["user_id"], name: "index_felt_devices_on_user_id"
  end

  create_table "felt_users", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    t.string "email", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["email"], name: "index_felt_users_on_email", unique: true
  end
  ...
  add_foreign_key "felt_devices", "felt_users", column: "user_id"
