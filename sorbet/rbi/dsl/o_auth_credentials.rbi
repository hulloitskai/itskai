...
class OAuthCredentials
  ...
  module CommonRelationMethods
    ...
    sig { params(block: T.nilable(T.proc.params(object: ::OAuthCredentials).void)).returns(::OAuthCredentials) }
    sig do
      params(
  ...
  module GeneratedAssociationRelationMethods
    ...
    sig do
      params(
        blk: T.proc.params(record: ::OAuthCredentials).returns(BasicObject)
      ).returns(T::Array[::OAuthCredentials])
    end
