...
class Post
  ...
  module GeneratedAssociationMethods
    ...
    sig { returns(::PostLink::PrivateCollectionProxy) }
    def links; end

    sig { params(value: T::Enumerable[::PostLink]).void }
    def links=(value); end
  ...
  module GeneratedAttributeMethods
    ...
    sig { returns(T.nilable(::String)) }
    def author_type_before_last_save; end

    sig { returns(T.untyped) }
    def author_type_before_type_cast; end

    sig { returns(T::Boolean) }
    def author_type_came_from_user?; end

    sig { returns(T.nilable([::String, ::String])) }
    def author_type_change; end

    sig { returns(T.nilable([::String, ::String])) }
    def author_type_change_to_be_saved; end

    sig { returns(T::Boolean) }
    def author_type_changed?; end

    sig { returns(T.nilable(::String)) }
    def author_type_in_database; end

    sig { returns(T.nilable([::String, ::String])) }
    def author_type_previous_change; end

    sig { returns(T::Boolean) }
    def author_type_previously_changed?; end

    sig { returns(T.nilable(::String)) }
    def author_type_previously_was; end

    sig { returns(T.nilable(::String)) }
    def author_type_was; end

    sig { void }
    def author_type_will_change!; end
    ...
    sig { returns(T::Boolean) }
    def pinned_at_previously_changed?; end
    ...
    sig { returns(T.nilable([::String, ::String])) }
    def saved_change_to_author_type; end
    ...
    sig { returns(T::Boolean) }
    def will_save_change_to_author_type?; end
