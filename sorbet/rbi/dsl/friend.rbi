...
class Friend
  ...
  module GeneratedAssociationMethods
    ...
    sig { returns(T::Array[T.untyped]) }
    def vibecheck_ids; end

    sig { params(ids: T::Array[T.untyped]).returns(T::Array[T.untyped]) }
    def vibecheck_ids=(ids); end

    # This method is created by ActiveRecord on the `Friend` class because it declared `has_many :vibechecks`.
    # 🔗 [Rails guide for `has_many` association](https://guides.rubyonrails.org/association_basics.html#the-has-many-association)
    sig { returns(::FriendVibecheck::PrivateCollectionProxy) }
    def vibechecks; end

    sig { params(value: T::Enumerable[::FriendVibecheck]).void }
    def vibechecks=(value); end
  end
