...
class GoodJob::Setting
  ...
  module CommonRelationMethods
    ...
    sig { params(block: T.nilable(T.proc.params(object: ::GoodJob::Setting).void)).returns(::GoodJob::Setting) }
    sig do
      params(
  ...
  module GeneratedAssociationRelationMethods
    ...
    sig do
      params(
        blk: T.proc.params(record: ::GoodJob::Setting).returns(BasicObject)
      ).returns(T::Array[::GoodJob::Setting])
    end
