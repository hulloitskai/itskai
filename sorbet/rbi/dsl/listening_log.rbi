...
class ListeningLog
  ...
  module CommonRelationMethods
    ...
    sig { params(limit: NilClass).returns(T.nilable(::ListeningLog)) }
  ...
  class PrivateCollectionProxy < ::ActiveRecord::Associations::CollectionProxy
    ...
    sig do
      params(
        records: T.any(::ListeningLog, Integer, String, T::Enumerable[T.any(::ListeningLog, Integer, String, T::Enumerable[::ListeningLog])])
