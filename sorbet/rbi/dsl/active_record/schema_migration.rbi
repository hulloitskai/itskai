...
class ActiveRecord::SchemaMigration
  ...
  module CommonRelationMethods
    ...
    sig { params(signed_id: T.untyped, purpose: T.untyped).returns(T.nilable(::ActiveRecord::SchemaMigration)) }
    def find_signed(signed_id, purpose: nil); end

    sig { params(signed_id: T.untyped, purpose: T.untyped).returns(::ActiveRecord::SchemaMigration) }
    def find_signed!(signed_id, purpose: nil); end
