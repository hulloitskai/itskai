...
class PensieveMessageLike
  ...
  module CommonRelationMethods
    ...
    sig { params(block: T.nilable(T.proc.params(object: ::PensieveMessageLike).void)).returns(::PensieveMessageLike) }
    sig do
      params(
  ...
  module GeneratedAssociationRelationMethods
    ...
    sig do
      params(
        blk: T.proc.params(record: ::PensieveMessageLike).returns(BasicObject)
      ).returns(T::Array[::PensieveMessageLike])
    end
