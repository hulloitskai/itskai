  ...
  module CommonRelationMethods
    ...
    sig do
      params(
        ...
        order: Symbol,
        block: T.nilable(T.proc.params(object: ::PensieveMessageLike).void)
      ).returns(T.nilable(T::Enumerator[::PensieveMessageLike]))
    end
    ...
    sig do
      params(
        ...
        error_on_ignore: T.untyped,
        order: Symbol,
        block: T.nilable(T.proc.params(object: T::Array[::PensieveMessageLike]).void)
      ).returns(T.nilable(T::Enumerator[T::Enumerator[::PensieveMessageLike]]))
    end
