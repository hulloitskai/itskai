...
class ICloudCredentials
  ...
  module CommonRelationMethods
    ...
    sig { params(block: T.nilable(T.proc.params(object: ::ICloudCredentials).void)).returns(::ICloudCredentials) }
    sig do
      params(
  ...
  module GeneratedAssociationRelationMethods
    ...
    sig do
      params(
        blk: T.proc.params(record: ::ICloudCredentials).returns(BasicObject)
      ).returns(T::Array[::ICloudCredentials])
    end
