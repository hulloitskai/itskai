...
class Business
  ...
  module GeneratedAssociationMethods
    ...
    sig { returns(T::Array[T.untyped]) }
    def community_membership_ids; end

    sig { params(ids: T::Array[T.untyped]).returns(T::Array[T.untyped]) }
    def community_membership_ids=(ids); end

    sig { returns(::CommunityBusinessMembership::PrivateCollectionProxy) }
    def community_memberships; end

    sig { params(value: T::Enumerable[::CommunityBusinessMembership]).void }
    def community_memberships=(value); end
  ...
  class PrivateCollectionProxy < ::ActiveRecord::Associations::CollectionProxy
    ...
    sig do
      params(
        records: T.any(::Business, Integer, String, T::Enumerable[T.any(::Business, Integer, String, T::Enumerable[::Business])])
