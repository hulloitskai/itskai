...
# This is an autogenerated file for dynamic methods in `Email`.
# Please instead update this file by running `bin/tapioca dsl Email`.
...
class Email
  ...
  def rich_text_message=(value); end
  ...
  module CommonRelationMethods
    sig { params(block: T.nilable(T.proc.params(record: ::Email).returns(T.untyped))).returns(T::Boolean) }
    def any?(&block); end

    sig { params(column_name: T.any(String, Symbol)).returns(T.untyped) }
    def average(column_name); end

    sig { params(attributes: T.untyped, block: T.nilable(T.proc.params(object: ::Email).void)).returns(::Email) }
    ...
    sig { params(args: T.untyped).returns(T.nilable(::Email)) }
    def find_by(*args); end

    sig { params(args: T.untyped).returns(::Email) }
    def find_by!(*args); end
    ...
    sig { params(arg: T.untyped, args: T.untyped).returns(::Email) }
  ...
  module GeneratedAssociationMethods
    ...
    def build_rich_text_message(*args, &blk); end

    sig { params(args: T.untyped, blk: T.untyped).returns(::User) }
    def build_sender(*args, &blk); end

    sig { params(args: T.untyped, blk: T.untyped).returns(::ActionText::RichText) }
    def create_rich_text_message(*args, &blk); end
    ...
    sig { returns(::EmailReception::PrivateCollectionProxy) }
    def receptions; end

    sig { params(value: T::Enumerable[::EmailReception]).void }
    ...
    def reload_rich_text_message; end
  ...
  module GeneratedAssociationRelationMethods
    ...
    sig { params(args: T.untyped, blk: T.untyped).returns(PrivateAssociationRelation) }
    def with_rich_text_message(*args, &blk); end

    sig { params(args: T.untyped, blk: T.untyped).returns(PrivateAssociationRelation) }
    def with_rich_text_message_and_embeds(*args, &blk); end
  ...
  class PrivateCollectionProxy < ::ActiveRecord::Associations::CollectionProxy
    ...
    sig do
      params(
        records: T.any(::Email, T::Enumerable[T.any(::Email, T::Enumerable[::Email])])
    ...
    sig do
      params(
        records: T.any(::Email, Integer, String, T::Enumerable[T.any(::Email, Integer, String, T::Enumerable[::Email])])
      ).returns(T::Array[::Email])
    end
    ...
    sig do
      params(
        other_array: T.any(::Email, T::Enumerable[T.any(::Email, T::Enumerable[::Email])])
      ).returns(T::Array[::Email])
    end
