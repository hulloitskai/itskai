...
module ActiveModel::Validations
  ...
  # source://activemodel/7.0.3.1/lib/active_model/validations.rb#301
  def errors; end

  # source://activemodel/7.0.3.1/lib/active_model/validations.rb#373
  def invalid?(context = T.unsafe(nil)); end

  def read_attribute_for_validation(*_arg0); end

  # source://activemodel/7.0.3.1/lib/active_model/validations.rb#334
  def valid?(context = T.unsafe(nil)); end

  # source://activemodel/7.0.3.1/lib/active_model/validations.rb#334
  def validate(context = T.unsafe(nil)); end

  # source://activemodel/7.0.3.1/lib/active_model/validations.rb#382
  def validate!(context = T.unsafe(nil)); end

  # source://activemodel/7.0.3.1/lib/active_model/validations/with.rb#137
  def validates_with(*args, &block); end

  private

  # source://activemodel/7.0.3.1/lib/active_model/validations.rb#283
  def initialize_dup(other); end

  # source://activemodel/7.0.3.1/lib/active_model/validations.rb#410
  def raise_validation_error; end

  # source://activemodel/7.0.3.1/lib/active_model/validations.rb#405
...
module ActiveModel::Validations::ClassMethods
  # source://activemodel/7.0.3.1/lib/active_model/validations.rb#270
  def attribute_method?(attribute); end

  # source://activemodel/7.0.3.1/lib/active_model/validations.rb#234
  def clear_validators!; end

  # source://activemodel/7.0.3.1/lib/active_model/validations.rb#275
  def inherited(base); end

  # source://activemodel/7.0.3.1/lib/active_model/validations.rb#152
  def validate(*args, &block); end

  # source://activemodel/7.0.3.1/lib/active_model/validations/validates.rb#106
  def validates(*attributes); end

  # source://activemodel/7.0.3.1/lib/active_model/validations/validates.rb#148
  def validates!(*attributes); end

  # source://activemodel/7.0.3.1/lib/active_model/validations.rb#85
  ...
  # source://activemodel/7.0.3.1/lib/active_model/validations/with.rb#81
  def validates_with(*args, &block); end

  # source://activemodel/7.0.3.1/lib/active_model/validations.rb#192
  def validators; end

  # source://activemodel/7.0.3.1/lib/active_model/validations.rb#254
  def validators_on(*attributes); end

  private

  # source://activemodel/7.0.3.1/lib/active_model/validations/validates.rb#161
  def _parse_validates_options(options); end

  # source://activemodel/7.0.3.1/lib/active_model/validations/validates.rb#157
  def _validates_default_keys; end
end

# source://activemodel/7.0.3.1/lib/active_model/validations.rb#89
