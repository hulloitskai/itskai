...
module ActiveRecord
  class << self
    # source://activerecord/7.0.5/lib/active_record.rb#277
    def action_on_strict_loading_violation; end

    # source://activerecord/7.0.5/lib/active_record.rb#277
    def action_on_strict_loading_violation=(_arg0); end

    # source://activerecord/7.0.5/lib/active_record.rb#270
    def application_record_class; end

    # source://activerecord/7.0.5/lib/active_record.rb#270
    def application_record_class=(_arg0); end

    # source://activerecord/7.0.5/lib/active_record.rb#213
    def async_query_executor; end

    # source://activerecord/7.0.5/lib/active_record.rb#213
    def async_query_executor=(_arg0); end

    # source://activerecord/7.0.5/lib/active_record.rb#183
    def default_timezone; end

    # source://activerecord/7.0.5/lib/active_record.rb#187
    def default_timezone=(default_timezone); end

    # source://activerecord/7.0.5/lib/active_record.rb#311
    def dump_schema_after_migration; end

    # source://activerecord/7.0.5/lib/active_record.rb#311
    def dump_schema_after_migration=(_arg0); end

    # source://activerecord/7.0.5/lib/active_record.rb#321
    def dump_schemas; end

    # source://activerecord/7.0.5/lib/active_record.rb#321
    def dump_schemas=(_arg0); end

    # source://activerecord/7.0.5/lib/active_record.rb#365
    def eager_load!; end

    # source://activerecord/7.0.5/lib/active_record.rb#296
    def error_on_ignored_order; end

    # source://activerecord/7.0.5/lib/active_record.rb#296
    def error_on_ignored_order=(_arg0); end

    # source://activerecord/7.0.5/lib/active_record/gem_version.rb#5
    def gem_version; end

    # source://activerecord/7.0.5/lib/active_record.rb#236
    def global_executor_concurrency; end

    # source://activerecord/7.0.5/lib/active_record.rb#228
    def global_executor_concurrency=(global_executor_concurrency); end

    # source://activerecord/7.0.5/lib/active_record.rb#216
    def global_thread_pool_async_query_executor; end

    # source://activerecord/7.0.5/lib/active_record.rb#240
    def index_nested_attribute_errors; end

    # source://activerecord/7.0.5/lib/active_record.rb#240
    def index_nested_attribute_errors=(_arg0); end

    # source://activerecord/7.0.5/lib/active_record.rb#171
    def lazily_load_schema_cache; end

    # source://activerecord/7.0.5/lib/active_record.rb#171
    def lazily_load_schema_cache=(_arg0); end

    # source://activerecord/7.0.5/lib/active_record.rb#180
    def legacy_connection_handling; end

    # source://activerecord/7.0.5/lib/active_record.rb#180
    def legacy_connection_handling=(_arg0); end

    # source://activerecord/7.0.5/lib/active_record.rb#258
    def maintain_test_schema; end

    # source://activerecord/7.0.5/lib/active_record.rb#258
    def maintain_test_schema=(_arg0); end

    # source://activerecord/7.0.5/lib/active_record.rb#340
    def query_transformers; end

    # source://activerecord/7.0.5/lib/active_record.rb#340
    def query_transformers=(_arg0); end

    # source://activerecord/7.0.5/lib/active_record.rb#255
    def queues; end

    # source://activerecord/7.0.5/lib/active_record.rb#255
    def queues=(_arg0); end

    # source://activerecord/7.0.5/lib/active_record.rb#355
    def raise_int_wider_than_64bit; end

    # source://activerecord/7.0.5/lib/active_record.rb#355
    def raise_int_wider_than_64bit=(_arg0); end

    # source://activerecord/7.0.5/lib/active_record.rb#200
    def reading_role; end

    # source://activerecord/7.0.5/lib/active_record.rb#200
    def reading_role=(_arg0); end

    # source://activerecord/7.0.5/lib/active_record.rb#177
    def schema_cache_ignored_tables; end

    # source://activerecord/7.0.5/lib/active_record.rb#177
    def schema_cache_ignored_tables=(_arg0); end

    # source://activerecord/7.0.5/lib/active_record.rb#288
    def schema_format; end

    # source://activerecord/7.0.5/lib/active_record.rb#288
    def schema_format=(_arg0); end

    # source://activerecord/7.0.5/lib/active_record.rb#328
    def suppress_multiple_database_warning; end

    # source://activerecord/7.0.5/lib/active_record.rb#328
    def suppress_multiple_database_warning=(_arg0); end

    # source://activerecord/7.0.5/lib/active_record.rb#302
    def timestamped_migrations; end

    # source://activerecord/7.0.5/lib/active_record.rb#302
    def timestamped_migrations=(_arg0); end

    # source://activerecord/7.0.5/lib/active_record.rb#347
    def use_yaml_unsafe_load; end

    # source://activerecord/7.0.5/lib/active_record.rb#347
    def use_yaml_unsafe_load=(_arg0); end

    # source://activerecord/7.0.5/lib/active_record.rb#248
    def verbose_query_logs; end

    # source://activerecord/7.0.5/lib/active_record.rb#248
    def verbose_query_logs=(_arg0); end

    # source://activerecord/7.0.5/lib/active_record.rb#337
    def verify_foreign_keys_for_fixtures; end

    # source://activerecord/7.0.5/lib/active_record.rb#337
    def verify_foreign_keys_for_fixtures=(_arg0); end

    # source://activerecord/7.0.5/lib/active_record/version.rb#7
    def version; end

    # source://activerecord/7.0.5/lib/active_record.rb#267
    def warn_on_records_fetched_greater_than; end

    # source://activerecord/7.0.5/lib/active_record.rb#267
    def warn_on_records_fetched_greater_than=(_arg0); end

    # source://activerecord/7.0.5/lib/active_record.rb#197
    def writing_role; end

    # source://activerecord/7.0.5/lib/active_record.rb#197
    def writing_role=(_arg0); end

    # source://activerecord/7.0.5/lib/active_record.rb#362
...
module ActiveRecord::ConnectionHandling
  # source://activerecord/7.0.5/lib/active_record/connection_handling.rb#337
  def clear_active_connections!(*_arg0, **_arg1, &_arg2); end

  # source://activerecord/7.0.5/lib/active_record/connection_handling.rb#337
  def clear_all_connections!(*_arg0, **_arg1, &_arg2); end

  # source://activerecord/7.0.5/lib/active_record/connection_handling.rb#333
  def clear_cache!; end

  # source://activerecord/7.0.5/lib/active_record/connection_handling.rb#266
  def clear_query_caches_for_current_thread; end

  # source://activerecord/7.0.5/lib/active_record/connection_handling.rb#337
  def clear_reloadable_connections!(*_arg0, **_arg1, &_arg2); end

  # source://activerecord/7.0.5/lib/active_record/connection_handling.rb#317
  def connected?; end

  # source://activerecord/7.0.5/lib/active_record/connection_handling.rb#137
  def connected_to(role: T.unsafe(nil), shard: T.unsafe(nil), prevent_writes: T.unsafe(nil), &blk); end

  # source://activerecord/7.0.5/lib/active_record/connection_handling.rb#252
  def connected_to?(role:, shard: T.unsafe(nil)); end

  # source://activerecord/7.0.5/lib/active_record/connection_handling.rb#172
  def connected_to_many(*classes, role:, shard: T.unsafe(nil), prevent_writes: T.unsafe(nil)); end

  # source://activerecord/7.0.5/lib/active_record/connection_handling.rb#198
  def connecting_to(role: T.unsafe(nil), shard: T.unsafe(nil), prevent_writes: T.unsafe(nil)); end

  # source://activerecord/7.0.5/lib/active_record/connection_handling.rb#279
  def connection; end

  # source://activerecord/7.0.5/lib/active_record/connection_handling.rb#304
  def connection_db_config; end

  # source://activerecord/7.0.5/lib/active_record/connection_handling.rb#308
  def connection_pool; end

  # source://activerecord/7.0.5/lib/active_record/connection_handling.rb#286
  def connection_specification_name; end

  # source://activerecord/7.0.5/lib/active_record/connection_handling.rb#283
  def connection_specification_name=(_arg0); end

  # source://activerecord/7.0.5/lib/active_record/connection_handling.rb#81
  def connects_to(database: T.unsafe(nil), shards: T.unsafe(nil)); end

  # source://activerecord/7.0.5/lib/active_record/connection_handling.rb#49
  def establish_connection(config_or_env = T.unsafe(nil)); end

  # source://activerecord/7.0.5/lib/active_record/connection_handling.rb#337
  def flush_idle_connections!(*_arg0, **_arg1, &_arg2); end

  # source://activerecord/7.0.5/lib/active_record/connection_handling.rb#256
  ...
  # source://activerecord/7.0.5/lib/active_record/connection_adapters/postgresql_adapter.rb#25
  def postgresql_connection(config); end

  # source://activerecord/7.0.5/lib/active_record/connection_handling.rb#293
  def primary_class?; end

  # source://activerecord/7.0.5/lib/active_record/connection_handling.rb#214
  def prohibit_shard_swapping(enabled = T.unsafe(nil)); end

  # source://activerecord/7.0.5/lib/active_record/connection_handling.rb#321
  def remove_connection(name = T.unsafe(nil)); end

  # source://activerecord/7.0.5/lib/active_record/connection_handling.rb#312
  def retrieve_connection; end

  # source://activerecord/7.0.5/lib/active_record/connection_handling.rb#223
  def shard_swapping_prohibited?; end

  # source://activerecord/7.0.5/lib/active_record/connection_handling.rb#238
  def while_preventing_writes(enabled = T.unsafe(nil), &block); end

  private

  # source://activerecord/7.0.5/lib/active_record/connection_handling.rb#382
  def append_to_connected_to_stack(entry); end

  # source://activerecord/7.0.5/lib/active_record/connection_handling.rb#341
  def clear_on_handler(handler); end

  # source://activerecord/7.0.5/lib/active_record/connection_handling.rb#347
  def resolve_config_for_connection(config_or_env); end

  # source://activerecord/7.0.5/lib/active_record/connection_handling.rb#390
  def swap_connection_handler(handler, &blk); end

  # source://activerecord/7.0.5/lib/active_record/connection_handling.rb#357
  def with_handler(handler_key, &blk); end

  # source://activerecord/7.0.5/lib/active_record/connection_handling.rb#362
...
module ActiveRecord::Type
  ...
  class << self
    # source://activerecord/7.0.5/lib/active_record/type.rb#49
    def adapter_name_from(model); end

    # source://activerecord/7.0.5/lib/active_record/type.rb#27
    def add_modifier(*_arg0, **_arg1, &_arg2); end

    # source://activerecord/7.0.5/lib/active_record/type.rb#45
    def default_value; end

    # source://activerecord-postgis-adapter//lib/active_record/connection_adapters/postgis/type.rb#9
    def lookup(*args, adapter: T.unsafe(nil), **kwargs); end

    # source://activerecord/7.0.5/lib/active_record/type.rb#37
    def register(type_name, klass = T.unsafe(nil), **options, &block); end

    # source://activerecord/7.0.5/lib/active_record/type.rb#26
    def registry; end
    ...
    # source://activerecord/7.0.5/lib/active_record/type.rb#54
...
module Arel
  class << self
    # source://activerecord/7.0.5/lib/arel.rb#46
    def arel_node?(value); end

    # source://activerecord/7.0.5/lib/arel.rb#50
    def fetch_attribute(value, &block); end

    # source://rgeo-activerecord/7.0.1/lib/rgeo/active_record/spatial_expressions.rb#253
    def spatial(arg); end

    # source://activerecord/7.0.5/lib/arel.rb#38
    def sql(raw_sql); end

    # source://activerecord/7.0.5/lib/arel.rb#42
    def star; end
  end
end
