...
module ActiveRecord::ConnectionHandling
  # source://activerecord/7.0.6/lib/active_record/connection_handling.rb#337
  def clear_active_connections!(*_arg0, **_arg1, &_arg2); end

  # source://activerecord/7.0.6/lib/active_record/connection_handling.rb#337
  def clear_all_connections!(*_arg0, **_arg1, &_arg2); end

  # source://activerecord/7.0.6/lib/active_record/connection_handling.rb#333
  def clear_cache!; end

  # source://activerecord/7.0.6/lib/active_record/connection_handling.rb#266
  def clear_query_caches_for_current_thread; end

  # source://activerecord/7.0.6/lib/active_record/connection_handling.rb#337
  def clear_reloadable_connections!(*_arg0, **_arg1, &_arg2); end

  # source://activerecord/7.0.6/lib/active_record/connection_handling.rb#317
  def connected?; end

  # source://activerecord/7.0.6/lib/active_record/connection_handling.rb#137
  def connected_to(role: T.unsafe(nil), shard: T.unsafe(nil), prevent_writes: T.unsafe(nil), &blk); end

  # source://activerecord/7.0.6/lib/active_record/connection_handling.rb#252
  def connected_to?(role:, shard: T.unsafe(nil)); end

  # source://activerecord/7.0.6/lib/active_record/connection_handling.rb#172
  def connected_to_many(*classes, role:, shard: T.unsafe(nil), prevent_writes: T.unsafe(nil)); end

  # source://activerecord/7.0.6/lib/active_record/connection_handling.rb#198
  def connecting_to(role: T.unsafe(nil), shard: T.unsafe(nil), prevent_writes: T.unsafe(nil)); end

  # source://activerecord/7.0.6/lib/active_record/connection_handling.rb#279
  def connection; end

  # source://activerecord/7.0.6/lib/active_record/connection_handling.rb#304
  def connection_db_config; end

  # source://activerecord/7.0.6/lib/active_record/connection_handling.rb#308
  def connection_pool; end

  # source://activerecord/7.0.6/lib/active_record/connection_handling.rb#286
  def connection_specification_name; end

  # source://activerecord/7.0.6/lib/active_record/connection_handling.rb#283
  def connection_specification_name=(_arg0); end

  # source://activerecord/7.0.6/lib/active_record/connection_handling.rb#81
  def connects_to(database: T.unsafe(nil), shards: T.unsafe(nil)); end

  # source://activerecord/7.0.6/lib/active_record/connection_handling.rb#49
  def establish_connection(config_or_env = T.unsafe(nil)); end

  # source://activerecord/7.0.6/lib/active_record/connection_handling.rb#337
  def flush_idle_connections!(*_arg0, **_arg1, &_arg2); end

  # source://activerecord/7.0.6/lib/active_record/connection_handling.rb#256
  ...
  # source://activerecord/7.0.6/lib/active_record/connection_adapters/postgresql_adapter.rb#25
  def postgresql_connection(config); end

  # source://activerecord/7.0.6/lib/active_record/connection_handling.rb#293
  def primary_class?; end

  # source://activerecord/7.0.6/lib/active_record/connection_handling.rb#214
  def prohibit_shard_swapping(enabled = T.unsafe(nil)); end

  # source://activerecord/7.0.6/lib/active_record/connection_handling.rb#321
  def remove_connection(name = T.unsafe(nil)); end

  # source://activerecord/7.0.6/lib/active_record/connection_handling.rb#312
  def retrieve_connection; end

  # source://activerecord/7.0.6/lib/active_record/connection_handling.rb#223
  def shard_swapping_prohibited?; end

  # source://activerecord/7.0.6/lib/active_record/connection_handling.rb#238
  def while_preventing_writes(enabled = T.unsafe(nil), &block); end

  private

  # source://activerecord/7.0.6/lib/active_record/connection_handling.rb#382
  def append_to_connected_to_stack(entry); end

  # source://activerecord/7.0.6/lib/active_record/connection_handling.rb#341
  def clear_on_handler(handler); end

  # source://activerecord/7.0.6/lib/active_record/connection_handling.rb#347
  def resolve_config_for_connection(config_or_env); end

  # source://activerecord/7.0.6/lib/active_record/connection_handling.rb#390
  def swap_connection_handler(handler, &blk); end

  # source://activerecord/7.0.6/lib/active_record/connection_handling.rb#357
  def with_handler(handler_key, &blk); end

  # source://activerecord/7.0.6/lib/active_record/connection_handling.rb#362
...
module ActiveRecord::Type
  ...
  class << self
    # source://activerecord/7.0.6/lib/active_record/type.rb#49
    def adapter_name_from(model); end

    # source://activerecord/7.0.6/lib/active_record/type.rb#27
    def add_modifier(*_arg0, **_arg1, &_arg2); end

    # source://activerecord/7.0.6/lib/active_record/type.rb#45
    def default_value; end

    # source://activerecord-postgis-adapter//lib/active_record/connection_adapters/postgis/type.rb#9
    def lookup(*args, adapter: T.unsafe(nil), **kwargs); end

    # source://activerecord/7.0.6/lib/active_record/type.rb#37
    def register(type_name, klass = T.unsafe(nil), **options, &block); end

    # source://activerecord/7.0.6/lib/active_record/type.rb#26
    def registry; end
    ...
    # source://activerecord/7.0.6/lib/active_record/type.rb#54
