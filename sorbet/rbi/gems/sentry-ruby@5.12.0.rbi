...
module Sentry
  class << self
    ...
    #
    # source://sentry-ruby//lib/sentry-ruby.rb#287
    ...
    #
    # source://sentry-ruby//lib/sentry-ruby.rb#69
    ...
    #
    # source://sentry-ruby//lib/sentry-ruby.rb#448
    ...
    # @return [Event, nil]
    #
    # source://sentry-ruby//lib/sentry-ruby.rb#430
    ...
    # @yieldparam scope [Scope]
    #
    # source://sentry-ruby//lib/sentry-ruby.rb#422
    ...
    # @return [void]
    #
    # source://sentry-ruby//lib/sentry-ruby.rb#238
    def close; end

    # source://sentry-ruby//lib/sentry-ruby.rb#145
    ...
    # @return [String, nil]
    #
    # source://sentry-ruby//lib/sentry-ruby.rb#272
    ...
    # @return [Boolean]
    #
    # source://sentry-ruby//lib/sentry-ruby.rb#490
    ...
    # @return [String, nil]
    #
    # source://sentry-ruby//lib/sentry-ruby.rb#525
    def get_baggage; end
    ...
    # @return [Client, nil]
    #
    # source://sentry-ruby//lib/sentry-ruby.rb#308
    ...
    # @return [Hub]
    #
    # source://sentry-ruby//lib/sentry-ruby.rb#297
    ...
    # @return [Hub]
    #
    # source://sentry-ruby//lib/sentry-ruby.rb#280
    ...
    #
    # source://sentry-ruby//lib/sentry-ruby.rb#209
    def init(&block); end
    ...
    # @return [Boolean]
    #
    # source://sentry-ruby//lib/sentry-ruby.rb#260
    def initialized?; end
    ...
    #
    # source://sentry-ruby//lib/sentry-ruby.rb#109
    ...
    # @return [String, nil]
    #
    # source://sentry-ruby//lib/sentry-ruby.rb#482
    def last_event_id; end

    # source://sentry-ruby//lib/sentry-ruby.rb#559
    def logger; end
    ...
    #
    # source://sentry-ruby//lib/sentry-ruby.rb#117
    def register_integration(name, version); end

    # source://sentry-ruby//lib/sentry-ruby.rb#78
    def register_patch(patch = T.unsafe(nil), target = T.unsafe(nil), &block); end

    # source://sentry-ruby//lib/sentry-ruby.rb#100
    def registered_patches; end

    # source://sentry-ruby//lib/sentry-ruby.rb#564
    def sdk_meta; end

    # source://sentry-ruby//lib/sentry-ruby.rb#152
    def send_event(*args); end

    # Returns the value of attribute session_flusher.
    #
    # source://sentry-ruby//lib/sentry-ruby.rb#73
    def session_flusher; end

    # source://sentry-ruby//lib/sentry-ruby.rb#198
    def set_context(*args); end

    # source://sentry-ruby//lib/sentry-ruby.rb#184
    def set_extras(*args); end

    # source://sentry-ruby//lib/sentry-ruby.rb#177
    ...
    # @return [Transaction, nil]
    #
    # source://sentry-ruby//lib/sentry-ruby.rb#456
    def start_transaction(**options); end

    # source://sentry-ruby//lib/sentry-ruby.rb#551
    ...
    # source://sentry-ruby//lib/sentry-ruby.rb#569
    def utc_now; end
    ...
    #
    # source://sentry-ruby//lib/sentry-ruby.rb#474
    ...
    #   end
    #
    # source://sentry-ruby//lib/sentry-ruby.rb#411
    ...
    # @yieldparam scope [Scope]
    #
    # source://sentry-ruby//lib/sentry-ruby.rb#365
    ...
    # @return [void]
    #
    # source://sentry-ruby//lib/sentry-ruby.rb#385
...
class Sentry::BackgroundWorker
  ...
  # source://sentry-rails/5.12.0/lib/sentry/rails/background_worker.rb#3
...
class Sentry::Client
  ...
  # @return [Event]
  #
  # source://sentry-ruby//lib/sentry/client.rb#97
  ...
  #
  # source://sentry-ruby//lib/sentry/client.rb#141
  ...
  # @return [String, nil]
  #
  # source://sentry-ruby//lib/sentry/client.rb#202
  ...
  # @return [String, nil]
  #
  # source://sentry-ruby//lib/sentry/client.rb#188
  ...
  # source://sentry-ruby//lib/sentry/client.rb#216
...
class Sentry::Configuration
  ...
  # @return [Regexp, nil]
  #
  # source://sentry-ruby//lib/sentry/configuration.rb#24
  ...
  # source://sentry-ruby//lib/sentry/configuration.rb#368
  def async=(value); end
  ...
  # @return [Integer]
  #
  # source://sentry-ruby//lib/sentry/configuration.rb#41
  ...
  # @return [Proc, nil]
  #
  # source://sentry-ruby//lib/sentry/configuration.rb#52
  ...
  # source://sentry-ruby//lib/sentry/configuration.rb#409
  ...
  # @return [Proc]
  #
  # source://sentry-ruby//lib/sentry/configuration.rb#88
  ...
  # source://sentry-ruby//lib/sentry/configuration.rb#384
  ...
  # @return [String, nil]
  #
  # source://sentry-ruby//lib/sentry/configuration.rb#490
  def csp_report_uri; end
  ...
  # @api private
  #
  # source://sentry-ruby//lib/sentry/configuration.rb#511
  ...
  # @return [Array<String>]
  #
  # source://sentry-ruby//lib/sentry/configuration.rb#125
  ...
  # @return [Boolean]
  #
  # source://sentry-ruby//lib/sentry/configuration.rb#455
  ...
  # @return [Integer]
  #
  # source://sentry-ruby//lib/sentry/configuration.rb#104
  ...
  # @raise [ArgumentError]
  #
  # source://sentry-ruby//lib/sentry/configuration.rb#437
  ...
  # source://sentry-rails/5.12.0/lib/sentry/rails/configuration.rb#8
  def rails; end
  ...
  # source://sentry-ruby//lib/sentry/configuration.rb#362
  ...
  # @return [Boolean]
  #
  # source://sentry-ruby//lib/sentry/configuration.rb#240
  ...
  # @return [Boolean]
  #
  # source://sentry-ruby//lib/sentry/configuration.rb#202
  ...
  # @api private
  #
  # source://sentry-ruby//lib/sentry/configuration.rb#500
  ...
  # @return [Proc]
  #
  # source://sentry-ruby//lib/sentry/configuration.rb#230
  ...
  # source://sentry-ruby//lib/sentry/configuration.rb#588
  def environment_from_env; end

  # @return [Boolean]
  #
  # source://sentry-ruby//lib/sentry/configuration.rb#543
  def excluded_exception?(incoming_exception); end

  # source://sentry-ruby//lib/sentry/configuration.rb#549
  def excluded_exception_classes; end

  # source://sentry-ruby//lib/sentry/configuration.rb#553
  def get_exception_class(x); end

  # source://sentry-ruby//lib/sentry/configuration.rb#537
  def init_dsn(dsn_string); end

  # @return [Boolean]
  #
  # source://sentry-ruby//lib/sentry/configuration.rb#557
  def matches_exception?(excluded_exception_class, incoming_exception); end

  # source://sentry-ruby//lib/sentry/configuration.rb#606
  ...
  # source://sentry-ruby//lib/sentry/configuration.rb#565
  def safe_const_get(x); end

  # source://sentry-ruby//lib/sentry/configuration.rb#592
  def server_name_from_env; end

  # @return [Boolean]
  #
  # source://sentry-ruby//lib/sentry/configuration.rb#579
  def valid?; end
  ...
  class << self
    ...
    #
    # source://sentry-ruby//lib/sentry/configuration.rb#303
...
class Sentry::Event
  ...
  #
  # source://sentry-ruby//lib/sentry/event.rb#109
  def configuration; end
  ...
  #
  # source://sentry-ruby//lib/sentry/event.rb#131
  ...
  # @return [void]
  #
  # source://sentry-ruby//lib/sentry/event.rb#116
  ...
  # source://sentry-ruby//lib/sentry/event.rb#160
  def add_request_interface(env); end

  # When behind a proxy (or if the user is using a proxy), we can't use
  # REMOTE_ADDR to determine the Event IP, and must use other headers instead.
  #
  # source://sentry-ruby//lib/sentry/event.rb#174
  def calculate_real_ip_from_rack(env); end

  # source://sentry-ruby//lib/sentry/event.rb#164
  ...
  class << self
    ...
    # source://sentry-ruby//lib/sentry/event.rb#98
...
# source://sentry-ruby//lib/sentry/interfaces/exception.rb#5
...
# source://sentry-ruby//lib/sentry-ruby.rb#37
...
class Sentry::PropagationContext
  ...
  # @return [Baggage, nil]
  #
  # source://sentry-ruby//lib/sentry/propagation_context.rb#104
  def get_baggage; end
  ...
  # @return [String, nil]
  #
  # source://sentry-ruby//lib/sentry/propagation_context.rb#111
  ...
  # @return [Hash]
  #
  # source://sentry-ruby//lib/sentry/propagation_context.rb#88
  ...
  # @return [String]
  #
  # source://sentry-ruby//lib/sentry/propagation_context.rb#98
  def get_traceparent; end
  ...
  # source://sentry-ruby//lib/sentry/propagation_context.rb#117
  ...
  class << self
    ...
    # @return [Array, nil]
    #
    # source://sentry-ruby//lib/sentry/propagation_context.rb#76
...
# source://sentry-ruby//lib/sentry/puma.rb#4
module Sentry::Puma; end

# source://sentry-ruby//lib/sentry/puma.rb#5
...
class Sentry::Scope
  ...
  # @return [void]
  #
  # source://sentry-ruby//lib/sentry/scope.rb#80
  ...
  # source://sentry-ruby//lib/sentry/scope.rb#212
  ...
  # @return [Hash]
  #
  # source://sentry-ruby//lib/sentry/scope.rb#179
  ...
  # @return [Hash]
  #
  # source://sentry-ruby//lib/sentry/scope.rb#150
  ...
  # @return [void]
  #
  # source://sentry-ruby//lib/sentry/scope.rb#236
  ...
  # @return [Span]
  #
  # source://sentry-ruby//lib/sentry/scope.rb#158
  ...
  # @return [void]
  #
  # source://sentry-ruby//lib/sentry/scope.rb#228
  def set_transaction_name(transaction_name, source: T.unsafe(nil)); end

  # source://sentry-ruby//lib/sentry/scope.rb#164
  ...
  # @return [void]
  #
  # source://sentry-ruby//lib/sentry/scope.rb#131
  ...
  # @return [void]
  #
  # source://sentry-ruby//lib/sentry/scope.rb#110
  ...
  # source://sentry-ruby//lib/sentry/scope.rb#296
  ...
  class << self
    ...
    # @return [void]
    #
    # source://sentry-ruby//lib/sentry/scope.rb#353
    def add_global_event_processor(&block); end
    ...
    # @return [Array<Proc>]
    #
    # source://sentry-ruby//lib/sentry/scope.rb#343
    def global_event_processors; end

    # @return [Hash]
    #
    # source://sentry-ruby//lib/sentry/scope.rb#319
    def os_context; end

    # @return [Hash]
    #
    # source://sentry-ruby//lib/sentry/scope.rb#334
...
class Sentry::Span
  ...
  # source://sentry-ruby//lib/sentry/span.rb#215
  def deep_dup; end
  ...
  # @return [Hash]
  #
  # source://sentry-ruby//lib/sentry/span.rb#169
  def get_trace_context; end
  ...
  # @param value [Object]
  #
  # source://sentry-ruby//lib/sentry/span.rb#262
  ...
  #
  # source://sentry-ruby//lib/sentry/span.rb#227
  ...
  #
  # source://sentry-ruby//lib/sentry/span.rb#221
  def set_op(op); end
  ...
  # @param value [String]
  #
  # source://sentry-ruby//lib/sentry/span.rb#269
  def set_tag(key, value); end
  ...
  #
  # source://sentry-ruby//lib/sentry/span.rb#240
  ...
  #
  # source://sentry-ruby//lib/sentry/span.rb#182
  ...
  #
  # source://sentry-ruby//lib/sentry/span.rb#203
  def with_child_span(**attributes, &block); end
end
...
class Sentry::Transaction < ::Sentry::Span
  ...
  # @return [Transaction]
  #
  # source://sentry-ruby//lib/sentry/transaction.rb#155
  def deep_dup; end
  ...
  # @return [Baggage]
  #
  # source://sentry-ruby//lib/sentry/transaction.rb#267
  def get_baggage; end
  ...
  # @return [void]
  #
  # source://sentry-ruby//lib/sentry/transaction.rb#180
  ...
  # @return [void]
  #
  # source://sentry-ruby//lib/sentry/transaction.rb#173
  ...
  # @return [void]
  #
  # source://sentry-ruby//lib/sentry/transaction.rb#292
  def start_profiler!; end

  # @return [Hash]
  #
  # source://sentry-ruby//lib/sentry/transaction.rb#141
  def to_hash; end

  protected

  # source://sentry-ruby//lib/sentry/transaction.rb#299
  ...
  # @return [Boolean]
  #
  # source://sentry-ruby//lib/sentry/transaction.rb#333
  ...
  class << self
    ...
    # @return [Array, nil]
    #
    # source://sentry-ruby//lib/sentry/transaction.rb#136
    def extract_sentry_trace(sentry_trace); end
...
# source://sentry-ruby//lib/sentry/transaction.rb#337
class Sentry::Transaction::SpanRecorder
  # @return [SpanRecorder] a new instance of SpanRecorder
  #
  # source://sentry-ruby//lib/sentry/transaction.rb#340
  ...
  #
  # source://sentry-ruby//lib/sentry/transaction.rb#338
  def max_length; end
...
class Sentry::Transport
  ...
  # source://sentry-ruby//lib/sentry/transport.rb#134
  ...
  # source://sentry-ruby//lib/sentry/transport.rb#171
  ...
  # source://sentry-ruby//lib/sentry/transport.rb#180
  def fetch_pending_client_report; end

  # source://sentry-ruby//lib/sentry/transport.rb#206
