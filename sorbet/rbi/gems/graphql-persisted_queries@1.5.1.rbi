...
class GraphQL::Execution::Interpreter
  class << self
    # source://graphql-persisted_queries//lib/graphql/persisted_queries/compiled_queries/interpreter_patch.rb#16
    def run_all(schema, query_options, context: T.unsafe(nil), max_complexity: T.unsafe(nil)); end

    private

    # source://graphql/2.0.14/lib/graphql/execution/interpreter.rb#200
    def call_after_hooks(instrumenters, object, after_hook_name, ex); end

    # source://graphql/2.0.14/lib/graphql/execution/interpreter.rb#175
    def call_hooks(instrumenters, object, before_hook_name, after_hook_name); end

    # source://graphql/2.0.14/lib/graphql/execution/interpreter.rb#160
    def each_query_call_hooks(instrumenters, queries, i = T.unsafe(nil)); end
  end
end

# source://graphql/2.0.14/lib/graphql/execution.rb#16
...
module GraphQL::PersistedQueries
  class << self
    # source://graphql-persisted_queries//lib/graphql/persisted_queries.rb#41
    def configure_compiled_queries; end

    # source://graphql-persisted_queries//lib/graphql/persisted_queries.rb#20
...
# source://graphql-persisted_queries//lib/graphql/persisted_queries/compiled_queries/resolver.rb#5
module GraphQL::PersistedQueries::CompiledQueries; end

# Patches GraphQL::Execution::Multiplex to support compiled queries
#
# source://graphql-persisted_queries//lib/graphql/persisted_queries/compiled_queries/interpreter_patch.rb#13
module GraphQL::PersistedQueries::CompiledQueries::InterpreterPatch
...
module GraphQL::PersistedQueries::CompiledQueries::QueryPatch
  ...
  # source://graphql-persisted_queries//lib/graphql/persisted_queries/compiled_queries/query_patch.rb#27
  def resolver; end
end
...
#
# source://graphql-persisted_queries//lib/graphql/persisted_queries/schema_patch.rb#11
module GraphQL::PersistedQueries::SchemaPatch
  # source://graphql-persisted_queries//lib/graphql/persisted_queries/schema_patch.rb#46
  def configure_persisted_query_error_handler(handler); end

  # source://graphql-persisted_queries//lib/graphql/persisted_queries/schema_patch.rb#32
  def configure_persisted_query_store(store, **options); end

  # source://graphql-persisted_queries//lib/graphql/persisted_queries/schema_patch.rb#50
  def hash_generator=(hash_generator); end

  # source://graphql-persisted_queries//lib/graphql/persisted_queries/schema_patch.rb#54
  ...
  #
  # source://graphql-persisted_queries//lib/graphql/persisted_queries/schema_patch.rb#30
  def persisted_queries_tracing_enabled=(_arg0); end

  # @return [Boolean]
  #
  # source://graphql-persisted_queries//lib/graphql/persisted_queries/schema_patch.rb#62
  def persisted_queries_tracing_enabled?; end

  # source://graphql-persisted_queries//lib/graphql/persisted_queries/schema_patch.rb#42
  def persisted_query_error_handler; end

  # source://graphql-persisted_queries//lib/graphql/persisted_queries/schema_patch.rb#38
  def persisted_query_store; end

  # source://graphql-persisted_queries//lib/graphql/persisted_queries/schema_patch.rb#67
  def tracer(name); end

  # source://graphql-persisted_queries//lib/graphql/persisted_queries/schema_patch.rb#58
  def verify_http_method=(verify); end

  private

  # source://graphql-persisted_queries//lib/graphql/persisted_queries/schema_patch.rb#78
  def prepare_analyzer; end

  class << self
    # source://graphql-persisted_queries//lib/graphql/persisted_queries/schema_patch.rb#13
...
#
# source://graphql-persisted_queries//lib/graphql/persisted_queries/schema_patch.rb#24
module GraphQL::PersistedQueries::SchemaPatch::MultiplexPatch
  # source://graphql-persisted_queries//lib/graphql/persisted_queries/schema_patch.rb#25
...
#
# source://graphql-persisted_queries//lib/graphql/persisted_queries/errors.rb#13
class GraphQL::PersistedQueries::WrongHash < ::StandardError
  # source://graphql-persisted_queries//lib/graphql/persisted_queries/errors.rb#14
  def message; end
end

class GraphQL::Query
  # source://graphql/2.0.14/lib/graphql/query.rb#86
  ...
  # source://graphql/2.0.14/lib/graphql/query.rb#293
  ...
  # source://graphql/2.0.14/lib/graphql/query.rb#246
  def arguments_cache; end

  # source://graphql/2.0.14/lib/graphql/query.rb#242
  def arguments_for(ast_node, definition, parent_object: T.unsafe(nil)); end

  # source://forwardable/1.3.2/forwardable.rb#229
  def ast_analyzers(*args, **_arg1, &block); end

  # source://graphql/2.0.14/lib/graphql/query.rb#28
  def context; end

  # source://graphql/2.0.14/lib/graphql/query.rb#51
  def document; end

  # source://graphql/2.0.14/lib/graphql/query.rb#204
  def executed?; end

  # source://graphql/2.0.14/lib/graphql/query.rb#272
  def fingerprint; end

  # source://graphql/2.0.14/lib/graphql/query.rb#187
  def fragments; end
  ...
  # source://graphql/2.0.14/lib/graphql/query.rb#343
  def handle_or_reraise(err); end

  # source://graphql/2.0.14/lib/graphql/query.rb#60
  def inspect; end

  # source://graphql/2.0.14/lib/graphql/query.rb#154
  def interpreter?; end

  # source://graphql/2.0.14/lib/graphql/query.rb#166
  def lookahead; end
  ...
  # source://graphql/2.0.14/lib/graphql/query.rb#329
  def merge_filters(only: T.unsafe(nil), except: T.unsafe(nil)); end

  # source://graphql/2.0.14/lib/graphql/query.rb#158
  def multiplex; end

  # source://graphql/2.0.14/lib/graphql/query.rb#158
  def multiplex=(_arg0); end

  # source://graphql/2.0.14/lib/graphql/query.rb#320
  def mutation?; end

  # source://graphql/2.0.14/lib/graphql/query.rb#277
  def operation_fingerprint; end

  # source://graphql/2.0.14/lib/graphql/query.rb#34
  def operation_name; end

  # source://graphql/2.0.14/lib/graphql/query.rb#34
  def operation_name=(_arg0); end

  # source://graphql/2.0.14/lib/graphql/query.rb#191
  def operations; end
  ...
  # source://graphql/2.0.14/lib/graphql/query.rb#324
  def query?; end

  # source://graphql/2.0.14/lib/graphql/query.rb#150
  def query_string; end

  # source://graphql/2.0.14/lib/graphql/query.rb#48
  def query_string=(_arg0); end

  # source://graphql/2.0.14/lib/graphql/query.rb#308
  def resolve_type(abstract_type, value = T.unsafe(nil)); end

  # source://graphql/2.0.14/lib/graphql/query.rb#197
  def result; end

  # source://graphql/2.0.14/lib/graphql/query.rb#185
  def result_values; end

  # source://graphql/2.0.14/lib/graphql/query.rb#175
  def result_values=(result_hash); end

  # source://forwardable/1.3.2/forwardable.rb#229
  def root_type_for_operation(*args, **_arg1, &block); end

  # source://graphql/2.0.14/lib/graphql/query.rb#31
  def root_value; end

  # source://graphql/2.0.14/lib/graphql/query.rb#31
  def root_value=(_arg0); end

  # source://graphql/2.0.14/lib/graphql/query.rb#254
  def sanitized_query_string(inline_variables: T.unsafe(nil)); end

  # source://graphql/2.0.14/lib/graphql/query.rb#28
  def schema; end

  # source://graphql/2.0.14/lib/graphql/query.rb#215
  def selected_operation; end

  # source://graphql/2.0.14/lib/graphql/query.rb#65
  def selected_operation_name; end

  # source://graphql/2.0.14/lib/graphql/query.rb#208
  def static_errors; end

  # source://graphql/2.0.14/lib/graphql/query.rb#338
  def subscription?; end

  # source://graphql/2.0.14/lib/graphql/query.rb#71
  def subscription_topic; end

  # source://graphql/2.0.14/lib/graphql/query.rb#160
  def subscription_update?; end

  # source://graphql/2.0.14/lib/graphql/query.rb#73
  def tracers; end

  # source://graphql/2.0.14/lib/graphql/query.rb#294
  def valid?; end

  # source://graphql/2.0.14/lib/graphql/query.rb#37
  def validate; end

  # source://graphql/2.0.14/lib/graphql/query.rb#40
  def validate=(new_validate); end

  # source://forwardable/1.3.2/forwardable.rb#229
  def validation_errors(*args, **_arg1, &block); end

  # source://graphql/2.0.14/lib/graphql/query.rb#286
  def validation_pipeline; end

  # source://graphql/2.0.14/lib/graphql/query.rb#225
  def variables; end

  # source://graphql/2.0.14/lib/graphql/query.rb#282
  def variables_fingerprint; end

  # source://graphql/2.0.14/lib/graphql/query.rb#298
  def warden; end

  private

  # source://graphql/2.0.14/lib/graphql/query.rb#349
  def find_operation(operations, operation_name); end

  # source://graphql/2.0.14/lib/graphql/query.rb#423
