...
#
# source://friendly_id//lib/friendly_id/slugged.rb#238
module FriendlyId::Slugged
  ...
  # @return [Boolean]
  #
  # source://friendly_id//lib/friendly_id/slugged.rb#299
  def should_generate_new_friendly_id?; end
  ...
  #
  # source://friendly_id//lib/friendly_id/slugged.rb#333
  ...
  #
  # source://friendly_id//lib/friendly_id/slugged.rb#345
  ...
  # Sets the slug.
  #
  # source://friendly_id//lib/friendly_id/slugged.rb#354
  def set_slug(normalized_slug = T.unsafe(nil)); end

  # source://friendly_id//lib/friendly_id/slugged.rb#371
  def slug_generator; end

  # source://friendly_id//lib/friendly_id/slugged.rb#376
  ...
  class << self
    ...
    # feature.
    #
    # source://friendly_id//lib/friendly_id/slugged.rb#241
    def included(model_class); end
  end
end
...
module FriendlyId::Slugged::Configuration
  ...
  #
  # source://friendly_id//lib/friendly_id/slugged.rb#393
  def query_field; end
  ...
  #
  # source://friendly_id//lib/friendly_id/slugged.rb#403
  def sequence_separator; end
  ...
  # @param value the value to set the attribute sequence_separator to.
  #
  # source://friendly_id//lib/friendly_id/slugged.rb#388
  def sequence_separator=(_arg0); end

  # The column that will be used to store the generated slug.
  #
  # source://friendly_id//lib/friendly_id/slugged.rb#408
  def slug_column; end
  ...
  #
  # source://friendly_id//lib/friendly_id/slugged.rb#413
  def slug_limit; end
