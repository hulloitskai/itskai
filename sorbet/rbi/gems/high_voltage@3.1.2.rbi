...
# source://high_voltage//lib/high_voltage/configuration.rb#1
module HighVoltage
  extend ::HighVoltage::Configuration
end

# source://high_voltage//lib/high_voltage/configuration.rb#2
module HighVoltage::Configuration
  # @yield [_self]
  # @yieldparam _self [HighVoltage::Configuration] the object that the method was called on
  #
  # source://high_voltage//lib/high_voltage/configuration.rb#12
  def configure; end

  # Returns the value of attribute content_path.
  #
  # source://high_voltage//lib/high_voltage/configuration.rb#3
  ...
  # source://high_voltage//lib/high_voltage/configuration.rb#24
  def full_path; end
  ...
  # source://high_voltage//lib/high_voltage/configuration.rb#20
  def page_ids; end
  ...
  # source://high_voltage//lib/high_voltage/configuration.rb#28
  def set_default_configuration; end

  class << self
    # @private
    #
    # source://high_voltage//lib/high_voltage/configuration.rb#16
    def extended(base); end
  end
end

# source://high_voltage//lib/high_voltage/constraints/root_route.rb#2
module HighVoltage::Constraints; end

# Routing constraint to validate request.path has a corresponding view
#
# source://high_voltage//lib/high_voltage/constraints/root_route.rb#4
class HighVoltage::Constraints::RootRoute
  # @return [RootRoute] a new instance of RootRoute
  #
  # source://high_voltage//lib/high_voltage/constraints/root_route.rb#5
  def initialize; end

  # @return [Boolean]
  #
  # source://high_voltage//lib/high_voltage/constraints/root_route.rb#11
  def matches?(request); end

  private

  # source://high_voltage//lib/high_voltage/constraints/root_route.rb#21
  def clean_page_path(request_path); end

  # source://high_voltage//lib/high_voltage/constraints/root_route.rb#25
  def content_path; end

  # Returns the value of attribute lookup_context.
  #
  # source://high_voltage//lib/high_voltage/constraints/root_route.rb#19
  def lookup_context; end
end

# source://high_voltage//lib/high_voltage/engine.rb#2
...
# source://high_voltage//lib/high_voltage/page_finder.rb#35
class HighVoltage::InvalidPageIdError < ::StandardError; end

# source://high_voltage//lib/high_voltage/page.rb#2
class HighVoltage::Page
  # @return [Page] a new instance of Page
  #
  # source://high_voltage//lib/high_voltage/page.rb#5
  def initialize(content_path, file_path); end

  # Returns the value of attribute content_path.
  #
  # source://high_voltage//lib/high_voltage/page.rb#3
  def content_path; end
  ...
  # source://high_voltage//lib/high_voltage/page.rb#10
  def id; end

  # @return [Boolean]
  #
  # source://high_voltage//lib/high_voltage/page.rb#14
  def valid?; end

  private

  # source://high_voltage//lib/high_voltage/page.rb#44
  def available_handlers; end

  # @return [Boolean]
  #
  # source://high_voltage//lib/high_voltage/page.rb#32
  def directory?; end

  # @return [Boolean]
  #
  # source://high_voltage//lib/high_voltage/page.rb#24
  def exists?; end

  # @return [Boolean]
  #
  # source://high_voltage//lib/high_voltage/page.rb#28
  def file_in_content_path?; end

  # @return [Boolean]
  #
  # source://high_voltage//lib/high_voltage/page.rb#40
  def handled?; end

  # source://high_voltage//lib/high_voltage/page.rb#20
  def handler_extension; end

  # @return [Boolean]
  #
  # source://high_voltage//lib/high_voltage/page.rb#36
  def partial?; end
end

# source://high_voltage//lib/high_voltage/page_collector.rb#4
class HighVoltage::PageCollector
  # @return [PageCollector] a new instance of PageCollector
  #
  # source://high_voltage//lib/high_voltage/page_collector.rb#7
  def initialize(content_path); end

  # Returns the value of attribute content_path.
  #
  # source://high_voltage//lib/high_voltage/page_collector.rb#5
  def content_path; end

  # source://high_voltage//lib/high_voltage/page_collector.rb#11
  def page_ids; end

  private

  # source://high_voltage//lib/high_voltage/page_collector.rb#17
  def pages; end
end
...
#
# source://high_voltage//lib/high_voltage/page_finder.rb#4
class HighVoltage::PageFinder
  # @return [PageFinder] a new instance of PageFinder
  #
  # source://high_voltage//lib/high_voltage/page_finder.rb#5
  def initialize(page_id); end

  # source://high_voltage//lib/high_voltage/page_finder.rb#21
  def content_path; end

  # Produce a template path to the page, in a format understood by
  # `render :template => find`
  #
  # source://high_voltage//lib/high_voltage/page_finder.rb#11
  def find; end

  protected

  # source://high_voltage//lib/high_voltage/page_finder.rb#30
  def clean_content_pathname; end

  # The raw page id passed in by the user
  #
  # source://high_voltage//lib/high_voltage/page_finder.rb#28
  def page_id; end
end
...
# source://high_voltage//lib/high_voltage/route_drawers/default.rb#2
...
#
# source://high_voltage//lib/high_voltage/route_drawers/default.rb#5
class HighVoltage::RouteDrawers::Default
  class << self
    # source://high_voltage//lib/high_voltage/route_drawers/default.rb#6
...
#
# source://high_voltage//lib/high_voltage/route_drawers/root.rb#5
class HighVoltage::RouteDrawers::Root
  class << self
    # source://high_voltage//lib/high_voltage/route_drawers/root.rb#6
    def match_attributes; end
  end
end
...
# source://high_voltage//lib/high_voltage/version.rb#2
