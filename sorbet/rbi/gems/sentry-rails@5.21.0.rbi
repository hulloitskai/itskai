...
# source://sentry-rails//lib/sentry/rails/background_worker.rb#4
class Sentry::BackgroundWorker
  # source://sentry-ruby/5.21.0/lib/sentry/background_worker.rb#18
  def initialize(configuration); end

  # source://sentry-rails//lib/sentry/rails/background_worker.rb#5
  def _perform(&block); end

  # source://sentry-ruby/5.21.0/lib/sentry/background_worker.rb#68
  def full?; end

  # source://sentry-ruby/5.21.0/lib/sentry/background_worker.rb#13
  def logger; end

  # source://sentry-ruby/5.21.0/lib/sentry/background_worker.rb#11
  def max_queue; end

  # source://sentry-ruby/5.21.0/lib/sentry/background_worker.rb#11
  def number_of_threads; end

  # source://sentry-ruby/5.21.0/lib/sentry/background_worker.rb#53
  def perform(&block); end

  # source://sentry-ruby/5.21.0/lib/sentry/background_worker.rb#63
  def shutdown; end

  # source://sentry-ruby/5.21.0/lib/sentry/background_worker.rb#14
...
# source://sentry-rails//lib/sentry/rails/action_cable.rb#75
module Sentry::Rails::ActionCableExtensions::Channel; end

# source://sentry-rails//lib/sentry/rails/action_cable.rb#93
module Sentry::Rails::ActionCableExtensions::Channel::Actions
  private

  # source://sentry-rails//lib/sentry/rails/action_cable.rb#96
  def dispatch_action(action, data); end
end

# source://sentry-rails//lib/sentry/rails/action_cable.rb#76
module Sentry::Rails::ActionCableExtensions::Channel::Subscriptions
  private

  # source://sentry-rails//lib/sentry/rails/action_cable.rb#86
...
# source://sentry-rails//lib/sentry/rails/action_cable.rb#6
class Sentry::Rails::ActionCableExtensions::ErrorHandler
  class << self
    # source://sentry-rails//lib/sentry/rails/action_cable.rb#11
    ...
    # source://sentry-rails//lib/sentry/rails/action_cable.rb#38
    def start_transaction(env, scope); end
  end
end

# source://sentry-rails//lib/sentry/rails/action_cable.rb#7
...
# source://sentry-rails//lib/sentry/rails/active_job.rb#5
module Sentry::Rails::ActiveJobExtensions
  # @return [Boolean]
  #
  # source://sentry-rails//lib/sentry/rails/active_job.rb#16
  def already_supported_by_sentry_integration?; end

  # source://sentry-rails//lib/sentry/rails/active_job.rb#6
  def perform_now; end
end

# source://sentry-rails//lib/sentry/rails/active_job.rb#20
class Sentry::Rails::ActiveJobExtensions::SentryReporter
  class << self
    # source://sentry-rails//lib/sentry/rails/active_job.rb#62
    def finish_sentry_transaction(transaction, status); end

    # source://sentry-rails//lib/sentry/rails/active_job.rb#25
    def record(job, &block); end

    # source://sentry-rails//lib/sentry/rails/active_job.rb#69
    def sentry_context(job); end

    # source://sentry-rails//lib/sentry/rails/active_job.rb#80
    def sentry_serialize_arguments(argument); end
  end
end

# source://sentry-rails//lib/sentry/rails/active_job.rb#21
...
module Sentry::Rails::Breadcrumb::ActiveSupportLogger
  class << self
    # source://sentry-rails//lib/sentry/rails/breadcrumb/active_support_logger.rb#8
    def add(name, started, _finished, _unique_id, data); end

    # source://sentry-rails//lib/sentry/rails/breadcrumb/active_support_logger.rb#35
    def detach; end

    # source://sentry-rails//lib/sentry/rails/breadcrumb/active_support_logger.rb#24
...
# source://sentry-rails//lib/sentry/rails/controller_methods.rb#5
module Sentry::Rails::ControllerMethods
  # source://sentry-rails//lib/sentry/rails/controller_methods.rb#12
  def capture_exception(exception, options = T.unsafe(nil)); end

  # source://sentry-rails//lib/sentry/rails/controller_methods.rb#6
  def capture_message(message, options = T.unsafe(nil)); end

  private

  # source://sentry-rails//lib/sentry/rails/controller_methods.rb#20
  def with_request_scope; end
end

# source://sentry-rails//lib/sentry/rails/controller_transaction.rb#5
module Sentry::Rails::ControllerTransaction
  private

  # source://sentry-rails//lib/sentry/rails/controller_transaction.rb#14
  def sentry_around_action; end

  class << self
    # @private
    #
    # source://sentry-rails//lib/sentry/rails/controller_transaction.rb#8
    def included(base); end
  end
end

# source://sentry-rails//lib/sentry/rails/controller_transaction.rb#6
...
# source://sentry-rails//lib/sentry/rails/overrides/streaming_reporter.rb#13
module Sentry::Rails::Overrides::OldStreamingReporter
  # source://sentry-rails//lib/sentry/rails/overrides/streaming_reporter.rb#18
  def log_error_with_raven(exception); end

  class << self
    # @private
    #
    # source://sentry-rails//lib/sentry/rails/overrides/streaming_reporter.rb#14
    def included(base); end
  end
end

# source://sentry-rails//lib/sentry/rails/overrides/streaming_reporter.rb#6
module Sentry::Rails::Overrides::StreamingReporter
  # source://sentry-rails//lib/sentry/rails/overrides/streaming_reporter.rb#7
...
class Sentry::SendEventJob < ::ApplicationJob
  ...
  class << self
    # source://activejob/7.1.5/lib/active_job/logging.rb#12
