...
module ActionController::Base::HelperMethods
  ...
  # source://actionpack/7.0.3.1/lib/action_controller/metal/flash.rb#39
  def alert(*args, **_arg1, &block); end

  # source://action_policy/0.6.1/lib/action_policy/rails/controller.rb#27
  def allowed_to?(*args, **_arg1, &block); end

  # source://action_policy/0.6.1/lib/action_policy/rails/controller.rb#28
  ...
  # source://actionpack/7.0.3.1/lib/action_controller/metal/content_security_policy.rb#11
  def content_security_policy?(*args, **_arg1, &block); end

  # source://actionpack/7.0.3.1/lib/action_controller/metal/content_security_policy.rb#12
  def content_security_policy_nonce(*args, **_arg1, &block); end

  # source://actionpack/7.0.3.1/lib/action_controller/metal/cookies.rb#8
  def cookies(*args, **_arg1, &block); end

  # source://devise//lib/devise/controllers/helpers.rb#136
  ...
  # source://actionpack/7.0.3.1/lib/action_controller/metal/request_forgery_protection.rb#106
  def form_authenticity_token(*args, **_arg1, &block); end

  # source://actionpack/7.0.3.1/lib/action_controller/metal/flash.rb#39
  def notice(*args, **_arg1, &block); end

  # source://actionpack/7.0.3.1/lib/action_controller/metal/request_forgery_protection.rb#107
...
class ActionDispatch::Routing::RouteSet
  ...
  # source://actionpack/7.0.3.1/lib/action_dispatch/routing/route_set.rb#366
  def initialize(config = T.unsafe(nil)); end

  # source://actionpack/7.0.3.1/lib/action_dispatch/routing/route_set.rb#615
  def add_polymorphic_mapping(klass, options, &block); end

  # source://actionpack/7.0.3.1/lib/action_dispatch/routing/route_set.rb#584
  def add_route(mapping, name); end

  # source://actionpack/7.0.3.1/lib/action_dispatch/routing/route_set.rb#619
  def add_url_helper(name, options, &block); end

  # source://actionpack/7.0.3.1/lib/action_dispatch/routing/route_set.rb#395
  def api_only?; end

  # source://actionpack/7.0.3.1/lib/action_dispatch/routing/route_set.rb#415
  def append(&block); end

  # source://actionpack/7.0.3.1/lib/action_dispatch/routing/route_set.rb#849
  def call(env); end

  # source://actionpack/7.0.3.1/lib/action_dispatch/routing/route_set.rb#439
  def clear!; end

  # source://actionpack/7.0.3.1/lib/action_dispatch/routing/route_set.rb#336
  def default_scope; end

  # source://actionpack/7.0.3.1/lib/action_dispatch/routing/route_set.rb#336
  def default_scope=(_arg0); end

  # source://actionpack/7.0.3.1/lib/action_dispatch/routing/route_set.rb#338
  def default_url_options; end

  # source://actionpack/7.0.3.1/lib/action_dispatch/routing/route_set.rb#338
  def default_url_options=(_arg0); end

  # source://actionpack/7.0.3.1/lib/action_dispatch/routing/route_set.rb#461
  def define_mounted_helper(name, script_namer = T.unsafe(nil)); end

  # source://actionpack/7.0.3.1/lib/action_dispatch/routing/route_set.rb#337
  def disable_clear_and_finalize; end

  # source://actionpack/7.0.3.1/lib/action_dispatch/routing/route_set.rb#337
  def disable_clear_and_finalize=(_arg0); end

  # source://actionpack/7.0.3.1/lib/action_dispatch/routing/route_set.rb#408
  def draw(&block); end
  ...
  # source://actionpack/7.0.3.1/lib/action_dispatch/routing/route_set.rb#385
  def eager_load!; end

  # source://actionpack/7.0.3.1/lib/action_dispatch/routing/route_set.rb#580
  def empty?; end

  # source://actionpack/7.0.3.1/lib/action_dispatch/routing/route_set.rb#339
  def env_key; end

  # source://actionpack/7.0.3.1/lib/action_dispatch/routing/route_set.rb#760
  def extra_keys(options, recall = T.unsafe(nil)); end

  # source://devise//lib/devise/rails/routes.rb#8
  def finalize!; end

  # source://actionpack/7.0.3.1/lib/action_dispatch/routing/route_set.rb#792
  def find_relative_url_root(options); end

  # source://actionpack/7.0.3.1/lib/action_dispatch/routing/route_set.rb#788
  ...
  # source://actionpack/7.0.3.1/lib/action_dispatch/routing/route_set.rb#764
  def generate_extras(options, recall = T.unsafe(nil)); end

  # source://actionpack/7.0.3.1/lib/action_dispatch/routing/route_set.rb#488
  def generate_url_helpers(supports_path); end

  def inspect; end

  # source://actionpack/7.0.3.1/lib/action_dispatch/routing/route_set.rb#457
  ...
  # source://actionpack/7.0.3.1/lib/action_dispatch/routing/route_set.rb#784
  def optimize_routes_generation?; end

  # source://actionpack/7.0.3.1/lib/action_dispatch/routing/route_set.rb#796
  def path_for(options, route_name = T.unsafe(nil), reserved = T.unsafe(nil)); end

  # source://actionpack/7.0.3.1/lib/action_dispatch/routing/route_set.rb#339
  def polymorphic_mappings; end

  # source://actionpack/7.0.3.1/lib/action_dispatch/routing/route_set.rb#419
  def prepend(&block); end

  # source://actionpack/7.0.3.1/lib/action_dispatch/routing/route_set.rb#855
  def recognize_path(path, environment = T.unsafe(nil)); end

  # source://actionpack/7.0.3.1/lib/action_dispatch/routing/route_set.rb#870
  def recognize_path_with_request(req, path, extras, raise_on_missing: T.unsafe(nil)); end

  # source://actionpack/7.0.3.1/lib/action_dispatch/routing/route_set.rb#391
  def relative_url_root; end

  # source://actionpack/7.0.3.1/lib/action_dispatch/routing/route_set.rb#399
  ...
  # source://actionpack/7.0.3.1/lib/action_dispatch/routing/route_set.rb#801
  def url_for(options, route_name = T.unsafe(nil), url_strategy = T.unsafe(nil), method_name = T.unsafe(nil), reserved = T.unsafe(nil)); end

  # source://actionpack/7.0.3.1/lib/action_dispatch/routing/route_set.rb#480
  def url_helpers(supports_path = T.unsafe(nil)); end

  private

  # source://actionpack/7.0.3.1/lib/action_dispatch/routing/route_set.rb#423
  def eval_block(block); end

  # source://actionpack/7.0.3.1/lib/action_dispatch/routing/route_set.rb#775
  def generate(route_name, options, recall = T.unsafe(nil), method_name = T.unsafe(nil)); end

  # source://actionpack/7.0.3.1/lib/action_dispatch/routing/route_set.rb#403
  def make_request(env); end

  class << self
    # source://actionpack/7.0.3.1/lib/action_dispatch/routing/route_set.rb#343
    def default_resources_path_names; end

    # source://actionpack/7.0.3.1/lib/action_dispatch/routing/route_set.rb#347
    def new_with_config(config); end
  end
end

# source://actionpack/7.0.3.1/lib/action_dispatch/routing/route_set.rb#364
ActionDispatch::Routing::RouteSet::DEFAULT_CONFIG = T.let(T.unsafe(nil), ActionDispatch::Routing::RouteSet::Config)

# source://actionpack/7.0.3.1/lib/action_dispatch/routing/route_set.rb#333
ActionDispatch::Routing::RouteSet::PATH = T.let(T.unsafe(nil), Proc)

# source://actionpack/7.0.3.1/lib/action_dispatch/routing/route_set.rb#780
ActionDispatch::Routing::RouteSet::RESERVED_OPTIONS = T.let(T.unsafe(nil), Array)

# source://actionpack/7.0.3.1/lib/action_dispatch/routing/route_set.rb#334
...
module Devise
  # source://devise_invitable/2.0.6/lib/devise_invitable.rb#78
  ...
  # source://devise_invitable/2.0.6/lib/devise_invitable.rb#40
  def invitation_limit; end

  # source://devise_invitable/2.0.6/lib/devise_invitable.rb#40
  def invitation_limit=(val); end

  # source://devise_invitable/2.0.6/lib/devise_invitable.rb#22
  def invite_for; end

  # source://devise_invitable/2.0.6/lib/devise_invitable.rb#22
  def invite_for=(val); end

  # source://devise_invitable/2.0.6/lib/devise_invitable.rb#49
  def invite_key; end

  # source://devise_invitable/2.0.6/lib/devise_invitable.rb#49
  def invite_key=(val); end

  # source://devise_invitable/2.0.6/lib/devise_invitable.rb#63
  def invited_by_class_name; end

  # source://devise_invitable/2.0.6/lib/devise_invitable.rb#63
  def invited_by_class_name=(val); end

  # source://devise_invitable/2.0.6/lib/devise_invitable.rb#73
  def invited_by_counter_cache; end

  # source://devise_invitable/2.0.6/lib/devise_invitable.rb#73
  def invited_by_counter_cache=(val); end

  # source://devise_invitable/2.0.6/lib/devise_invitable.rb#68
  ...
  # source://devise_invitable/2.0.6/lib/devise_invitable.rb#84
  def require_password_on_accepting; end

  # source://devise_invitable/2.0.6/lib/devise_invitable.rb#84
  def require_password_on_accepting=(val); end

  # source://devise_invitable/2.0.6/lib/devise_invitable.rb#58
  ...
  # source://devise_invitable/2.0.6/lib/devise_invitable.rb#32
...
module Devise::Controllers::Helpers
  ...
  # source://devise//lib/devise/controllers/helpers.rb#116
  def authenticate_user!(opts = T.unsafe(nil)); end

  # source://devise//lib/devise/controllers/helpers.rb#125
  ...
  # source://devise//lib/devise/controllers/helpers.rb#129
  def user_session; end

  # source://devise//lib/devise/controllers/helpers.rb#121
...
class Devise::Mapping
  ...
  # source://devise_invitable/2.0.6/lib/devise_invitable/mapping.rb#5
...
class Devise::ParameterSanitizer
  ...
  #
  # source://devise_invitable/2.0.6/lib/devise_invitable/parameter_sanitizer.rb#31
