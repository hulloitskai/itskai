...
module ActiveRecord::ConnectionHandling
  # source://activerecord/7.1.1/lib/active_record/connection_handling.rb#319
  def clear_active_connections!(role = T.unsafe(nil)); end

  # source://activerecord/7.1.1/lib/active_record/connection_handling.rb#329
  def clear_all_connections!(role = T.unsafe(nil)); end

  # source://activerecord/7.1.1/lib/active_record/connection_handling.rb#315
  def clear_cache!; end

  # source://activerecord/7.1.1/lib/active_record/connection_handling.rb#244
  def clear_query_caches_for_current_thread; end

  # source://activerecord/7.1.1/lib/active_record/connection_handling.rb#324
  def clear_reloadable_connections!(role = T.unsafe(nil)); end

  # source://activerecord/7.1.1/lib/active_record/connection_handling.rb#291
  def connected?; end

  # source://activerecord/7.1.1/lib/active_record/connection_handling.rb#134
  def connected_to(role: T.unsafe(nil), shard: T.unsafe(nil), prevent_writes: T.unsafe(nil), &blk); end

  # source://activerecord/7.1.1/lib/active_record/connection_handling.rb#239
  def connected_to?(role:, shard: T.unsafe(nil)); end

  # source://activerecord/7.1.1/lib/active_record/connection_handling.rb#163
  def connected_to_many(*classes, role:, shard: T.unsafe(nil), prevent_writes: T.unsafe(nil)); end

  # source://activerecord/7.1.1/lib/active_record/connection_handling.rb#185
  def connecting_to(role: T.unsafe(nil), shard: T.unsafe(nil), prevent_writes: T.unsafe(nil)); end

  # source://activerecord/7.1.1/lib/active_record/connection_handling.rb#253
  def connection; end

  # source://activerecord/7.1.1/lib/active_record/connection_handling.rb#278
  def connection_db_config; end

  # source://activerecord/7.1.1/lib/active_record/connection_handling.rb#282
  def connection_pool; end

  # source://activerecord/7.1.1/lib/active_record/connection_handling.rb#260
  def connection_specification_name; end

  # source://activerecord/7.1.1/lib/active_record/connection_handling.rb#257
  def connection_specification_name=(_arg0); end

  # source://activerecord/7.1.1/lib/active_record/connection_handling.rb#81
  def connects_to(database: T.unsafe(nil), shards: T.unsafe(nil)); end

  # source://activerecord/7.1.1/lib/active_record/connection_handling.rb#50
  def establish_connection(config_or_env = T.unsafe(nil)); end

  # source://activerecord/7.1.1/lib/active_record/connection_handling.rb#334
  ...
  # source://activerecord/7.1.1/lib/active_record/connection_adapters/postgresql_adapter.rb#24
  def postgresql_adapter_class; end

  # source://activerecord/7.1.1/lib/active_record/connection_adapters/postgresql_adapter.rb#29
  def postgresql_connection(config); end

  # source://activerecord/7.1.1/lib/active_record/connection_handling.rb#267
  def primary_class?; end

  # source://activerecord/7.1.1/lib/active_record/connection_handling.rb#197
  def prohibit_shard_swapping(enabled = T.unsafe(nil)); end

  # source://activerecord/7.1.1/lib/active_record/connection_handling.rb#295
  def remove_connection(name = T.unsafe(nil)); end

  # source://activerecord/7.1.1/lib/active_record/connection_handling.rb#286
  def retrieve_connection; end

  # source://activerecord/7.1.1/lib/active_record/connection_handling.rb#206
  def shard_swapping_prohibited?; end

  # source://activerecord/7.1.1/lib/active_record/connection_handling.rb#221
  def while_preventing_writes(enabled = T.unsafe(nil), &block); end

  private

  # source://activerecord/7.1.1/lib/active_record/connection_handling.rb#368
  def append_to_connected_to_stack(entry); end

  # source://activerecord/7.1.1/lib/active_record/connection_handling.rb#340
  def deprecation_for_delegation(method); end

  # source://activerecord/7.1.1/lib/active_record/connection_handling.rb#348
  def resolve_config_for_connection(config_or_env); end

  # source://activerecord/7.1.1/lib/active_record/connection_handling.rb#357
...
module ActiveRecord::Type
  ...
  class << self
    # source://activerecord/7.1.1/lib/active_record/type.rb#49
    def adapter_name_from(model); end

    # source://activerecord/7.1.1/lib/active_record/type.rb#27
    def add_modifier(*_arg0, **_arg1, &_arg2); end

    # source://activerecord/7.1.1/lib/active_record/type.rb#45
    def default_value; end

    # source://activerecord-postgis-adapter//lib/active_record/connection_adapters/postgis/type.rb#9
    def lookup(*args, adapter: T.unsafe(nil), **kwargs); end

    # source://activerecord/7.1.1/lib/active_record/type.rb#37
    def register(type_name, klass = T.unsafe(nil), **options, &block); end

    # source://activerecord/7.1.1/lib/active_record/type.rb#26
    def registry; end
    ...
    # source://activerecord/7.1.1/lib/active_record/type.rb#54
