...
module Reline
  ...
  class << self
    # source://reline//lib/reline.rb#538
    def core; end

    # source://reline//lib/reline.rb#534
    def encoding_system_needs; end

    # source://reline//lib/reline.rb#515
    def insert_text(*args, &block); end

    # source://reline//lib/reline.rb#558
    def line_editor; end
...
class Reline::Config
  ...
  # source://reline//lib/reline/config.rb#170
  ...
  # source://reline//lib/reline/config.rb#85
  def editing_mode; end

  # source://reline//lib/reline/config.rb#89
  def editing_mode=(val); end

  # @return [Boolean]
  #
  # source://reline//lib/reline/config.rb#93
  ...
  # source://reline//lib/reline/config.rb#224
  ...
  # source://reline//lib/reline/config.rb#101
  ...
  # source://reline//lib/reline/config.rb#97
  def keymap; end
  ...
  # source://reline//lib/reline/config.rb#131
  def read(file = T.unsafe(nil)); end

  # source://reline//lib/reline/config.rb#180
  def read_lines(lines, file = T.unsafe(nil)); end

  # source://reline//lib/reline/config.rb#74
  def reset; end

  # source://reline//lib/reline/config.rb#174
  ...
  # source://reline//lib/reline/config.rb#127
...
class Reline::Core
  ...
  # source://reline//lib/reline.rb#284
  def readline(prompt = T.unsafe(nil), add_hist = T.unsafe(nil)); end

  # source://reline//lib/reline.rb#257
  ...
  # source://reline//lib/reline.rb#302
  ...
  #
  # source://reline//lib/reline.rb#381
...
# source://reline//lib/reline.rb#255
