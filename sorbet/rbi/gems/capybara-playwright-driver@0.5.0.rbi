...
module Capybara
  class << self
    # source://capybara/3.39.2/lib/capybara.rb#389
    def HTML(html); end

    # source://capybara/3.39.2/lib/capybara.rb#182
    ...
    # source://capybara/3.39.2/lib/capybara.rb#114
    def configure; end

    # source://capybara/3.39.2/lib/capybara.rb#261
    def current_driver; end

    # source://capybara/3.39.2/lib/capybara.rb#270
    def current_driver=(name); end

    # source://capybara/3.39.2/lib/capybara.rb#316
    ...
    # source://capybara/3.39.2/lib/capybara.rb#204
    def drivers; end
    ...
    # source://capybara/3.39.2/lib/capybara.rb#200
    ...
    # source://capybara/3.39.2/lib/capybara.rb#131
    def register_driver(name, &block); end

    # source://capybara/3.39.2/lib/capybara.rb#150
    def register_server(name, &block); end

    # source://capybara/3.39.2/lib/capybara.rb#325
    def reset!; end
    ...
    # source://capybara/3.39.2/lib/capybara.rb#253
    ...
    # source://capybara/3.39.2/lib/capybara.rb#208
    def servers; end

    # source://capybara/3.39.2/lib/capybara.rb#337
    def session_name; end

    # source://capybara/3.39.2/lib/capybara.rb#345
    def session_name=(name); end

    # source://capybara/3.39.2/lib/capybara.rb#409
    def session_options; end

    # source://capybara/3.39.2/lib/capybara.rb#240
    def string(html); end
    ...
    # source://capybara/3.39.2/lib/capybara.rb#282
    ...
    # source://capybara/3.39.2/lib/capybara.rb#290
    def using_driver(driver); end

    # source://capybara/3.39.2/lib/capybara.rb#357
    def using_session(name_or_session, &block); end

    # source://capybara/3.39.2/lib/capybara.rb#302
    ...
    # source://capybara/3.39.2/lib/capybara.rb#415
    def config; end

    # source://capybara/3.39.2/lib/capybara.rb#419
    def session_pool; end

    # source://capybara/3.39.2/lib/capybara.rb#425
    def specified_session; end

    # source://capybara/3.39.2/lib/capybara.rb#433
...
#
# source://capybara-playwright-driver//lib/capybara/playwright/browser.rb#11
class Capybara::Playwright::Browser
  ...
  #
  # source://capybara-playwright-driver//lib/capybara/playwright/browser.rb#17
  ...
  # source://capybara-playwright-driver//lib/capybara/playwright/browser.rb#344
  def accept_modal(dialog_type, **options, &block); end

  # source://capybara-playwright-driver//lib/capybara/playwright/browser.rb#184
  def active_element; end

  # source://capybara-playwright-driver//lib/capybara/playwright/browser.rb#55
  def clear_browser_contexts; end

  # source://capybara-playwright-driver//lib/capybara/playwright/browser.rb#303
  def close_window(handle); end

  # source://capybara-playwright-driver//lib/capybara/playwright/browser.rb#67
  def current_url; end

  # source://capybara-playwright-driver//lib/capybara/playwright/browser.rb#271
  def current_window_handle; end

  # source://capybara-playwright-driver//lib/capybara/playwright/browser.rb#350
  def dismiss_modal(dialog_type, **options, &block); end

  # source://capybara-playwright-driver//lib/capybara/playwright/browser.rb#168
  def evaluate_async_script(script, *args); end

  # source://capybara-playwright-driver//lib/capybara/playwright/browser.rb#161
  def evaluate_script(script, *args); end

  # source://capybara-playwright-driver//lib/capybara/playwright/browser.rb#154
  def execute_script(script, *args); end

  # source://capybara-playwright-driver//lib/capybara/playwright/browser.rb#102
  def find_css(query, **options); end

  # source://capybara-playwright-driver//lib/capybara/playwright/browser.rb#94
  def find_xpath(query, **options); end

  # source://capybara-playwright-driver//lib/capybara/playwright/browser.rb#335
  def fullscreen_window(handle); end

  # source://capybara-playwright-driver//lib/capybara/playwright/browser.rb#142
  def go_back; end

  # source://capybara-playwright-driver//lib/capybara/playwright/browser.rb#148
  def go_forward; end

  # source://capybara-playwright-driver//lib/capybara/playwright/browser.rb#122
  def html; end

  # source://capybara-playwright-driver//lib/capybara/playwright/browser.rb#325
  def maximize_window(handle); end

  # source://capybara-playwright-driver//lib/capybara/playwright/browser.rb#275
  def open_new_window(kind = T.unsafe(nil)); end

  # Not used by Capybara::Session.
  # Intended to be directly called by user.
  #
  # source://capybara-playwright-driver//lib/capybara/playwright/browser.rb#203
  def raw_screenshot(**options); end

  # source://capybara-playwright-driver//lib/capybara/playwright/browser.rb#88
  def refresh; end

  # source://capybara-playwright-driver//lib/capybara/playwright/browser.rb#319
  def resize_window_to(handle, width, height); end

  # source://capybara-playwright-driver//lib/capybara/playwright/browser.rb#110
  def response_headers; end

  # source://capybara-playwright-driver//lib/capybara/playwright/browser.rb#209
  def save_screenshot(path, **options); end

  # source://capybara-playwright-driver//lib/capybara/playwright/browser.rb#215
  def send_keys(*args); end

  # source://capybara-playwright-driver//lib/capybara/playwright/browser.rb#116
  def status_code; end

  # source://capybara-playwright-driver//lib/capybara/playwright/browser.rb#219
  def switch_to_frame(frame); end

  # source://capybara-playwright-driver//lib/capybara/playwright/browser.rb#295
  def switch_to_window(handle); end

  # source://capybara-playwright-driver//lib/capybara/playwright/browser.rb#136
  def title; end

  # Not used by Capybara::Session.
  # Intended to be directly called by user.
  #
  # source://capybara-playwright-driver//lib/capybara/playwright/browser.rb#195
  def video_path; end

  # source://capybara-playwright-driver//lib/capybara/playwright/browser.rb#73
  def visit(path); end

  # source://capybara-playwright-driver//lib/capybara/playwright/browser.rb#267
  def window_handles; end

  # source://capybara-playwright-driver//lib/capybara/playwright/browser.rb#313
  def window_size(handle); end

  # source://capybara-playwright-driver//lib/capybara/playwright/browser.rb#402
  ...
  #
  # source://capybara-playwright-driver//lib/capybara/playwright/browser.rb#236
  def assert_page_alive(retry_count: T.unsafe(nil), &block); end

  # source://capybara-playwright-driver//lib/capybara/playwright/browser.rb#30
  def create_browser_context; end

  # source://capybara-playwright-driver//lib/capybara/playwright/browser.rb#45
  def create_page(browser_context); end

  # source://capybara-playwright-driver//lib/capybara/playwright/browser.rb#286
  def on_window(handle, &block); end

  # source://capybara-playwright-driver//lib/capybara/playwright/browser.rb#263
  def pages; end

  # source://capybara-playwright-driver//lib/capybara/playwright/browser.rb#356
  def unwrap_node(args); end

  # source://capybara-playwright-driver//lib/capybara/playwright/browser.rb#366
  def wrap_node(arg); end
end

# source://capybara-playwright-driver//lib/capybara/playwright/browser.rb#15
