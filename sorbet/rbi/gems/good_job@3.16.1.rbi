...
module ActiveJob
  class << self
    # source://activejob/7.0.6/lib/active_job/gem_version.rb#5
    def gem_version; end

    # source://activejob/7.0.6/lib/active_job/version.rb#7
    def version; end
  end
end
...
module ActiveJob::QueueAdapters
  class << self
    # source://activejob/7.0.6/lib/active_job/queue_adapters.rb#136
    def lookup(name); end
  end
end
...
module GoodJob
  ...
  # source://good_job//lib/good_job.rb#50
  def active_record_parent_class; end

  # source://good_job//lib/good_job.rb#50
  def active_record_parent_class=(val); end

  # source://good_job//lib/good_job.rb#100
  def capsule; end

  # source://good_job//lib/good_job.rb#100
  def capsule=(val); end

  # source://good_job//lib/good_job.rb#94
  def configuration; end

  # source://good_job//lib/good_job.rb#94
  def configuration=(val); end

  # source://good_job//lib/good_job.rb#59
  def logger; end
  ...
  # source://good_job//lib/good_job.rb#78
  ...
  class << self
    ...
    # @return [void]
    #
    # source://good_job//lib/good_job.rb#159
    ...
    #
    # source://good_job//lib/good_job.rb#179
    ...
    #
    # source://good_job//lib/good_job.rb#242
    def deprecator; end
    ...
    # @return [void]
    #
    # source://good_job//lib/good_job.rb#231
    ...
    # @return [void]
    #
    # source://good_job//lib/good_job.rb#150
    ...
    #
    # source://good_job//lib/good_job.rb#139
    def shutdown?; end
...
class GoodJob::Adapter
  ...
  # @return [GoodJob::Execution]
  #
  # source://good_job//lib/good_job/adapter.rb#125
  ...
  # @return [Boolean]
  #
  # source://good_job//lib/good_job/adapter.rb#178
  ...
  # @return [Boolean]
  #
  # source://good_job//lib/good_job/adapter.rb#185
  ...
  # @return [Symbol, nil]
  #
  # source://good_job//lib/good_job/adapter.rb#172
  ...
  # @return [void]
  #
  # source://good_job//lib/good_job/adapter.rb#165
  def shutdown(timeout: T.unsafe(nil)); end
  ...
  # @return [void]
  #
  # source://good_job//lib/good_job/adapter.rb#199
  def start_async; end
...
#
# source://good_job//lib/good_job/assignable_connection.rb#6
...
module GoodJob::AssignableConnection::ClassMethods
  # source://good_job//lib/good_job/assignable_connection.rb#23
  def connection; end

  # source://good_job//lib/good_job/assignable_connection.rb#17
  def connection=(conn); end

  # source://good_job//lib/good_job/assignable_connection.rb#30
...
class GoodJob::BaseExecution < ::GoodJob::BaseRecord
  ...
  class << self
    ...
    def error_event_discarded(*args, **_arg1); end

    # source://activerecord/7.0.6/lib/active_record/scoping/named.rb#174
    def error_event_handled(*args, **_arg1); end

    # source://activerecord/7.0.6/lib/active_record/scoping/named.rb#174
    def error_event_interrupted(*args, **_arg1); end

    def error_event_migrated?; end

    # source://activerecord/7.0.6/lib/active_record/scoping/named.rb#174
    def error_event_retried(*args, **_arg1); end

    # source://activerecord/7.0.6/lib/active_record/scoping/named.rb#174
    def error_event_retry_stopped(*args, **_arg1); end

    # source://activerecord/7.0.6/lib/active_record/scoping/named.rb#174
    def error_event_unhandled(*args, **_arg1); end
    ...
    # source://activerecord/7.0.6/lib/active_record/scoping/named.rb#174
    def not_error_event_discarded(*args, **_arg1); end

    # source://activerecord/7.0.6/lib/active_record/scoping/named.rb#174
    def not_error_event_handled(*args, **_arg1); end

    # source://activerecord/7.0.6/lib/active_record/scoping/named.rb#174
    def not_error_event_interrupted(*args, **_arg1); end

    # source://activerecord/7.0.6/lib/active_record/scoping/named.rb#174
    def not_error_event_retried(*args, **_arg1); end

    # source://activerecord/7.0.6/lib/active_record/scoping/named.rb#174
    def not_error_event_retry_stopped(*args, **_arg1); end

    # source://activerecord/7.0.6/lib/active_record/scoping/named.rb#174
    def not_error_event_unhandled(*args, **_arg1); end
...
class GoodJob::BatchRecord < ::GoodJob::BaseRecord
  ...
  # source://activemodel/7.0.6/lib/active_model/attribute_methods.rb#206
...
class GoodJob::CLI < ::Thor
  ...
  # @return [void]
  #
  # source://good_job//lib/good_job/cli.rb#137
  def cleanup_preserved_jobs; end

  # source://good_job//lib/good_job/cli.rb#150
  ...
  # @return [void]
  #
  # source://good_job//lib/good_job/cli.rb#92
  def start; end

  class << self
    # @return [Boolean]
    #
    # source://good_job//lib/good_job/cli.rb#32
    ...
    # @return [Boolean, nil]
    #
    # source://good_job//lib/good_job/cli.rb#28
    ...
    # @return [Boolean, nil]
    #
    # source://good_job//lib/good_job/cli.rb#23
    def within_exe; end
...
class GoodJob::Capsule
  ...
  #
  # source://good_job//lib/good_job/capsule.rb#15
  ...
  #
  # source://good_job//lib/good_job/capsule.rb#82
  ...
  # @return [void]
  #
  # source://good_job//lib/good_job/capsule.rb#62
  def restart(timeout: T.unsafe(nil)); end

  # @return [Boolean] Whether the capsule is currently running.
  #
  # source://good_job//lib/good_job/capsule.rb#70
  def running?; end
  ...
  # @return [void]
  #
  # source://good_job//lib/good_job/capsule.rb#52
  def shutdown(timeout: T.unsafe(nil)); end

  # @return [Boolean] Whether the capsule has been shutdown.
  #
  # source://good_job//lib/good_job/capsule.rb#75
  def shutdown?; end
  ...
  #
  # source://good_job//lib/good_job/capsule.rb#26
  ...
  # @return [Boolean]
  #
  # source://good_job//lib/good_job/capsule.rb#89
...
class GoodJob::Configuration
  ...
  #
  # source://good_job//lib/good_job/configuration.rb#82
  ...
  # @return [Boolean]
  #
  # source://good_job//lib/good_job/configuration.rb#231
  ...
  # @return [Integer, nil]
  #
  # source://good_job//lib/good_job/configuration.rb#252
  def cleanup_interval_jobs; end
  ...
  # @return [Integer]
  #
  # source://good_job//lib/good_job/configuration.rb#240
  def cleanup_preserved_jobs_before_seconds_ago; end

  # source://good_job//lib/good_job/configuration.rb#203
  def cron; end

  # source://good_job//lib/good_job/configuration.rb#212
  ...
  # @return [Boolean]
  #
  # source://good_job//lib/good_job/configuration.rb#320
  def daemonize?; end
  ...
  # @return [Boolean]
  #
  # source://good_job//lib/good_job/configuration.rb#191
  def enable_cron; end
  ...
  # source://good_job//lib/good_job/configuration.rb#339
  ...
  # @return [Hash]
  #
  # source://good_job//lib/good_job/configuration.rb#48
  def env; end
  ...
  # @return [Symbol]
  #
  # source://good_job//lib/good_job/configuration.rb#94
  def execution_mode; end

  # @return [Boolean]
  #
  # source://good_job//lib/good_job/configuration.rb#160
  ...
  # @return [Integer]
  #
  # source://good_job//lib/good_job/configuration.rb#168
  def max_cache; end
  ...
  # @return [Integer]
  #
  # source://good_job//lib/good_job/configuration.rb#118
  def max_threads; end
  ...
  # @return [Hash]
  #
  # source://good_job//lib/good_job/configuration.rb#42
  def options; end
  ...
  #
  # source://good_job//lib/good_job/configuration.rb#326
  def pidfile; end
  ...
  # @return [Integer]
  #
  # source://good_job//lib/good_job/configuration.rb#144
  ...
  # @return [nil, Integer]
  #
  # source://good_job//lib/good_job/configuration.rb#334
  def probe_port; end
  ...
  # @return [Integer, nil]
  #
  # source://good_job//lib/good_job/configuration.rb#221
  ...
  # @return [String]
  #
  # source://good_job//lib/good_job/configuration.rb#133
  ...
  # @return [Numeric]
  #
  # source://good_job//lib/good_job/configuration.rb#180
  def shutdown_timeout; end

  # source://good_job//lib/good_job/configuration.rb#347
  def smaller_number_is_higher_priority; end

  # source://good_job//lib/good_job/configuration.rb#87
  def validate!; end
  ...
  class << self
    ...
    # @return [Integer]
    #
    # source://good_job//lib/good_job/configuration.rb#53
...
module GoodJob::CurrentThread
  ...
  class << self
    ...
    #
    # source://good_job//lib/good_job/current_thread.rb#92
    def process_id; end
    ...
    #
    # source://good_job//lib/good_job/current_thread.rb#97
    def thread_name; end
    ...
    # @return [Hash]
    #
    # source://good_job//lib/good_job/current_thread.rb#80
    def to_h; end
...
# source://good_job//lib/good_job.rb#41
...
class GoodJob::Daemon
  ...
  # @return [void]
  #
  # source://good_job//lib/good_job/daemon.rb#42
  def check_pid; end

  # @return [void]
  #
  # source://good_job//lib/good_job/daemon.rb#37
  def delete_pid; end

  # @param pidfile [Pathname, String]
  # @return [Symbol]
  #
  # source://good_job//lib/good_job/daemon.rb#53
  def pid_status(pidfile); end

  # @return [void]
  #
  # source://good_job//lib/good_job/daemon.rb#28
  def write_pid; end
end
...
class GoodJob::JobPerformer
  ...
  # @return [void]
  #
  # source://good_job//lib/good_job/job_performer.rb#71
  def cleanup; end
  ...
  #
  # source://good_job//lib/good_job/job_performer.rb#23
  def name; end
  ...
  #
  # source://good_job//lib/good_job/job_performer.rb#29
  def next; end
  ...
  #
  # source://good_job//lib/good_job/job_performer.rb#48
  ...
  # source://good_job//lib/good_job/job_performer.rb#79
  def job_query; end

  # source://good_job//lib/good_job/job_performer.rb#83
  def parsed_queues; end

  # Returns the value of attribute queue_string.
  #
  # source://good_job//lib/good_job/job_performer.rb#77
  def queue_string; end
...
class GoodJob::LogSubscriber < ::ActiveSupport::LogSubscriber
  ...
  # @return [void]
  #
  # source://good_job//lib/good_job/log_subscriber.rb#155
  ...
  # @return [void]
  #
  # source://good_job//lib/good_job/log_subscriber.rb#21
  ...
  # source://good_job//lib/good_job/log_subscriber.rb#247
  ...
  # @return [void]
  #
  # source://good_job//lib/good_job/log_subscriber.rb#41
  ...
  # @return [Logger]
  #
  # source://good_job//lib/good_job/log_subscriber.rb#168
  def logger; end
  ...
  # @return [void]
  #
  # source://good_job//lib/good_job/log_subscriber.rb#123
  ...
  # @return [void]
  #
  # source://good_job//lib/good_job/log_subscriber.rb#130
  ...
  # @return [void]
  #
  # source://good_job//lib/good_job/log_subscriber.rb#139
  ...
  # @return [void]
  #
  # source://good_job//lib/good_job/log_subscriber.rb#148
  ...
  # @return [void]
  #
  # source://good_job//lib/good_job/log_subscriber.rb#112
  ...
  # @return [void]
  #
  # source://good_job//lib/good_job/log_subscriber.rb#51
  ...
  # @return [void]
  #
  # source://good_job//lib/good_job/log_subscriber.rb#103
  ...
  # source://good_job//lib/good_job/log_subscriber.rb#89
  ...
  # @return [void]
  #
  # source://good_job//lib/good_job/log_subscriber.rb#72
  ...
  class << self
    ...
    # @return [Logger]
    #
    # source://good_job//lib/good_job/log_subscriber.rb#192
    def logger; end
    ...
    # @return [Array<Logger>]
    #
    # source://good_job//lib/good_job/log_subscriber.rb#184
    def loggers; end
    ...
    # @return [void]
    #
    # source://good_job//lib/good_job/log_subscriber.rb#206
...
#
# source://good_job//lib/good_job/metrics.rb#5
class GoodJob::Metrics
  # @return [Metrics] a new instance of Metrics
  #
  # source://good_job//lib/good_job/metrics.rb#6
  def initialize; end
  ...
  # @return [Integer]
  #
  # source://good_job//lib/good_job/metrics.rb#15
  ...
  # @return [Integer]
  #
  # source://good_job//lib/good_job/metrics.rb#21
  ...
  # @return [Integer]
  #
  # source://good_job//lib/good_job/metrics.rb#27
  ...
  # @return [Integer]
  #
  # source://good_job//lib/good_job/metrics.rb#33
  def increment_unexecutable_executions; end

  # Reset counters.
  #
  # @return [void]
  #
  # source://good_job//lib/good_job/metrics.rb#50
  def reset; end

  # source://good_job//lib/good_job/metrics.rb#37
  def to_h; end
end
...
class GoodJob::MultiScheduler
  ...
  # @return [Boolean, nil]
  #
  # source://good_job//lib/good_job/multi_scheduler.rb#43
  ...
  # @return [void]
  #
  # source://good_job//lib/good_job/multi_scheduler.rb#36
  def restart(timeout: T.unsafe(nil)); end
  ...
  # @return [Boolean, nil]
  #
  # source://good_job//lib/good_job/multi_scheduler.rb#16
  def running?; end

  # @return [Array<Scheduler>] List of the scheduler delegates
  #
  # source://good_job//lib/good_job/multi_scheduler.rb#7
  def schedulers; end
  ...
  # @return [void]
  #
  # source://good_job//lib/good_job/multi_scheduler.rb#29
  def shutdown(timeout: T.unsafe(nil)); end
  ...
  # @return [Boolean, nil]
  #
  # source://good_job//lib/good_job/multi_scheduler.rb#22
  def shutdown?; end
end
...
class GoodJob::Notifier
  ...
  #
  # source://good_job//lib/good_job/notifier.rb#73
  ...
  #
  # source://good_job//lib/good_job/notifier.rb#69
  def recipients; end
  ...
  # source://good_job//lib/good_job/notifier.rb#262
  def reset_connection_errors; end

  # source://good_job//lib/good_job/notifier.rb#242
  def wait_for_notify; end

  # source://good_job//lib/good_job/notifier.rb#226
  ...
  class << self
    ...
    #
    # source://good_job//lib/good_job/notifier.rb#60
...
#
# source://good_job//lib/good_job/notifier.rb#22
...
module GoodJob::Notifier::ProcessHeartbeat
  ...
  #
  # source://good_job//lib/good_job/notifier/process_heartbeat.rb#34
  def deregister_process; end

  # source://good_job//lib/good_job/notifier/process_heartbeat.rb#23
...
#
# source://good_job//lib/good_job/notifier.rb#36
...
#
# source://good_job//lib/good_job/scheduler.rb#20
class GoodJob::Scheduler
  ...
  #
  # source://good_job//lib/good_job/scheduler.rb#159
  def create_thread(state = T.unsafe(nil)); end
  ...
  # @return [String]
  #
  # source://good_job//lib/good_job/scheduler.rb#68
  def name; end
  ...
  # @return [void]
  #
  # source://good_job//lib/good_job/scheduler.rb#141
  def restart(timeout: T.unsafe(nil)); end
  ...
  # @return [void]
  #
  # source://good_job//lib/good_job/scheduler.rb#116
  def shutdown(timeout: T.unsafe(nil)); end
  ...
  # @return [Boolean, nil]
  #
  # source://good_job//lib/good_job/scheduler.rb#105
  def shutdown?(*_arg0, **_arg1, &_arg2); end
  ...
  # @return [Hash]
  #
  # source://good_job//lib/good_job/scheduler.rb#233
  def stats; end
  ...
  # @return [void]
  #
  # source://good_job//lib/good_job/scheduler.rb#204
  def task_observer(time, output, thread_error); end
  ...
  # @return [void]
  #
  # source://good_job//lib/good_job/scheduler.rb#249
  def warm_cache; end

  private

  # source://good_job//lib/good_job/scheduler.rb#328
  def cache_count; end

  # @return [void]
  #
  # source://good_job//lib/good_job/scheduler.rb#295
  def create_executor; end

  # @param delay [Integer]
  # @return [void]
  #
  # source://good_job//lib/good_job/scheduler.rb#304
  def create_task(delay = T.unsafe(nil)); end

  # Returns the value of attribute executor.
  #
  # source://good_job//lib/good_job/scheduler.rb#292
  def executor; end
  ...
  # @return [void]
  #
  # source://good_job//lib/good_job/scheduler.rb#318
  ...
  # source://good_job//lib/good_job/scheduler.rb#332
  ...
  class << self
    ...
    #
    # source://good_job//lib/good_job/scheduler.rb#43
    ...
    #
    # source://good_job//lib/good_job/scheduler.rb#37
    def instances; end
  end
end
...
#
# source://good_job//lib/good_job/scheduler.rb#23
...
class GoodJob::Scheduler::ThreadPoolExecutor < ::Concurrent::ThreadPoolExecutor
  ...
  # @return [Integer]
  #
  # source://good_job//lib/good_job/scheduler.rb#342
...
# @private
#
# source://good_job//lib/good_job/scheduler.rb#357
class GoodJob::Scheduler::TimerSet < ::Concurrent::TimerSet
  # Number of scheduled jobs in the queue
  #
  # @return [Integer]
  #
  # source://good_job//lib/good_job/scheduler.rb#360
  def length; end
  ...
  # @return [void]
  #
  # source://good_job//lib/good_job/scheduler.rb#366
  def reset; end
end
