...
class Dry::Struct::Constructor < ::Dry::Types::Constructor
  # source://dry-types/1.7.1/lib/dry/types/constructor.rb#16
  def primitive; end
end
...
class Dry::Types::Printer
  # source://dry-types/1.7.1/lib/dry/types/printer.rb#38
  def initialize; end

  # source://dry-types/1.7.1/lib/dry/types/printer.rb#43
  def call(type); end

  # source://dry-types/1.7.1/lib/dry/types/printer.rb#49
  def visit(type, &block); end

  # source://dry-types/1.7.1/lib/dry/types/printer.rb#62
  def visit_any(_); end

  # source://dry-types/1.7.1/lib/dry/types/printer.rb#66
  def visit_array(type); end

  # source://dry-types/1.7.1/lib/dry/types/printer.rb#72
  def visit_array_member(array); end

  # source://dry-types/1.7.1/lib/dry/types/printer.rb#155
  def visit_callable(callable); end

  # source://dry-types/1.7.1/lib/dry/types/printer.rb#104
  def visit_composition(composition, &block); end

  # source://dry-types/1.7.1/lib/dry/types/printer.rb#93
  def visit_constrained(constrained); end

  # source://dry-types/1.7.1/lib/dry/types/printer.rb#80
  def visit_constructor(constructor); end

  # source://dry-types/1.7.1/lib/dry/types/printer.rb#129
  def visit_default(default); end

  # source://dry-types/1.7.1/lib/dry/types/printer.rb#110
  def visit_enum(enum); end

  # source://dry-types/1.7.1/lib/dry/types/printer.rb#253
  def visit_hash(hash); end

  # source://dry-types/1.7.1/lib/dry/types/printer.rb#243
  def visit_key(key); end

  # source://dry-types/1.7.1/lib/dry/types/printer.rb#149
  def visit_lax(lax); end

  # source://dry-types/1.7.1/lib/dry/types/printer.rb#229
  def visit_map(map); end

  # source://dry-types/1.7.1/lib/dry/types/printer.rb#143
  def visit_nominal(type); end

  # source://dry-types/1.7.1/lib/dry/types/printer.rb#272
  def visit_options(options, meta = T.unsafe(nil)); end

  # source://dry-types/1.7.1/lib/dry/types/printer.rb#190
