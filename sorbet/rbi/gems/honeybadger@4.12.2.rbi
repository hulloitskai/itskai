...
module Honeybadger
  ...
  # @api private
  #
  # source://honeybadger//lib/honeybadger/singleton.rb#69
  def install_at_exit_callback; end

  # @api private
  #
  # source://honeybadger//lib/honeybadger/singleton.rb#61
  ...
  # @see Agent#notify
  #
  # source://honeybadger//lib/honeybadger/singleton.rb#54
  def notify(exception_or_opts, opts = T.unsafe(nil)); end

  # @deprecated
  # @raise [NoMethodError]
  #
  # source://honeybadger//lib/honeybadger/singleton.rb#80
  ...
  # @return [Boolean]
  #
  # source://honeybadger//lib/honeybadger/singleton.rb#95
...
#   end
#
# source://honeybadger//lib/honeybadger/agent.rb#44
class Honeybadger::Agent
  ...
  #
  # source://honeybadger//lib/honeybadger/agent.rb#59
  ...
  # @return self
  #
  # source://honeybadger//lib/honeybadger/agent.rb#303
  ...
  # @api private
  #
  # source://honeybadger//lib/honeybadger/agent.rb#277
  def breadcrumbs; end
  ...
  #   otherwise.
  #
  # source://honeybadger//lib/honeybadger/agent.rb#186
  def check_in(id); end

  # Clear all transaction scoped data.
  #
  # source://honeybadger//lib/honeybadger/agent.rb#259
  def clear!; end

  # @api private
  #
  # source://honeybadger//lib/honeybadger/agent.rb#361
  def config; end
  ...
  #
  # source://honeybadger//lib/honeybadger/agent.rb#253
  ...
  #   data is flushed).
  #
  # source://honeybadger//lib/honeybadger/agent.rb#344
  def flush; end
  ...
  # @return [Hash, nil]
  #
  # source://honeybadger//lib/honeybadger/agent.rb#271
  def get_context; end
  ...
  #
  # source://honeybadger//lib/honeybadger/agent.rb#121
  def notify(exception_or_opts, opts = T.unsafe(nil)); end
  ...
  #
  # source://honeybadger//lib/honeybadger/agent.rb#355
  ...
  # @api private
  #
  # source://honeybadger//lib/honeybadger/agent.rb#424
  def with_rack_env(rack_env, &block); end

  # @api private
  #
  # source://honeybadger//lib/honeybadger/agent.rb#432
  def worker; end

  private

  # source://honeybadger//lib/honeybadger/agent.rb#454
  def context_manager; end

  # source://honeybadger//lib/honeybadger/agent.rb#469
  def init_worker; end

  # source://honeybadger//lib/honeybadger/agent.rb#459
  def push(object); end

  # source://honeybadger//lib/honeybadger/agent.rb#464
  def send_now(object); end

  # @raise [ArgumentError]
  #
  # source://honeybadger//lib/honeybadger/agent.rb#446
  def validate_notify_opts!(opts); end

  # source://honeybadger//lib/honeybadger/agent.rb#473
  def with_error_handling; end

  class << self
    # @api private
    #
    # source://honeybadger//lib/honeybadger/agent.rb#50
    def instance; end
...
# source://honeybadger//lib/honeybadger/backend/base.rb#70
class Honeybadger::Backend::Base
  ...
  #
  # source://honeybadger//lib/honeybadger/backend/base.rb#75
  ...
  #
  # source://honeybadger//lib/honeybadger/backend/base.rb#98
  def check_in(id); end
  ...
  # @raise NotImplementedError
  #
  # source://honeybadger//lib/honeybadger/backend/base.rb#89
  ...
  #
  # source://honeybadger//lib/honeybadger/backend/base.rb#107
  ...
  #
  # source://honeybadger//lib/honeybadger/backend/base.rb#113
  def config; end
end
...
class Honeybadger::Backend::Response
  ...
  #
  # source://honeybadger//lib/honeybadger/backend/base.rb#35
  def initialize(*args); end
  ...
  # source://honeybadger//lib/honeybadger/backend/base.rb#50
  ...
  # @return [Boolean]
  #
  # source://honeybadger//lib/honeybadger/backend/base.rb#46
  def success?; end

  private

  # source://honeybadger//lib/honeybadger/backend/base.rb#61
...
class Honeybadger::Backend::Server < ::Honeybadger::Backend::Base
  ...
  #
  # source://honeybadger//lib/honeybadger/backend/server.rb#22
  def initialize(config); end
  ...
  # @return [Response]
  #
  # source://honeybadger//lib/honeybadger/backend/server.rb#45
  def check_in(id); end
  ...
  # @return [Response]
  #
  # source://honeybadger//lib/honeybadger/backend/server.rb#33
  def notify(feature, payload); end

  private

  # source://honeybadger//lib/honeybadger/backend/server.rb#53
...
# source://honeybadger//lib/honeybadger/backend/server.rb#20
Honeybadger::Backend::Server::HTTP_ERRORS = T.let(T.unsafe(nil), Array)

# source://honeybadger//lib/honeybadger/backend/test.rb#11
class Honeybadger::Backend::Test < ::Honeybadger::Backend::Null
  # source://honeybadger//lib/honeybadger/backend/test.rb#40
  def check_in(id); end

  # source://honeybadger//lib/honeybadger/backend/test.rb#31
  def check_ins; end

  # source://honeybadger//lib/honeybadger/backend/test.rb#27
  def notifications; end

  # source://honeybadger//lib/honeybadger/backend/test.rb#35
  def notify(feature, payload); end
  ...
  class << self
    ...
    #
    # source://honeybadger//lib/honeybadger/backend/test.rb#23
    def check_ins; end
...
# @api private
#
# source://honeybadger//lib/honeybadger/breadcrumbs/logging.rb#37
module Honeybadger::Breadcrumbs::LogSubscriberInjector
  # source://honeybadger//lib/honeybadger/breadcrumbs/logging.rb#39
...
module Honeybadger::Breadcrumbs::LogWrapper
  ...
  # @return [Boolean]
  #
  # source://honeybadger//lib/honeybadger/breadcrumbs/logging.rb#22
...
class Honeybadger::Config
  ...
  # @api private
  #
  # source://honeybadger//lib/honeybadger/config.rb#113
  def [](key); end

  # @api private
  #
  # source://honeybadger//lib/honeybadger/config.rb#125
  def []=(key, value); end

  # @api private
  #
  # source://honeybadger//lib/honeybadger/config.rb#150
  def backend; end

  # @api private
  #
  # source://honeybadger//lib/honeybadger/config.rb#155
  ...
  # @api private
  #
  # source://honeybadger//lib/honeybadger/config.rb#191
  ...
  # @api private
  #
  # source://honeybadger//lib/honeybadger/config.rb#205
  def connection_port; end

  # @api private
  #
  # source://honeybadger//lib/honeybadger/config.rb#215
  def connection_protocol; end

  # @api private
  # @return [Boolean]
  #
  # source://honeybadger//lib/honeybadger/config.rb#174
  def debug?; end

  # @api private
  #
  # source://honeybadger//lib/honeybadger/config.rb#267
  def detected_framework; end

  # @api private
  # @return [Boolean]
  #
  # source://honeybadger//lib/honeybadger/config.rb#160
  def dev?; end
  ...
  # @api private
  #
  # source://honeybadger//lib/honeybadger/config.rb#104
  def exception_fingerprint(&block); end

  # @api private
  #
  # source://honeybadger//lib/honeybadger/config.rb#231
  ...
  # @api private
  #
  # source://honeybadger//lib/honeybadger/config.rb#281
  ...
  # @api private
  #
  # source://honeybadger//lib/honeybadger/config.rb#183
  ...
  # @return [Boolean]
  #
  # source://honeybadger//lib/honeybadger/config.rb#251
  def load_plugin?(name); end

  # @api private
  #
  # source://honeybadger//lib/honeybadger/config.rb#201
  ...
  # @api private
  #
  # source://honeybadger//lib/honeybadger/config.rb#240
  def log_level(key = T.unsafe(nil)); end

  # @api private
  #
  # source://honeybadger//lib/honeybadger/config.rb#145
  def logger; end
  ...
  # @api private
  #
  # source://honeybadger//lib/honeybadger/config.rb#131
  ...
  # @api private
  #
  # source://honeybadger//lib/honeybadger/config.rb#346
  def build_file_logger(path); end

  # @api private
  #
  # source://honeybadger//lib/honeybadger/config.rb#357
  def build_logger; end

  # @api private
  #
  # source://honeybadger//lib/honeybadger/config.rb#337
  def build_stdout_logger; end

  # @api private
  #
  # source://honeybadger//lib/honeybadger/config.rb#304
  def config_path; end

  # @api private
  #
  # source://honeybadger//lib/honeybadger/config.rb#308
  def config_paths; end

  # @api private
  #
  # source://honeybadger//lib/honeybadger/config.rb#314
  def default_backend; end

  # @api private
  #
  # source://honeybadger//lib/honeybadger/config.rb#293
  ...
  # @return [Boolean]
  #
  # source://honeybadger//lib/honeybadger/config.rb#378
  ...
  # @api private
  #
  # source://honeybadger//lib/honeybadger/config.rb#392
  def load_config_from_disk; end

  # @api private
  #
  # source://honeybadger//lib/honeybadger/config.rb#383
  def locate_absolute_path(path, root); end

  # @api private
  #
  # source://honeybadger//lib/honeybadger/config.rb#298
  def log_path; end

  # @api private
  # @return [Boolean]
  #
  # source://honeybadger//lib/honeybadger/config.rb#353
  def log_stdout?; end

  # @api private
  #
  # source://honeybadger//lib/honeybadger/config.rb#400
...
# source://honeybadger//lib/honeybadger/config/defaults.rb#325
Honeybadger::Config::DEFAULTS = T.let(T.unsafe(nil), Hash)

# source://honeybadger//lib/honeybadger/config/defaults.rb#35
Honeybadger::Config::DEFAULT_PATHS = T.let(T.unsafe(nil), Array)

# source://honeybadger//lib/honeybadger/config/defaults.rb#33
...
class Honeybadger::Config::Mash
  ...
  # source://honeybadger//lib/honeybadger/config/ruby.rb#60
  def get(key); end

  # @return [Boolean]
  #
  # source://honeybadger//lib/honeybadger/config/ruby.rb#49
  ...
  # @return [Boolean]
  #
  # source://honeybadger//lib/honeybadger/config/ruby.rb#38
  def mash?(method); end
...
# source://honeybadger//lib/honeybadger/config/defaults.rb#37
Honeybadger::Config::OPTIONS = T.let(T.unsafe(nil), Hash)

# source://honeybadger//lib/honeybadger/config/ruby.rb#67
class Honeybadger::Config::Ruby < ::Honeybadger::Config::Mash
  # source://honeybadger//lib/honeybadger/config/ruby.rb#80
  def backend; end

  # source://honeybadger//lib/honeybadger/config/ruby.rb#76
  def backend=(backend); end

  # source://honeybadger//lib/honeybadger/config/ruby.rb#96
  def backtrace_filter(&block); end

  # source://honeybadger//lib/honeybadger/config/ruby.rb#84
  def before_notify(action = T.unsafe(nil), &block); end

  # source://honeybadger//lib/honeybadger/config/ruby.rb#105
  def exception_filter(&block); end

  # source://honeybadger//lib/honeybadger/config/ruby.rb#114
  def exception_fingerprint(&block); end

  # source://honeybadger//lib/honeybadger/config/ruby.rb#72
  def logger; end

  # source://honeybadger//lib/honeybadger/config/ruby.rb#68
  def logger=(logger); end

  private

  # source://honeybadger//lib/honeybadger/config/ruby.rb#125
...
class Honeybadger::ContextManager
  ...
  # @api private
  #
  # source://honeybadger//lib/honeybadger/context_manager.rb#31
  def get_context; end

  # @api private
  #
  # source://honeybadger//lib/honeybadger/context_manager.rb#39
  ...
  # @api private
  #
  # source://honeybadger//lib/honeybadger/context_manager.rb#35
  ...
  # @api private
  #
  # source://honeybadger//lib/honeybadger/context_manager.rb#47
  def _initialize; end

  # @api private
  #
  # source://honeybadger//lib/honeybadger/context_manager.rb#45
  def custom; end
...
module Honeybadger::Conversions
  ...
  #
  # source://honeybadger//lib/honeybadger/conversions.rb#11
...
class Honeybadger::Notice
  ...
  #
  # source://honeybadger//lib/honeybadger/notice.rb#179
  ...
  #
  # source://honeybadger//lib/honeybadger/notice.rb#225
  ...
  # Returns nothing.
  #
  # source://honeybadger//lib/honeybadger/notice.rb#273
  def halt!; end
  ...
  # @return [Boolean]
  #
  # source://honeybadger//lib/honeybadger/notice.rb#279
  def halted?; end
  ...
  # @return [Boolean]
  #
  # source://honeybadger//lib/honeybadger/notice.rb#266
  def ignore?; end
  ...
  #
  # source://honeybadger//lib/honeybadger/notice.rb#260
  def to_json(*a); end
  ...
  # Returns the value of attribute config.
  #
  # source://honeybadger//lib/honeybadger/notice.rb#285
  def config; end

  # source://honeybadger//lib/honeybadger/notice.rb#350
  def construct_backtrace_filters(opts); end

  # source://honeybadger//lib/honeybadger/notice.rb#400
  ...
  #
  # source://honeybadger//lib/honeybadger/notice.rb#363
  def construct_request_hash; end

  # source://honeybadger//lib/honeybadger/notice.rb#424
  ...
  #
  # source://honeybadger//lib/honeybadger/notice.rb#309
  ...
  #
  # source://honeybadger//lib/honeybadger/notice.rb#517
  ...
  #
  # source://honeybadger//lib/honeybadger/notice.rb#380
  def exception_context(exception); end

  # source://honeybadger//lib/honeybadger/notice.rb#408
  ...
  #
  # source://honeybadger//lib/honeybadger/notice.rb#321
  def from_exception(attribute); end

  # @return [Boolean]
  #
  # source://honeybadger//lib/honeybadger/notice.rb#294
  ...
  # @return [Boolean]
  #
  # source://honeybadger//lib/honeybadger/notice.rb#337
  def ignore_by_class?(ignored_class = T.unsafe(nil)); end

  # @return [Boolean]
  #
  # source://honeybadger//lib/honeybadger/notice.rb#288
  ...
  #
  # source://honeybadger//lib/honeybadger/notice.rb#445
  ...
  # source://honeybadger//lib/honeybadger/notice.rb#560
  def params_filters; end
  ...
  #
  # source://honeybadger//lib/honeybadger/notice.rb#492
  ...
  #
  # source://honeybadger//lib/honeybadger/notice.rb#550
  ...
  # source://honeybadger//lib/honeybadger/notice.rb#564
  def rails_params_filters; end

  # source://honeybadger//lib/honeybadger/notice.rb#356
  ...
  # source://honeybadger//lib/honeybadger/notice.rb#436
  def s(data); end
  ...
  # @return [Boolean]
  #
  # source://honeybadger//lib/honeybadger/notice.rb#483
  ...
  #
  # source://honeybadger//lib/honeybadger/notice.rb#533
  ...
  #
  # source://honeybadger//lib/honeybadger/notice.rb#507
...
# @api private
#
# source://honeybadger//lib/honeybadger/notice.rb#153
...
# @api private
#
# source://honeybadger//lib/honeybadger/notice.rb#149
...
#   end
#
# source://honeybadger//lib/honeybadger/plugin.rb#43
class Honeybadger::Plugin
  ...
  # @return nil
  #
  # source://honeybadger//lib/honeybadger/plugin.rb#164
  def execution(&block); end

  # @api private
  #
  # source://honeybadger//lib/honeybadger/plugin.rb#208
  def executions; end

  # @api private
  #
  # source://honeybadger//lib/honeybadger/plugin.rb#177
  def load!(config); end

  # @api private
  # @return [Boolean]
  #
  # source://honeybadger//lib/honeybadger/plugin.rb#197
  def loaded?; end
  ...
  # @return [Boolean]
  #
  # source://honeybadger//lib/honeybadger/plugin.rb#169
  def ok?(config); end
  ...
  # @return nil
  #
  # source://honeybadger//lib/honeybadger/plugin.rb#139
  ...
  # @private
  #
  # source://honeybadger//lib/honeybadger/plugin.rb#203
  def reset!; end

  class << self
    # @api private
    #
    # source://honeybadger//lib/honeybadger/plugin.rb#52
    def instances; end

    # @api private
    #
    # source://honeybadger//lib/honeybadger/plugin.rb#77
    def load!(config); end

    # @api private
    #
    # source://honeybadger//lib/honeybadger/plugin.rb#88
    ...
    # @return nil
    #
    # source://honeybadger//lib/honeybadger/plugin.rb#69
...
# @api private
#
# source://honeybadger//lib/honeybadger/plugin.rb#45
Honeybadger::Plugin::CALLER_FILE = T.let(T.unsafe(nil), Regexp)

# @api private
#
# source://honeybadger//lib/honeybadger/plugin.rb#96
class Honeybadger::Plugin::Execution
  ...
  #
  # source://honeybadger//lib/honeybadger/plugin.rb#99
  ...
  # @api private
  #
  # source://honeybadger//lib/honeybadger/plugin.rb#110
  def block; end
...
# @api private
#
# source://honeybadger//lib/honeybadger/plugins/rails.rb#5
...
module Honeybadger::Plugins::Rails::ExceptionsCatcher
  ...
  #   method.
  #
  # source://honeybadger//lib/honeybadger/plugins/rails.rb#16
...
# @api private
#
# source://honeybadger//lib/honeybadger/plugins/sidekiq.rb#6
...
class Honeybadger::Rack::UserFeedback
  ...
  #
  # source://honeybadger//lib/honeybadger/rack/user_feedback.rb#46
  def action; end
  ...
  # @private
  #
  # source://honeybadger//lib/honeybadger/rack/user_feedback.rb#59
  def custom_template_file; end

  # @private
  # @return [Boolean]
  #
  # source://honeybadger//lib/honeybadger/rack/user_feedback.rb#64
  def custom_template_file?; end
  ...
  # @private
  #
  # source://honeybadger//lib/honeybadger/rack/user_feedback.rb#53
  def render_form(error_id, action = T.unsafe(nil)); end

  # @private
  #
  # source://honeybadger//lib/honeybadger/rack/user_feedback.rb#69
  def template_file; end

  private

  # source://honeybadger//lib/honeybadger/rack/user_feedback.rb#82
  def agent; end
end
...
class Honeybadger::Rack::UserInformer
  ...
  # source://honeybadger//lib/honeybadger/rack/user_informer.rb#40
  def agent; end
end
...
class Honeybadger::Util::HTTP
  ...
  # @api private
  #
  # source://honeybadger//lib/honeybadger/util/http.rb#87
  def compress(string, level = T.unsafe(nil)); end

  # @api private
  #
  # source://honeybadger//lib/honeybadger/util/http.rb#54
  def config; end

  # @api private
  #
  # source://honeybadger//lib/honeybadger/util/http.rb#56
  ...
  # @api private
  #
  # source://honeybadger//lib/honeybadger/util/http.rb#68
...
class Honeybadger::Util::SQL
  class << self
    # @api private
    #
    # source://honeybadger//lib/honeybadger/util/sql.rb#24
    def force_utf_8(string); end

    # @api private
    #
    # source://honeybadger//lib/honeybadger/util/sql.rb#13
...
# @api private
#
# source://honeybadger//lib/honeybadger/util/sql.rb#11
...
# @api private
#
# source://honeybadger//lib/honeybadger/util/sql.rb#9
...
class Honeybadger::Util::Sanitizer
  ...
  #
  # source://honeybadger//lib/honeybadger/util/sanitizer.rb#35
  def initialize(max_depth: T.unsafe(nil), filters: T.unsafe(nil)); end

  # @api private
  #
  # source://honeybadger//lib/honeybadger/util/sanitizer.rb#133
  def filter_cookies(raw_cookies); end

  # @api private
  #
  # source://honeybadger//lib/honeybadger/util/sanitizer.rb#147
  def filter_url(url); end

  # @api private
  #
  # source://honeybadger//lib/honeybadger/util/sanitizer.rb#59
  ...
  # @return [Boolean]
  #
  # source://honeybadger//lib/honeybadger/util/sanitizer.rb#197
  def basic_object?(object); end

  # @api private
  #
  # source://honeybadger//lib/honeybadger/util/sanitizer.rb#162
  def blocks; end

  # @api private
  # @return [Boolean]
  #
  # source://honeybadger//lib/honeybadger/util/sanitizer.rb#205
  def can_dup?(obj); end
  ...
  # @return [Boolean]
  #
  # source://honeybadger//lib/honeybadger/util/sanitizer.rb#168
  def filter_key?(key, parents = T.unsafe(nil)); end

  # @api private
  # @return [Boolean]
  #
  # source://honeybadger//lib/honeybadger/util/sanitizer.rb#164
  def filters?; end

  # @api private
  # @return [Boolean]
  #
  # source://honeybadger//lib/honeybadger/util/sanitizer.rb#209
  ...
  # @return [Boolean]
  #
  # source://honeybadger//lib/honeybadger/util/sanitizer.rb#193
  ...
  # @api private
  #
  # source://honeybadger//lib/honeybadger/util/sanitizer.rb#175
  def sanitize_string(string); end

  # @api private
  #
  # source://honeybadger//lib/honeybadger/util/sanitizer.rb#188
  def valid_encoding(string); end

  # @api private
  # @return [Boolean]
  #
  # source://honeybadger//lib/honeybadger/util/sanitizer.rb#181
  def valid_encoding?(string); end

  class << self
    # @api private
    #
    # source://honeybadger//lib/honeybadger/util/sanitizer.rb#30
...
# @api private
#
# source://honeybadger//lib/honeybadger/util/sanitizer.rb#13
...
# @api private
#
# source://honeybadger//lib/honeybadger/util/sanitizer.rb#15
...
# @api private
#
# source://honeybadger//lib/honeybadger/util/sanitizer.rb#24
Honeybadger::Util::Sanitizer::IMMUTABLE = T.let(T.unsafe(nil), Array)

# @api private
#
# source://honeybadger//lib/honeybadger/util/sanitizer.rb#26
...
# @api private
#
# source://honeybadger//lib/honeybadger/util/sanitizer.rb#22
Honeybadger::Util::Sanitizer::TRUNCATED = T.let(T.unsafe(nil), String)

# @api private
#
# source://honeybadger//lib/honeybadger/util/sanitizer.rb#28
...
class Honeybadger::Worker
  ...
  # @api private
  #
  # source://honeybadger//lib/honeybadger/worker.rb#243
  ...
  # @api private
  #
  # source://honeybadger//lib/honeybadger/worker.rb#247
