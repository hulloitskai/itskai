...
class Premailer
  # source://premailer/1.16.0/lib/premailer/premailer.rb#182
  def initialize(html, options = T.unsafe(nil)); end

  # source://premailer/1.16.0/lib/premailer/premailer.rb#355
  def append_query_string(doc, qs); end

  # source://premailer/1.16.0/lib/premailer/premailer.rb#119
  def base_dir; end

  # source://premailer/1.16.0/lib/premailer/premailer.rb#115
  def base_url; end

  # source://premailer/1.16.0/lib/premailer/premailer.rb#506
  def check_client_support; end

  # source://premailer/1.16.0/lib/premailer/premailer.rb#421
  def convert_inline_links(doc, base_uri); end

  # source://premailer/1.16.0/lib/premailer/premailer.rb#128
  def doc; end

  # source://premailer/1.16.0/lib/premailer/premailer.rb#112
  def html_file; end

  # source://premailer/1.16.0/lib/premailer/premailer.rb#406
  def is_xhtml?; end

  # source://premailer/1.16.0/lib/premailer/premailer.rb#341
  def local_uri?(uri); end

  # source://premailer/1.16.0/lib/premailer/premailer.rb#349
  def media_type_ok?(media_types); end

  # source://premailer/1.16.0/lib/premailer/premailer.rb#125
  def processed_doc; end

  # source://premailer/1.16.0/lib/premailer/premailer.rb#122
  def unmergable_rules; end

  # source://premailer/1.16.0/lib/premailer/premailer.rb#256
  def warnings; end

  protected

  # source://premailer/1.16.0/lib/premailer/premailer.rb#297
  def load_css_from_html!; end

  # source://premailer/1.16.0/lib/premailer/premailer.rb#263
  def load_css_from_local_file!(path); end

  # source://premailer/1.16.0/lib/premailer/premailer.rb#284
  def load_css_from_options!; end

  # source://premailer/1.16.0/lib/premailer/premailer.rb#279
  def load_css_from_string(css_string); end

  class << self
    # source://premailer/1.16.0/lib/premailer/premailer.rb#499
    def canonicalize(uri); end

    # source://premailer/1.16.0/lib/premailer/premailer.rb#467
    def is_media_query?(media_types); end

    # source://premailer/1.16.0/lib/premailer/premailer.rb#493
    def local_data?(data); end

    # source://premailer/1.16.0/lib/premailer/premailer.rb#472
    def resolve_link(path, base_path); end
  end
end

# source://premailer/1.16.0/lib/premailer/premailer.rb#38
Premailer::CLIENT_SUPPORT_FILE = T.let(T.unsafe(nil), String)

# source://premailer/1.16.0/lib/premailer/premailer.rb#47
Premailer::HTML_ENTITIES = T.let(T.unsafe(nil), Hash)

# source://premailer/1.16.0/lib/premailer/premailer.rb#65
Premailer::RELATED_ATTRIBUTES = T.let(T.unsafe(nil), Hash)

# source://premailer/1.16.0/lib/premailer/premailer.rb#43
Premailer::RE_RESET_SELECTORS = T.let(T.unsafe(nil), Regexp)

# source://premailer/1.16.0/lib/premailer/premailer.rb#41
...
# source://premailer/1.16.0/lib/premailer/version.rb#3
Premailer::VERSION = T.let(T.unsafe(nil), String)

# source://premailer/1.16.0/lib/premailer/premailer.rb#144
