...
module Sentry
  class << self
    ...
    # source://sentry-ruby//lib/sentry-ruby.rb#503
    def logger; end
    ...
    # source://sentry-ruby//lib/sentry-ruby.rb#495
    ...
    # source://sentry-ruby//lib/sentry-ruby.rb#513
    def utc_now; end
...
class Sentry::BackgroundWorker
  ...
  # source://sentry-rails/5.10.0/lib/sentry/rails/background_worker.rb#3
...
class Sentry::Client
  ...
  # @return [String, nil]
  #
  # source://sentry-ruby//lib/sentry/client.rb#167
  ...
  # @return [String, nil]
  #
  # source://sentry-ruby//lib/sentry/client.rb#155
  ...
  # source://sentry-ruby//lib/sentry/client.rb#187
  def dispatch_async_event(async_block, event, hint); end

  # source://sentry-ruby//lib/sentry/client.rb#181
...
class Sentry::Configuration
  ...
  # @return [String, nil]
  #
  # source://sentry-ruby//lib/sentry/configuration.rb#482
  def csp_report_uri; end
  ...
  # source://sentry-ruby//lib/sentry/configuration.rb#407
  def environment=(environment); end

  # @api private
  #
  # source://sentry-ruby//lib/sentry/configuration.rb#516
  def error_messages; end

  # these are not config options
  #
  # source://sentry-ruby//lib/sentry/configuration.rb#258
  def errors; end
  ...
  # @raise [ArgumentError]
  #
  # source://sentry-ruby//lib/sentry/configuration.rb#429
  def profiles_sample_rate=(profiles_sample_rate); end

  # @return [Boolean]
  #
  # source://sentry-ruby//lib/sentry/configuration.rb#475
  ...
  # source://sentry-rails/5.10.0/lib/sentry/rails/configuration.rb#8
  def rails; end
  ...
  # @return [Boolean]
  #
  # source://sentry-ruby//lib/sentry/configuration.rb#435
  ...
  # @return [Boolean]
  #
  # source://sentry-ruby//lib/sentry/configuration.rb#469
  ...
  # @return [Boolean]
  #
  # source://sentry-ruby//lib/sentry/configuration.rb#464
  ...
  # @return [Boolean]
  #
  # source://sentry-ruby//lib/sentry/configuration.rb#564
  ...
  # source://sentry-ruby//lib/sentry/configuration.rb#598
  def run_post_initialization_callbacks; end

  # @return [Boolean]
  #
  # source://sentry-ruby//lib/sentry/configuration.rb#594
  ...
  # @return [Boolean]
  #
  # source://sentry-ruby//lib/sentry/configuration.rb#571
  def valid?; end
...
class Sentry::Hub
  ...
  # source://sentry-ruby//lib/sentry/hub.rb#234
...
class Sentry::Hub::Layer
  ...
  #
  # source://sentry-ruby//lib/sentry/hub.rb#242
  def initialize(client, scope); end
  ...
  #
  # source://sentry-ruby//lib/sentry/hub.rb#240
  def scope; end
end
...
module Sentry::Net::HTTP
  ...
  # @api private
  #
  # source://sentry-ruby//lib/sentry/net/http.rb#86
  ...
  # @api private
  #
  # source://sentry-ruby//lib/sentry/net/http.rb#64
  def record_sentry_breadcrumb(req, res); end

  # @api private
  #
  # source://sentry-ruby//lib/sentry/net/http.rb#52
...
class Sentry::Redis
  ...
  # @api private
  #
  # source://sentry-ruby//lib/sentry/redis.rb#30
  def commands; end

  # @api private
  #
  # source://sentry-ruby//lib/sentry/redis.rb#49
  ...
  # @api private
  #
  # source://sentry-ruby//lib/sentry/redis.rb#32
...
# @api private
#
# source://sentry-ruby//lib/sentry/redis.rb#81
module Sentry::Redis::GlobalRedisInstrumentation
  # @api private
  #
  # source://sentry-ruby//lib/sentry/redis.rb#82
  def call(command, redis_config); end

  # @api private
  #
  # source://sentry-ruby//lib/sentry/redis.rb#88
...
class Sentry::Scope
  ...
  # @return [void]
  #
  # source://sentry-ruby//lib/sentry/scope.rb#75
  ...
  # @return [Hash]
  #
  # source://sentry-ruby//lib/sentry/scope.rb#172
  ...
  # @return [Hash]
  #
  # source://sentry-ruby//lib/sentry/scope.rb#143
  ...
  # @return [Hash]
  #
  # source://sentry-ruby//lib/sentry/scope.rb#186
  ...
  # source://sentry-ruby//lib/sentry/scope.rb#157
  ...
  # @return [void]
  #
  # source://sentry-ruby//lib/sentry/scope.rb#104
  ...
  # source://sentry-ruby//lib/sentry/scope.rb#282
  ...
  class << self
    ...
    # @return [void]
    #
    # source://sentry-ruby//lib/sentry/scope.rb#338
    def add_global_event_processor(&block); end
    ...
    # @return [Array<Proc>]
    #
    # source://sentry-ruby//lib/sentry/scope.rb#328
...
class Sentry::SingleExceptionInterface < ::Sentry::Interface
  ...
  class << self
    ...
    #
    # source://sentry-ruby//lib/sentry/interfaces/single_exception.rb#40
...
class Sentry::Span
  ...
  # source://sentry-ruby//lib/sentry/span.rb#178
  def deep_dup; end
  ...
  # @param value [Object]
  #
  # source://sentry-ruby//lib/sentry/span.rb#225
  ...
  #
  # source://sentry-ruby//lib/sentry/span.rb#190
  ...
  #
  # source://sentry-ruby//lib/sentry/span.rb#209
  ...
  #
  # source://sentry-ruby//lib/sentry/span.rb#184
  def set_op(op); end
  ...
  #
  # source://sentry-ruby//lib/sentry/span.rb#197
  ...
  #
  # source://sentry-ruby//lib/sentry/span.rb#166
  def with_child_span(**attributes, &block); end
end
...
class Sentry::Transaction < ::Sentry::Span
  ...
  #
  # source://sentry-ruby//lib/sentry/transaction.rb#66
  ...
  # @return [Baggage, nil]
  #
  # source://sentry-ruby//lib/sentry/transaction.rb#39
  def baggage; end
  ...
  # @return [Transaction]
  #
  # source://sentry-ruby//lib/sentry/transaction.rb#164
  def deep_dup; end
  ...
  #
  # source://sentry-ruby//lib/sentry/transaction.rb#52
  def logger; end
  ...
  # @return [String]
  #
  # source://sentry-ruby//lib/sentry/transaction.rb#25
  def name; end
  ...
  # @return [String]
  #
  # source://sentry-ruby//lib/sentry/transaction.rb#33
  ...
  # @return [Profiler]
  #
  # source://sentry-ruby//lib/sentry/transaction.rb#64
  def profiler; end
  ...
  # @return [void]
  #
  # source://sentry-ruby//lib/sentry/transaction.rb#189
  ...
  # @return [Symbol]
  #
  # source://sentry-ruby//lib/sentry/transaction.rb#29
  def source; end
  ...
  # @return [Hash]
  #
  # source://sentry-ruby//lib/sentry/transaction.rb#150
  def to_hash; end

  protected

  # source://sentry-ruby//lib/sentry/transaction.rb#308
  def init_span_recorder(limit = T.unsafe(nil)); end

  private

  # source://sentry-ruby//lib/sentry/transaction.rb#315
  def generate_transaction_description; end

  # source://sentry-ruby//lib/sentry/transaction.rb#322
  ...
  # @return [Boolean]
  #
  # source://sentry-ruby//lib/sentry/transaction.rb#341
  ...
  class << self
    ...
    # @return [Array, nil]
    #
    # source://sentry-ruby//lib/sentry/transaction.rb#139
...
#
# source://sentry-ruby//lib/sentry/transaction.rb#19
...
class Sentry::TransactionEvent < ::Sentry::Event
  ...
  # @return [void]
  #
  # source://sentry-ruby//lib/sentry/transaction_event.rb#45
  def start_timestamp=(time); end

  # @return [Hash]
  #
  # source://sentry-ruby//lib/sentry/transaction_event.rb#50
  def to_hash; end

  private

  # source://sentry-ruby//lib/sentry/transaction_event.rb#60
