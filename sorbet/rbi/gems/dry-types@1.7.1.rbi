...
class Dry::Types::PredicateInferrer
  ...
  # @return [Symbol]
  #
  # source://dry-types//lib/dry/types/predicate_inferrer.rb#219
  def [](type); end

  # @api private
  # @return [Compiler]
  #
  # source://dry-types//lib/dry/types/predicate_inferrer.rb#206
  def compiler; end
end
...
class Dry::Types::PredicateInferrer::Compiler
  ...
  # @api private
  #
  # source://dry-types//lib/dry/types/predicate_inferrer.rb#191
...
class Dry::Types::Printer
  ...
  # source://dry-struct/1.6.0/lib/dry/struct/printer.rb#12
