...
# source://activestorage//lib/active_storage/service/disk_service.rb#11
class ActiveStorage::Service::DiskService < ::ActiveStorage::Service
  ...
  # source://activestorage//lib/active_storage/service/disk_service.rb#103
  def compose(source_keys, destination_key, **_arg2); end

  # source://activestorage//lib/active_storage/service/disk_service.rb#51
  def delete(key); end

  # source://activestorage//lib/active_storage/service/disk_service.rb#59
  def delete_prefixed(prefix); end

  # source://activestorage//lib/active_storage/service/disk_service.rb#26
  def download(key, &block); end

  # source://activestorage//lib/active_storage/service/disk_service.rb#40
  def download_chunk(key, range); end

  # source://activestorage//lib/active_storage/service/disk_service.rb#67
  def exist?(key); end

  # source://activestorage//lib/active_storage/service/disk_service.rb#95
  def headers_for_direct_upload(key, content_type:, **_arg2); end

  # source://activestorage//lib/active_storage/service/disk_service.rb#99
  def path_for(key); end

  # source://activestorage//lib/active_storage/service/disk_service.rb#12
  def root; end

  # source://activestorage//lib/active_storage/service/disk_service.rb#12
  def root=(_arg0); end

  # source://activestorage//lib/active_storage/service/disk_service.rb#19
  def upload(key, io, checksum: T.unsafe(nil), **_arg3); end

  # source://activestorage//lib/active_storage/service/disk_service.rb#75
  def url_for_direct_upload(key, expires_in:, content_type:, content_length:, checksum:, custom_metadata: T.unsafe(nil)); end

  private

  # source://activestorage//lib/active_storage/service/disk_service.rb#161
  def ensure_integrity_of(key, checksum); end

  # source://activestorage//lib/active_storage/service/disk_service.rb#153
  def folder_for(key); end

  # source://activestorage//lib/active_storage/service/disk_service.rb#122
  def generate_url(key, expires_in:, filename:, content_type:, disposition:); end

  # source://activestorage//lib/active_storage/service/disk_service.rb#157
  ...
  # source://activestorage//lib/active_storage/service/disk_service.rb#118
  def public_url(key, filename:, content_type: T.unsafe(nil), disposition: T.unsafe(nil), **_arg4); end

  # source://activestorage//lib/active_storage/service/disk_service.rb#143
  def stream(key); end

  # source://activestorage//lib/active_storage/service/disk_service.rb#168
  def url_helpers; end

  # source://activestorage//lib/active_storage/service/disk_service.rb#172
  def url_options; end
end
