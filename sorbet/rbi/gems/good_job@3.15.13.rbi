...
module ActiveJob
  class << self
    # source://activejob/7.0.5/lib/active_job/gem_version.rb#5
    def gem_version; end

    # source://activejob/7.0.5/lib/active_job/version.rb#7
    def version; end
  end
end
...
module ActiveJob::QueueAdapters
  class << self
    # source://activejob/7.0.5/lib/active_job/queue_adapters.rb#136
    def lookup(name); end
  end
end
...
module GoodJob
  ...
  class << self
    ...
    #
    # source://good_job//lib/good_job.rb#228
    def deprecator; end
    ...
    # @return [void]
    #
    # source://good_job//lib/good_job.rb#217
...
class GoodJob::BatchRecord < ::GoodJob::BaseRecord
  ...
  # source://activemodel/7.0.5/lib/active_model/attribute_methods.rb#206
...
class GoodJob::Capsule
  ...
  #
  # source://good_job//lib/good_job/capsule.rb#69
  def running?; end
  ...
  # @return [void]
  #
  # source://good_job//lib/good_job/capsule.rb#51
  def shutdown(timeout: T.unsafe(nil)); end

  # @return [Boolean] Whether the capsule has been shutdown.
  #
  # source://good_job//lib/good_job/capsule.rb#74
  def shutdown?; end
  ...
  #
  # source://good_job//lib/good_job/capsule.rb#25
  ...
  # @return [Boolean]
  #
  # source://good_job//lib/good_job/capsule.rb#88
...
module GoodJob::CurrentThread
  ...
  class << self
    ...
    #
    # source://good_job//lib/good_job/current_thread.rb#84
    def process_id; end
    ...
    # @return [void]
    #
    # source://good_job//lib/good_job/current_thread.rb#64
    ...
    # @yield [self]
    #
    # source://good_job//lib/good_job/current_thread.rb#96
    def within; end
  end
end
...
#
# source://good_job//lib/good_job/version.rb#7
