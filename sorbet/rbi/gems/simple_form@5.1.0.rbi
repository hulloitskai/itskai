...
module SimpleForm
  ...
  # source://simple_form//lib/simple_form.rb#109
  ...
  # source://simple_form//lib/simple_form.rb#153
  def custom_inputs_namespaces; end

  # source://simple_form//lib/simple_form.rb#153
  def custom_inputs_namespaces=(val); end

  # source://simple_form//lib/simple_form.rb#119
  ...
  #
  # source://simple_form//lib/simple_form.rb#203
  def default_wrapper; end

  # source://simple_form//lib/simple_form.rb#203
  def default_wrapper=(val); end

  # source://simple_form//lib/simple_form.rb#61
  ...
  # source://simple_form//lib/simple_form.rb#184
  def field_error_proc; end

  # source://simple_form//lib/simple_form.rb#184
  def field_error_proc=(val); end

  # source://simple_form//lib/simple_form.rb#114
  def form_class; end
  ...
  # source://simple_form//lib/simple_form.rb#190
  def input_class; end

  # source://simple_form//lib/simple_form.rb#190
  def input_class=(val); end

  # source://simple_form//lib/simple_form.rb#210
  def input_field_error_class; end

  # source://simple_form//lib/simple_form.rb#210
  def input_field_error_class=(val); end

  # source://simple_form//lib/simple_form.rb#213
  def input_field_valid_class; end

  # source://simple_form//lib/simple_form.rb#213
  def input_field_valid_class=(val); end

  # source://simple_form//lib/simple_form.rb#137
  ...
  # source://simple_form//lib/simple_form.rb#91
  ...
  # source://simple_form//lib/simple_form.rb#166
  def translate_labels; end

  # source://simple_form//lib/simple_form.rb#166
  def translate_labels=(val); end

  # source://simple_form//lib/simple_form.rb#145
  ...
  class << self
    # source://simple_form//lib/simple_form.rb#260
    ...
    # @yield [builder]
    #
    # source://simple_form//lib/simple_form.rb#238
    ...
    # SETUP
    #
    # source://simple_form//lib/simple_form.rb#266
    ...
    # source://simple_form//lib/simple_form.rb#280
    def file_methods; end

    # source://simple_form//lib/simple_form.rb#275
    ...
    #    <% end %>
    #
    # source://simple_form//lib/simple_form.rb#327
    ...
    #
    # source://simple_form//lib/simple_form.rb#287
    def setup; end
    ...
    #
    # source://simple_form//lib/simple_form.rb#227
...
class SimpleForm::FormBuilder < ::ActionView::Helpers::FormBuilder
  ...
  # given SimpleForm.time_zone_priority and SimpleForm.country_priority are used respectively.
  #
  # source://enumerize/2.5.0/lib/enumerize/hooks/simple_form.rb#9
  ...
  #
  # source://enumerize/2.5.0/lib/enumerize/hooks/simple_form.rb#14
  ...
  # source://simple_form//lib/simple_form/form_builder.rb#683
  ...
  # source://simple_form//lib/simple_form/form_builder.rb#693
  def build_input_field_components(components); end

  # source://simple_form//lib/simple_form/form_builder.rb#703
...
class SimpleForm::Inputs::Base
  ...
  # source://actionview/7.0.3.1/lib/action_view/helpers/translation_helper.rb#18
...
class SimpleForm::Inputs::BooleanInput < ::SimpleForm::Inputs::Base
  ...
  # source://simple_form//lib/simple_form/inputs/boolean_input.rb#19
  def label_input(wrapper_options = T.unsafe(nil)); end

  private

  # source://simple_form//lib/simple_form/inputs/boolean_input.rb#40
  def boolean_label_class; end
  ...
  #
  # source://simple_form//lib/simple_form/inputs/boolean_input.rb#48
  def build_check_box(unchecked_value, options); end

  # Build a checkbox without generating the hidden field. See
  # #build_hidden_field_for_checkbox for more info.
  #
  # source://simple_form//lib/simple_form/inputs/boolean_input.rb#54
  ...
  #
  # source://simple_form//lib/simple_form/inputs/boolean_input.rb#62
  ...
  # @return [Boolean]
  #
  # source://simple_form//lib/simple_form/inputs/boolean_input.rb#71
  def inline_label?; end
  ...
  # @return [Boolean]
  #
  # source://simple_form//lib/simple_form/inputs/boolean_input.rb#87
  def required_by_default?; end
...
class SimpleForm::Inputs::PriorityInput < ::SimpleForm::Inputs::CollectionSelectInput
  ...
  # source://simple_form//lib/simple_form/inputs/priority_input.rb#12
  ...
  # @return [Boolean]
  #
  # source://simple_form//lib/simple_form/inputs/priority_input.rb#18
  def skip_include_blank?; end
end
...
#
# source://simple_form//lib/simple_form.rb#222
