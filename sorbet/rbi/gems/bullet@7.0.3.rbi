...
module Bullet
  ...
  class << self
    ...
    #
    # source://bullet//lib/bullet.rb#39
    def add_footer; end
    ...
    # source://bullet//lib/bullet.rb#98
    ...
    #
    # source://bullet//lib/bullet.rb#74
    def app_root; end
    ...
    # source://bullet//lib/bullet.rb#123
    def bullet_logger=(active); end

    # source://bullet//lib/bullet.rb#119
    ...
    #
    # source://bullet//lib/bullet.rb#32
    def counter_cache_enable=(_arg0); end

    # @return [Boolean]
    #
    # source://bullet//lib/bullet.rb#86
    ...
    # source://bullet//lib/bullet.rb#152
    def end_request; end

    # source://bullet//lib/bullet.rb#196
    def footer_info; end

    # source://bullet//lib/bullet.rb#182
    ...
    # @return [Boolean]
    #
    # source://bullet//lib/bullet.rb#242
    ...
    # @return [Boolean]
    #
    # source://bullet//lib/bullet.rb#78
    ...
    # source://bullet//lib/bullet.rb#188
    def perform_out_of_channel_notifications(env = T.unsafe(nil)); end

    # source://bullet//lib/bullet.rb#218
    def profile; end
    ...
    #
    # source://bullet//lib/bullet.rb#38
    def safelist; end
    ...
    # source://bullet//lib/bullet.rb#94
    ...
    # source://bullet//lib/bullet.rb#90
    ...
    # @return [Boolean]
    #
    # source://bullet//lib/bullet.rb#167
    def start?; end
    ...
    # @return [Boolean]
    #
    # source://bullet//lib/bullet.rb#82
    ...
    # source://bullet//lib/bullet.rb#259
    def build_request_uri(env); end

    # source://bullet//lib/bullet.rb#250
...
module Bullet::Dependency
  ...
  # @return [Boolean]
  #
  # source://bullet//lib/bullet/dependency.rb#57
  ...
  # source://bullet//lib/bullet/dependency.rb#40
...
class Bullet::Detector::Association < ::Bullet::Detector::Base
  class << self
    ...
    #
    # source://bullet//lib/bullet/detector/association.rb#43
    ...
    # e.g. { Post => ["Post:1", "Post:2"] }
    #
    # source://bullet//lib/bullet/detector/association.rb#34
    ...
    #
    # source://bullet//lib/bullet/detector/association.rb#62
    ...
    #
    # source://bullet//lib/bullet/detector/association.rb#76
    ...
    # e.g. { "Comment:1" => ["post"] }
    #
    # source://bullet//lib/bullet/detector/association.rb#69
    ...
    #
    # source://bullet//lib/bullet/detector/association.rb#54
...
class Bullet::Detector::NPlusOneQuery < ::Bullet::Detector::Association
  ...
  class << self
    # source://bullet//lib/bullet/detector/n_plus_one_query.rb#47
    def add_impossible_object(object); end

    # source://bullet//lib/bullet/detector/n_plus_one_query.rb#56
    ...
    # @return [Boolean]
    #
    # source://bullet//lib/bullet/detector/n_plus_one_query.rb#82
    ...
    # @return [Boolean]
    #
    # source://bullet//lib/bullet/detector/n_plus_one_query.rb#69
    ...
    # @return [Boolean]
    #
    # source://bullet//lib/bullet/detector/n_plus_one_query.rb#73
    def possible?(object); end

    private

    # source://bullet//lib/bullet/detector/n_plus_one_query.rb#97
...
class Bullet::Detector::UnusedEagerLoading < ::Bullet::Detector::Association
  ...
  class << self
    ...
    # source://bullet//lib/bullet/detector/unused_eager_loading.rb#76
    def call_associations(bullet_key, associations); end

    # source://bullet//lib/bullet/detector/unused_eager_loading.rb#67
    def create_notification(callers, klazz, associations); end

    # source://bullet//lib/bullet/detector/unused_eager_loading.rb#87
...
class Bullet::Notification::Base
  ...
  # @return [Boolean]
  #
  # source://bullet//lib/bullet/notification/base.rb#61
  def eql?(other); end

  # source://bullet//lib/bullet/notification/base.rb#65
  def hash; end

  # source://bullet//lib/bullet/notification/base.rb#57
  ...
  # source://bullet//lib/bullet/notification/base.rb#75
  def associations_str; end

  # source://bullet//lib/bullet/notification/base.rb#71
...
class Bullet::Rack
  ...
  # source://bullet//lib/bullet/rack.rb#50
  ...
  # @return [Boolean]
  #
  # source://bullet//lib/bullet/rack.rb#42
  ...
  # source://bullet//lib/bullet/rack.rb#61
  def footer_note; end

  # @return [Boolean]
  #
  # source://bullet//lib/bullet/rack.rb#81
  def html_request?(headers, response); end

  # source://bullet//lib/bullet/rack.rb#85
  def response_body(response); end

  # source://bullet//lib/bullet/rack.rb#65
  ...
  # source://bullet//lib/bullet/rack.rb#95
  def details_attributes; end

  # source://bullet//lib/bullet/rack.rb#114
...
module Bullet::StackTraceFilter
  ...
  # @return [Boolean]
  #
  # source://bullet//lib/bullet/stack_trace_filter.rb#21
  def excluded_stacktrace_path?; end

  private

  # source://bullet//lib/bullet/stack_trace_filter.rb#52
  def location_as_path(location); end

  # @return [Boolean]
  #
  # source://bullet//lib/bullet/stack_trace_filter.rb#29
