...
module IRB::Debug
  class << self
    ...
    # source://irb//lib/irb/debug.rb#68
    ...
    #
    # source://irb//lib/irb/debug.rb#85
...
class IRB::FileInputMethod < ::IRB::InputMethod
  ...
  #
  # source://irb//lib/irb/input-method.rb#126
  ...
  #
  # source://irb//lib/irb/input-method.rb#148
  def encoding; end
  ...
  # @return [Boolean]
  #
  # source://irb//lib/irb/input-method.rb#135
  def eof?; end
  ...
  #
  # source://irb//lib/irb/input-method.rb#142
  def gets; end

  # For debug message
  #
  # source://irb//lib/irb/input-method.rb#153
  def inspect; end
...
module IRB::HistorySavingAbility
  ...
  # source://irb//lib/irb/history.rb#34
  def save_history; end
...
class IRB::InputMethod
  ...
  # @return [Boolean]
  #
  # source://irb//lib/irb/input-method.rb#37
  def readable_after_eof?; end

  # @return [Boolean]
  #
  # source://irb//lib/irb/input-method.rb#41
  def support_history_saving?; end
...
class IRB::Irb
  ...
  # source://irb//lib/irb.rb#635
  def build_statement(code); end

  # source://irb//lib/irb.rb#655
  def configure_io; end

  # Returns the current context of this irb session
  #
  # source://irb//lib/irb.rb#512
  def context; end
  ...
  #
  # source://irb//lib/irb.rb#443
  def debug_break; end

  # source://irb//lib/irb.rb#453
  def debug_readline(binding); end

  # source://irb//lib/irb.rb#622
  ...
  #
  # source://irb//lib/irb.rb#962
  def inspect; end

  # source://irb//lib/irb.rb#924
  def output_value(omit = T.unsafe(nil)); end

  # source://irb//lib/irb.rb#885
  def prompt(prompt, ltype, indent, line_no); end

  # source://irb//lib/irb.rb#575
  def read_input; end

  # source://irb//lib/irb.rb#593
  def readmultiline; end

  # source://irb//lib/irb.rb#485
  ...
  # information.
  #
  # source://irb//lib/irb.rb#807
  def suspend_workspace(workspace); end

  # source://irb//lib/irb.rb#876
...
class IRB::ReadlineInputMethod # < ::IRB::StdioInputMethod
  ...
  # @return [Boolean]
  #
  # source://irb//lib/irb/input-method.rb#209
  def eof?; end
  ...
  # See IO#gets for more information.
  #
  # source://irb//lib/irb/input-method.rb#193
  def gets; end

  # For debug message
  #
  # source://irb//lib/irb/input-method.rb#214
  def inspect; end
...
class IRB::RelineInputMethod # < ::IRB::StdioInputMethod
  ...
  # @return [Boolean]
  #
  # source://irb//lib/irb/input-method.rb#390
  def eof?; end
  ...
  # See IO#gets for more information.
  #
  # source://irb//lib/irb/input-method.rb#372
  def gets; end

  # For debug message
  #
  # source://irb//lib/irb/input-method.rb#395
  def inspect; end
end
...
# source://irb//lib/irb/input-method.rb#274
...
class IRB::RubyLex
  ...
  #
  # source://irb//lib/irb/ruby-lex.rb#47
  def initialize(context); end

  # @return [Boolean]
  #
  # source://irb//lib/irb/ruby-lex.rb#183
  def assignment_expression?(code); end
  ...
  # source://irb//lib/irb/ruby-lex.rb#428
  def ltype_from_open_tokens(opens); end

  # source://irb//lib/irb/ruby-lex.rb#352
  ...
  # source://irb//lib/irb/ruby-lex.rb#70
  def set_prompt(&block); end

  # @return [Boolean]
  #
  # source://irb//lib/irb/ruby-lex.rb#201
  ...
  class << self
    ...
    # source://irb//lib/irb/ruby-lex.rb#83
    ...
    #
    # source://irb//lib/irb/ruby-lex.rb#90
...
class IRB::StdioInputMethod < ::IRB::InputMethod
  ...
  # @return [Boolean]
  #
  # source://irb//lib/irb/input-method.rb#73
  def eof?; end
  ...
  #
  # source://irb//lib/irb/input-method.rb#97
  ...
  # @return [Boolean]
  #
  # source://irb//lib/irb/input-method.rb#88
  def readable_after_eof?; end
end
...
# source://irb//lib/irb/ruby-lex.rb#500
RubyLex = IRB::RubyLex
