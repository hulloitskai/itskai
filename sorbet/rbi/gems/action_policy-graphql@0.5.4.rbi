...
module ActionPolicy
  class << self
    # source://action_policy/0.6.8/lib/action_policy.rb#35
    def cache_store; end

    # source://action_policy/0.6.8/lib/action_policy.rb#35
    def cache_store=(_arg0); end

    # source://action_policy/0.6.8/lib/action_policy.rb#37
    def enforce_predicate_rules_naming; end

    # source://action_policy/0.6.8/lib/action_policy.rb#37
    def enforce_predicate_rules_naming=(_arg0); end

    # source://action_policy/0.6.8/lib/action_policy.rb#40
...
module ActionPolicy::GraphQL::AuthorizedField
  # source://action_policy-graphql//lib/action_policy/graphql/authorized_field.rb#129
  ...
  # source://action_policy-graphql//lib/action_policy/graphql/authorized_field.rb#152
...
class ActionPolicy::GraphQL::AuthorizedField::AuthorizeExtension < ::ActionPolicy::GraphQL::AuthorizedField::Extension
  # source://action_policy-graphql//lib/action_policy/graphql/authorized_field.rb#52
  def after_resolve(value:, context:, object:, **_rest); end

  # source://action_policy-graphql//lib/action_policy/graphql/authorized_field.rb#45
  def apply; end

  class << self
    # source://action_policy-graphql//lib/action_policy/graphql/authorized_field.rb#32
    def show_authorize_mutation_deprecation; end
  end
end

# source://action_policy-graphql//lib/action_policy/graphql/authorized_field.rb#29
ActionPolicy::GraphQL::AuthorizedField::AuthorizeExtension::DEPRECATION_MESSAGE = T.let(T.unsafe(nil), String)

# source://action_policy-graphql//lib/action_policy/graphql/authorized_field.rb#98
class ActionPolicy::GraphQL::AuthorizedField::AuthorizeFieldExtension < ::ActionPolicy::GraphQL::AuthorizedField::Extension
  # source://action_policy-graphql//lib/action_policy/graphql/authorized_field.rb#99
  def apply; end

  # source://action_policy-graphql//lib/action_policy/graphql/authorized_field.rb#104
  def resolve(context:, object:, arguments:, **_rest); end

  private

  # source://action_policy-graphql//lib/action_policy/graphql/authorized_field.rb#115
...
class ActionPolicy::GraphQL::AuthorizedField::Extension < ::GraphQL::Schema::FieldExtension
  ...
  # source://action_policy-graphql//lib/action_policy/graphql/authorized_field.rb#21
  def extract_option(key, &default); end
end

# source://action_policy-graphql//lib/action_policy/graphql/authorized_field.rb#64
class ActionPolicy::GraphQL::AuthorizedField::PreauthorizeExtension < ::ActionPolicy::GraphQL::AuthorizedField::Extension
  # source://action_policy-graphql//lib/action_policy/graphql/authorized_field.rb#65
  def apply; end

  # source://action_policy-graphql//lib/action_policy/graphql/authorized_field.rb#88
  def resolve(context:, object:, arguments:, **_rest); end
end

# source://action_policy-graphql//lib/action_policy/graphql/authorized_field.rb#120
class ActionPolicy::GraphQL::AuthorizedField::ScopeExtension < ::ActionPolicy::GraphQL::AuthorizedField::Extension
  # source://action_policy-graphql//lib/action_policy/graphql/authorized_field.rb#121
  def resolve(context:, object:, arguments:, **_rest); end
end
