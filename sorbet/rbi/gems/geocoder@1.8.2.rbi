...
module Geocoder::Lookup
  ...
  #
  # source://geocoder//lib/geocoder/lookup.rb#108
  def get(name); end
  ...
  #
  # source://geocoder//lib/geocoder/lookup.rb#101
  ...
  #
  # source://geocoder//lib/geocoder/lookup.rb#134
  def classify_name(filename); end

  # Safely instantiate Lookup
  #
  # source://geocoder//lib/geocoder/lookup.rb#141
  def instantiate_lookup(name); end

  # Spawn a Lookup of the given name.
  #
  # source://geocoder//lib/geocoder/lookup.rb#120
  def spawn(name); end
end
...
# source://geocoder//lib/geocoder/sql.rb#2
module Geocoder::Sql
  extend ::Geocoder::Sql
  ...
  #
  # source://geocoder//lib/geocoder/sql.rb#97
  ...
  #
  # source://geocoder//lib/geocoder/sql.rb#34
  ...
  #
  # source://geocoder//lib/geocoder/sql.rb#68
...
#
# source://geocoder//lib/geocoder/stores/base.rb#2
module Geocoder::Store; end

# source://geocoder//lib/geocoder/stores/active_record.rb#9
module Geocoder::Store::ActiveRecord
  ...
  #
  # source://geocoder//lib/geocoder/stores/active_record.rb#315
  def fetch_address; end

  # Look up coordinates and assign to +latitude+ and +longitude+ attributes
  # (or other as specified in +geocoded_by+). Returns coordinates (array).
  #
  # source://geocoder//lib/geocoder/stores/active_record.rb#297
  ...
  #
  # source://geocoder//lib/geocoder/stores/active_record.rb#287
  ...
  class << self
    ...
    #
    # source://geocoder//lib/geocoder/stores/active_record.rb#15
...
#
# source://geocoder//lib/geocoder/stores/active_record.rb#81
module Geocoder::Store::ActiveRecord::ClassMethods
  ...
  #                        default is 0.0
  #
  # source://geocoder//lib/geocoder/stores/active_record.rb#117
  ...
  #
  # source://geocoder//lib/geocoder/stores/active_record.rb#262
  def null_value; end

  # Generate the SELECT clause.
  #
  # source://geocoder//lib/geocoder/stores/active_record.rb#207
  ...
  # @return [Boolean]
  #
  # source://geocoder//lib/geocoder/stores/active_record.rb#255
  def using_postgres?; end

  # @return [Boolean]
  #
  # source://geocoder//lib/geocoder/stores/active_record.rb#243
  def using_sqlite?; end

  # @return [Boolean]
  #
  # source://geocoder//lib/geocoder/stores/active_record.rb#247
  def using_sqlite_with_extensions?; end

  # @return [Boolean]
  #
  # source://geocoder//lib/geocoder/stores/active_record.rb#239
  def using_unextended_sqlite?; end
end

# source://geocoder//lib/geocoder/stores/base.rb#3
module Geocoder::Store::Base
  # Calculate the bearing from another point to the object.
  # See Geocoder::Calculations.distance_between for
  # ways of specifying the point.
  #
  # source://geocoder//lib/geocoder/stores/base.rb#51
  ...
  # ways of specifying the point.
  #
  # source://geocoder//lib/geocoder/stores/base.rb#39
  ...
  #
  # source://geocoder//lib/geocoder/stores/base.rb#25
  ...
  # (or other as specified in +geocoded_by+). Returns coordinates (array).
  #
  # source://geocoder//lib/geocoder/stores/base.rb#62
  def geocode; end
  ...
  # @return [Boolean]
  #
  # source://geocoder//lib/geocoder/stores/base.rb#8
  def geocoded?; end

  # Look up address and assign to +address+ attribute (or other as specified
  # in +reverse_geocoded_by+). Returns address (string).
  #
  # source://geocoder//lib/geocoder/stores/base.rb#70
  def reverse_geocode; end

  # Coordinates [lat,lon] of the object.
  #
  # source://geocoder//lib/geocoder/stores/base.rb#15
  ...
  #
  # source://geocoder//lib/geocoder/stores/base.rb#83
