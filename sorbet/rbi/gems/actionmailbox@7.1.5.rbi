...
class ActionMailbox::InboundEmail < ::ActionMailbox::Record
  ...
  class << self
    ...
    # source://activerecord/7.1.5/lib/active_record/enum.rb#242
    def statuses; end
...
module ActionMailbox::InboundEmail::GeneratedAssociationMethods
  ...
  # source://activestorage/7.1.5/lib/active_storage/attached/model.rb#101
  def raw_email; end

  # source://activestorage/7.1.5/lib/active_storage/attached/model.rb#106
...
module Rails
  class << self
    # source://railties/7.1.5/lib/rails.rb#42
    def app_class; end

    # source://railties/7.1.5/lib/rails.rb#42
    def app_class=(_arg0); end

    # source://railties/7.1.5/lib/rails.rb#43
    def application; end

    # source://railties/7.1.5/lib/rails.rb#41
    def application=(_arg0); end

    # source://railties/7.1.5/lib/rails.rb#123
    def autoloaders; end

    # source://railties/7.1.5/lib/rails.rb#54
    ...
    # source://railties/7.1.5/lib/rails.rb#50
    def configuration; end

    # source://railties/7.1.5/lib/rails/deprecator.rb#4
    def deprecator; end

    # source://railties/7.1.5/lib/rails.rb#72
    def env; end

    # source://railties/7.1.5/lib/rails.rb#79
    def env=(environment); end

    # source://railties/7.1.5/lib/rails.rb#90
    def error; end

    # source://railties/7.1.5/lib/rails/gem_version.rb#5
    def gem_version; end

    # source://railties/7.1.5/lib/rails.rb#103
    def groups(*groups); end

    # source://railties/7.1.5/lib/rails.rb#47
    ...
    # source://railties/7.1.5/lib/rails.rb#119
    def public_path; end

    # source://railties/7.1.5/lib/rails.rb#63
    def root; end

    # source://railties/7.1.5/lib/rails/version.rb#7
    def version; end
  end
end
