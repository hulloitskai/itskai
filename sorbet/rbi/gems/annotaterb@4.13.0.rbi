...
class AnnotateRb::ModelAnnotator::AnnotationDiffGenerator
  ...
  #
  # source://annotaterb//lib/annotate_rb/model_annotator/annotation_diff_generator.rb#18
  ...
  class << self
    # source://annotaterb//lib/annotate_rb/model_annotator/annotation_diff_generator.rb#11
    def call(file_content, annotation_block); end
  end
end

# source://annotaterb//lib/annotate_rb/model_annotator/annotation_diff_generator.rb#8
...
class AnnotateRb::ModelAnnotator::ColumnAnnotation::AttributesBuilder
  ...
  # @return [Boolean]
  #
  # source://annotaterb//lib/annotate_rb/model_annotator/column_annotation/attributes_builder.rb#93
  def hide_default?; end

  # source://annotaterb//lib/annotate_rb/model_annotator/column_annotation/attributes_builder.rb#84
...
class AnnotateRb::ModelAnnotator::ColumnAnnotation::ColumnWrapper
  ...
  #
  # source://annotaterb//lib/annotate_rb/model_annotator/column_annotation/column_wrapper.rb#91
  def quote(value); end
end
...
class AnnotateRb::ModelAnnotator::ColumnAnnotation::TypeBuilder
  ...
  # @return [Boolean]
  #
  # source://annotaterb//lib/annotate_rb/model_annotator/column_annotation/type_builder.rb#42
  def hide_limit?; end
end
...
class AnnotateRb::Options
  ...
  # source://annotaterb//lib/annotate_rb/options.rb#216
  def get_state(key); end

  # source://annotaterb//lib/annotate_rb/options.rb#174
  def load_defaults; end

  # source://annotaterb//lib/annotate_rb/options.rb#220
  def print; end

  # source://annotaterb//lib/annotate_rb/options.rb#207
  ...
  #
  # source://annotaterb//lib/annotate_rb/options.rb#227
...
# source://annotaterb//lib/annotate_rb/options.rb#152
AnnotateRb::Options::ALL_OPTION_KEYS = T.let(T.unsafe(nil), Array)

# source://annotaterb//lib/annotate_rb/options.rb#93
...
# source://annotaterb//lib/annotate_rb/options.rb#95
AnnotateRb::Options::FLAG_OPTION_KEYS = T.let(T.unsafe(nil), Array)

# source://annotaterb//lib/annotate_rb/options.rb#60
AnnotateRb::Options::OTHER_OPTIONS = T.let(T.unsafe(nil), Hash)

# source://annotaterb//lib/annotate_rb/options.rb#126
AnnotateRb::Options::OTHER_OPTION_KEYS = T.let(T.unsafe(nil), Array)

# source://annotaterb//lib/annotate_rb/options.rb#84
AnnotateRb::Options::PATH_OPTIONS = T.let(T.unsafe(nil), Hash)

# source://annotaterb//lib/annotate_rb/options.rb#145
...
class AnnotateRb::Parser
  ...
  # source://annotaterb//lib/annotate_rb/parser.rb#159
  def add_model_options_to_parser(option_parser); end

  # source://annotaterb//lib/annotate_rb/parser.rb#356
  def add_options_to_parser(option_parser); end

  # source://annotaterb//lib/annotate_rb/parser.rb#285
  def add_position_options_to_parser(option_parser); end

  # source://annotaterb//lib/annotate_rb/parser.rb#268
  def add_route_options_to_parser(option_parser); end

  # source://annotaterb//lib/annotate_rb/parser.rb#137
  def add_utils_to_parser(option_parser); end

  # source://annotaterb//lib/annotate_rb/parser.rb#116
  ...
  # source://annotaterb//lib/annotate_rb/parser.rb#91
  def parser; end
