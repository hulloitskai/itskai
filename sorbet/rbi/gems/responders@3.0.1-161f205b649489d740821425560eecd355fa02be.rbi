...
module ActionController
  class << self
    # source://actionpack/7.0.3.1/lib/action_controller/metal/renderers.rb#7
    def add_renderer(key, &block); end

    # source://actionpack/7.0.3.1/lib/action_controller/metal/renderers.rb#12
...
class ActionController::API < ::ActionController::Metal
  ...
  class << self
    ...
    # source://actionpack/7.0.3.1/lib/action_controller/api.rb#104
    def without_modules(*modules); end
  end
end

# source://actionpack/7.0.3.1/lib/action_controller/api.rb#112
...
class ActionController::Base < ::ActionController::Metal
  ...
  # source://action_policy/0.6.1/lib/action_policy/rails/controller.rb#32
  def verify_authorized_skipped; end

  protected

  # source://action_policy/0.6.1/lib/action_policy/rails/controller.rb#31
  def authorize_count=(_arg0); end
...
# source://actionpack/7.0.3.1/lib/action_controller/base.rb#206
ActionController::Base::MODULES = T.let(T.unsafe(nil), Array)

# source://actionpack/7.0.3.1/lib/action_controller/base.rb#261
...
module ActionController::RespondWith
  ...
  #
  # source://responders//lib/action_controller/respond_with.rb#199
  ...
  # current action.
  #
  # source://responders//lib/action_controller/respond_with.rb#243
  ...
  #   end
  #
  # source://responders//lib/action_controller/respond_with.rb#230
...
class ActionController::Responder
  ...
  #
  # source://responders//lib/action_controller/responder.rb#132
  ...
  # source://responders//lib/action_controller/responder.rb#149
  ...
  #
  # source://responders//lib/action_controller/responder.rb#164
  def respond; end
  ...
  #
  # source://responders//lib/action_controller/responder.rb#187
  def to_format; end

  # HTML format does not render the resource, it always attempt to render a
  # template.
  #
  # source://responders//lib/action_controller/responder.rb#172
  def to_html; end

  # to_js simply tries to render a template. If no template is found, raises the error.
  #
  # source://responders//lib/action_controller/responder.rb#179
  def to_js; end
  ...
  #
  # source://responders//lib/action_controller/responder.rb#213
  def api_behavior; end

  # Returns the resource location by retrieving it from the options or
  # returning the resources array.
  #
  # source://responders//lib/action_controller/responder.rb#228
  def api_location; end

  # By default, render the <code>:edit</code> action for HTML requests with errors, unless
  # the verb was POST.
  #
  # source://responders//lib/action_controller/responder.rb#290
  def default_action; end

  # If a response block was given, use it, otherwise call render on
  # controller.
  #
  # source://responders//lib/action_controller/responder.rb#237
  ...
  #
  # source://responders//lib/action_controller/responder.rb#264
  def display(resource, given_options = T.unsafe(nil)); end

  # source://responders//lib/action_controller/responder.rb#268
  ...
  # @return [Boolean]
  #
  # source://responders//lib/action_controller/responder.rb#274
  def has_errors?; end
  ...
  # @return [Boolean]
  #
  # source://responders//lib/action_controller/responder.rb#279
  ...
  #
  # source://responders//lib/action_controller/responder.rb#202
  ...
  class << self
    ...
    #
    # source://responders//lib/action_controller/responder.rb#158
    def call(*args); end
