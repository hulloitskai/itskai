...
class Searchkick::Index
  ...
  # source://searchkick//lib/searchkick/index.rb#106
  def all_indices(unaliased: T.unsafe(nil)); end

  # source://searchkick//lib/searchkick/index.rb#268
  def batches_left; end

  # source://searchkick//lib/searchkick/index.rb#149
  def bulk_delete(records); end

  # source://searchkick//lib/searchkick/index.rb#157
  def bulk_index(records); end

  # source://searchkick//lib/searchkick/index.rb#166
  def bulk_update(records, method_name); end

  # remove old indices that start w/ index_name
  #
  # source://searchkick//lib/searchkick/index.rb#123
  def clean_indices; end

  # private
  #
  # source://searchkick//lib/searchkick/index.rb#286
  def conversions_fields; end

  # source://searchkick//lib/searchkick/index.rb#15
  def create(body = T.unsafe(nil)); end

  # source://searchkick//lib/searchkick/index.rb#257
  def create_index(index_options: T.unsafe(nil)); end

  # source://searchkick//lib/searchkick/index.rb#19
  def delete; end

  # source://searchkick//lib/searchkick/index.rb#178
  ...
  # source://searchkick//lib/searchkick/index.rb#264
  ...
  # private
  #
  # source://searchkick//lib/searchkick/index.rb#273
  def klass_document_type(klass, ignore_type = T.unsafe(nil)); end

  # private
  #
  # source://searchkick//lib/searchkick/index.rb#299
  ...
  # source://searchkick//lib/searchkick/index.rb#77
  ...
  #
  # source://searchkick//lib/searchkick/index.rb#214
  def reindex(object, method_name: T.unsafe(nil), full: T.unsafe(nil), **options); end

  # queue
  #
  # source://searchkick//lib/searchkick/index.rb#206
  def reindex_queue; end

  # source://searchkick//lib/searchkick/index.rb#190
  def reload_synonyms; end

  # source://searchkick//lib/searchkick/index.rb#137
  def remove(record); end

  # source://searchkick//lib/searchkick/index.rb#97
  def retrieve(record); end

  # source://searchkick//lib/searchkick/index.rb#174
  ...
  # source://searchkick//lib/searchkick/index.rb#182
  def similar_record(record, **options); end

  # source://searchkick//lib/searchkick/index.rb#131
  def store(record); end

  # private
  #
  # source://searchkick//lib/searchkick/index.rb#294
  ...
  # source://searchkick//lib/searchkick/index.rb#143
  ...
  # private
  #
  # source://searchkick//lib/searchkick/index.rb#307
  def uuid; end
  ...
  #
  # source://searchkick//lib/searchkick/index.rb#432
  def check_uuid(old_uuid, new_uuid); end

  # source://searchkick//lib/searchkick/index.rb#313
  def client; end

  # https://gist.github.com/jarosan/3124884
  # http://www.elasticsearch.org/blog/changing-mapping-with-zero-downtime/
  #
  # source://searchkick//lib/searchkick/index.rb#352
  ...
  # source://searchkick//lib/searchkick/index.rb#337
  def import_before_promotion(index, relation, **import_options); end

  # source://searchkick//lib/searchkick/index.rb#333
  def index_settings; end

  # source://searchkick//lib/searchkick/index.rb#438
  def notify(record, name); end

  # source://searchkick//lib/searchkick/index.rb#453
  def notify_bulk(records, name); end

  # source://searchkick//lib/searchkick/index.rb#321
  def queue_delete(records); end

  # source://searchkick//lib/searchkick/index.rb#317
  def queue_index(records); end

  # source://searchkick//lib/searchkick/index.rb#325
  def queue_update(records, method_name); end

  # source://searchkick//lib/searchkick/index.rb#341
  def reindex_records(object, mode: T.unsafe(nil), refresh: T.unsafe(nil), **options); end

  # source://searchkick//lib/searchkick/index.rb#329
...
class Searchkick::Query
  ...
  # source://searchkick//lib/searchkick/query.rb#1146
  ...
  #
  # source://searchkick//lib/searchkick/query.rb#1117
  def coordinate_array(value); end

  # source://searchkick//lib/searchkick/query.rb#1079
  ...
  #
  # source://searchkick//lib/searchkick/query.rb#888
  ...
  # source://searchkick//lib/searchkick/query.rb#243
  def prepare; end

  # source://searchkick//lib/searchkick/query.rb#228
  def reindex_command; end

  # source://searchkick//lib/searchkick/query.rb#802
  def set_aggregations(payload, filters, post_filters); end

  # source://searchkick//lib/searchkick/query.rb#702
  def set_boost_by(multiply_filters, custom_filters); end

  # source://searchkick//lib/searchkick/query.rb#664
  def set_boost_by_distance(custom_filters); end

  # source://searchkick//lib/searchkick/query.rb#731
  def set_boost_by_indices(payload); end

  # source://searchkick//lib/searchkick/query.rb#689
  def set_boost_by_recency(custom_filters); end

  # source://searchkick//lib/searchkick/query.rb#715
  def set_boost_where(custom_filters); end

  # source://searchkick//lib/searchkick/query.rb#622
  def set_conversions; end

  # source://searchkick//lib/searchkick/query.rb#651
  def set_exclude(field, analyzer); end

  # source://searchkick//lib/searchkick/query.rb#563
  def set_fields; end

  # source://searchkick//lib/searchkick/query.rb#770
  def set_highlights(payload, fields); end

  # source://searchkick//lib/searchkick/query.rb#882
  def set_order(payload); end

  # source://searchkick//lib/searchkick/query.rb#874
  def set_post_filters(payload, post_filters); end

  # source://searchkick//lib/searchkick/query.rb#742
  def set_suggestions(payload, suggest); end

  # source://searchkick//lib/searchkick/query.rb#1032
...
class Searchkick::ReindexQueue
  ...
  # source://searchkick//lib/searchkick/reindex_queue.rb#71
...
class Searchkick::Relation
  ...
  # experimental
  #
  # source://searchkick//lib/searchkick/relation.rb#194
  def except(*keys); end

  # source://searchkick//lib/searchkick/relation.rb#27
  def execute; end

  # experimental
  #
  # source://searchkick//lib/searchkick/relation.rb#177
  def includes(*values); end

  # experimental
  #
  # source://searchkick//lib/searchkick/relation.rb#182
  def includes!(*values); end

  # same as Active Record
  #
  # source://searchkick//lib/searchkick/relation.rb#21
  def inspect; end

  # experimental
  #
  # source://searchkick//lib/searchkick/relation.rb#34
  def limit(value); end

  # experimental
  #
  # source://searchkick//lib/searchkick/relation.rb#39
  def limit!(value); end

  # @return [Boolean]
  #
  # source://searchkick//lib/searchkick/relation.rb#198
  def loaded?; end
  ...
  # experimental
  #
  # source://searchkick//lib/searchkick/relation.rb#46
  def offset(value = T.unsafe(nil)); end

  # experimental
  #
  # source://searchkick//lib/searchkick/relation.rb#56
  def offset!(value); end

  # experimental
  #
  # source://searchkick//lib/searchkick/relation.rb#189
  def only(*keys); end

  # experimental
  #
  # source://searchkick//lib/searchkick/relation.rb#124
  def order(*values); end

  # experimental
  #
  # source://searchkick//lib/searchkick/relation.rb#129
  def order!(*values); end

  # experimental
  #
  # source://searchkick//lib/searchkick/relation.rb#63
  def page(value); end

  # experimental
  #
  # source://searchkick//lib/searchkick/relation.rb#68
  def page!(value); end
  ...
  # experimental
  #
  # source://searchkick//lib/searchkick/relation.rb#75
  def per_page(value = T.unsafe(nil)); end

  # experimental
  #
  # source://searchkick//lib/searchkick/relation.rb#85
  def per_page!(value); end

  # experimental
  #
  # source://searchkick//lib/searchkick/relation.rb#137
  def reorder(*values); end

  # experimental
  #
  # source://searchkick//lib/searchkick/relation.rb#142
  def reorder!(*values); end

  # experimental
  #
  # source://searchkick//lib/searchkick/relation.rb#165
  def reselect(*values); end

  # experimental
  #
  # source://searchkick//lib/searchkick/relation.rb#170
  def reselect!(*values); end

  # experimental
  #
  # source://searchkick//lib/searchkick/relation.rb#112
  def rewhere(value); end

  # experimental
  #
  # source://searchkick//lib/searchkick/relation.rb#117
  def rewhere!(value); end

  # experimental
  #
  # source://searchkick//lib/searchkick/relation.rb#149
  def select(*values, &block); end

  # experimental
  #
  # source://searchkick//lib/searchkick/relation.rb#158
  def select!(*values); end

  # experimental
  #
  # source://searchkick//lib/searchkick/relation.rb#92
  def where(value = T.unsafe(nil)); end

  # experimental
  #
  # source://searchkick//lib/searchkick/relation.rb#101
  def where!(value); end
  ...
  # @raise [Error]
  #
  # source://searchkick//lib/searchkick/relation.rb#212
  ...
  # source://searchkick//lib/searchkick/relation.rb#204
  def private_execute; end

  # source://searchkick//lib/searchkick/relation.rb#208
  def query; end
...
class Searchkick::RelationIndexer
  ...
  # source://searchkick//lib/searchkick/relation_indexer.rb#48
  def batch_completed(batch_id); end

  # source://searchkick//lib/searchkick/relation_indexer.rb#44
  def batches_left; end
  ...
  # source://searchkick//lib/searchkick/relation_indexer.rb#136
  def batch_job(class_name, batch_id, record_ids); end

  # source://searchkick//lib/searchkick/relation_indexer.rb#122
  def batch_size; end

  # source://searchkick//lib/searchkick/relation_indexer.rb#146
  def batches_key; end

  # @yield [items]
  #
  # source://searchkick//lib/searchkick/relation_indexer.rb#108
  def each_batch(relation, batch_size:); end

  # source://searchkick//lib/searchkick/relation_indexer.rb#126
  def full_reindex_async(relation); end

  # source://searchkick//lib/searchkick/relation_indexer.rb#65
  def in_batches(relation); end

  # source://searchkick//lib/searchkick/relation_indexer.rb#54
...
class Searchkick::Results
  ...
  #
  # source://searchkick//lib/searchkick/results.rb#10
  ...
  # source://searchkick//lib/searchkick/results.rb#340
  def base_field(k); end

  # source://searchkick//lib/searchkick/results.rb#302
  def build_hits; end

  # source://searchkick//lib/searchkick/results.rb#330
  def combine_includes(result, inc); end

  # source://searchkick//lib/searchkick/results.rb#344
  def hit_highlights(hit, multiple: T.unsafe(nil)); end

  # source://searchkick//lib/searchkick/results.rb#311
  def results_query(records, hits); end

  # source://searchkick//lib/searchkick/results.rb#218
