...
module Faraday::DependencyLoader
  ...
  # libraries
  #
  # source://faraday//lib/faraday/dependency_loader.rb#10
  def dependency(lib = T.unsafe(nil)); end

  # source://faraday//lib/faraday/dependency_loader.rb#28
  def inherited(subclass); end

  # Returns the value of attribute load_error.
  #
  # source://faraday//lib/faraday/dependency_loader.rb#6
  def load_error; end

  # @return [Boolean]
  #
  # source://faraday//lib/faraday/dependency_loader.rb#24
  def loaded?; end

  # source://faraday//lib/faraday/dependency_loader.rb#16
  def new(*_arg0); end
  ...
  #
  # source://faraday//lib/faraday/dependency_loader.rb#35
...
# source://faraday_middleware/1.2.0/lib/faraday_middleware/request/oauth.rb#90
Faraday::Request::OAuth = FaradayMiddleware::OAuth

# source://faraday_middleware/1.2.0/lib/faraday_middleware/request/oauth2.rb#88
...
# source://faraday_middleware/1.2.0/lib/faraday_middleware/response/mashify.rb#39
...
# source://faraday_middleware/1.2.0/lib/faraday_middleware/response/parse_json.rb#50
Faraday::Response::ParseJson = FaradayMiddleware::ParseJson

# source://faraday_middleware/1.2.0/lib/faraday_middleware/response/parse_marshal.rb#15
Faraday::Response::ParseMarshal = FaradayMiddleware::ParseMarshal

# source://faraday_middleware/1.2.0/lib/faraday_middleware/response/parse_xml.rb#17
Faraday::Response::ParseXml = FaradayMiddleware::ParseXml

# source://faraday_middleware/1.2.0/lib/faraday_middleware/response/parse_yaml.rb#39
