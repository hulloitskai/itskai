...
# source://active_record_extended//lib/active_record_extended/query_methods/where_chain.rb#103
...
module ActiveRecordExtended::QueryMethods::WhereChain
  ...
  # source://active_record_extended//lib/active_record_extended/query_methods/where_chain.rb#63
  def assoc_from_related_table(arel); end

  # source://active_record_extended//lib/active_record_extended/query_methods/where_chain.rb#94
  def build_where_clause_for(scope, opts, rest); end

  # source://active_record_extended//lib/active_record_extended/query_methods/where_chain.rb#58
  ...
  # source://active_record_extended//lib/active_record_extended/query_methods/where_chain.rb#68
  def left_column(arel); end

  # @return [Boolean]
  #
  # source://active_record_extended//lib/active_record_extended/query_methods/where_chain.rb#54
  def matchable_column?(col, arel); end

  # source://active_record_extended//lib/active_record_extended/query_methods/where_chain.rb#83
...
module ActiveRecordExtended::QueryMethods::WithCTE
  # source://active_record_extended//lib/active_record_extended/query_methods/with_cte.rb#185
  def build_with(arel); end

  # @return [WithCTE]
  #
  # source://active_record_extended//lib/active_record_extended/query_methods/with_cte.rb#125
  def cte; end

  # @param cte [WithCTE]
  # @raise [TypeError]
  #
  # source://active_record_extended//lib/active_record_extended/query_methods/with_cte.rb#130
  def cte=(cte); end
  ...
  # @return [Boolean]
  #
  # source://active_record_extended//lib/active_record_extended/query_methods/with_cte.rb#159
  ...
  # @param opts [Hash, WithCTE]
  #
  # source://active_record_extended//lib/active_record_extended/query_methods/with_cte.rb#171
  def with!(opts = T.unsafe(nil), *rest); end

  # @return [Array<Hash>]
  #
  # source://active_record_extended//lib/active_record_extended/query_methods/with_cte.rb#142
  def with_values; end

  # @param values [Hash, WithCTE]
  #
  # source://active_record_extended//lib/active_record_extended/query_methods/with_cte.rb#147
  def with_values=(values); end

  # @return [Boolean]
  #
  # source://active_record_extended//lib/active_record_extended/query_methods/with_cte.rb#137
  def with_values?; end

  private

  # source://active_record_extended//lib/active_record_extended/query_methods/with_cte.rb#205
...
class ActiveRecordExtended::QueryMethods::WithCTE::WithCTE
  ...
  # source://active_record_extended//lib/active_record_extended/query_methods/with_cte.rb#74
  def reset!; end
...
class ActiveRecordExtended::QueryMethods::WithCTE::WithChain
  ...
  #
  # source://active_record_extended//lib/active_record_extended/query_methods/with_cte.rb#84
  def initialize(scope); end
  ...
  # @param args [Hash, WithCTE]
  #
  # source://active_record_extended//lib/active_record_extended/query_methods/with_cte.rb#111
  def not_materialized(args); end

  # @param args [Hash, WithCTE]
  #
  # source://active_record_extended//lib/active_record_extended/query_methods/with_cte.rb#90
...
module ActiveRecordExtended::Visitors::PostgreSQLDecorator
  ...
  # @return [Boolean]
  #
  # source://active_record_extended//lib/active_record_extended/arel/visitors/postgresql_decorator.rb#94
  def matchable_column?(col, object); end

  # source://active_record_extended//lib/active_record_extended/arel/visitors/postgresql_decorator.rb#59
  def visit_Arel_Nodes_AggregateFunctionName(object, collector); end

  # source://active_record_extended//lib/active_record_extended/arel/visitors/postgresql_decorator.rb#51
  def visit_Arel_Nodes_Array(object, collector); end

  # source://active_record_extended//lib/active_record_extended/arel/visitors/postgresql_decorator.rb#55
  def visit_Arel_Nodes_ArrayAgg(object, collector); end

  # source://active_record_extended//lib/active_record_extended/arel/visitors/postgresql_decorator.rb#23
  def visit_Arel_Nodes_ContainedInArray(object, collector); end

  # source://active_record_extended//lib/active_record_extended/arel/visitors/postgresql_decorator.rb#19
  def visit_Arel_Nodes_ContainedInHStore(object, collector); end

  # source://active_record_extended//lib/active_record_extended/arel/visitors/postgresql_decorator.rb#11
  def visit_Arel_Nodes_ContainsArray(object, collector); end

  # source://active_record_extended//lib/active_record_extended/arel/visitors/postgresql_decorator.rb#15
  def visit_Arel_Nodes_ContainsHStore(object, collector); end

  # source://active_record_extended//lib/active_record_extended/arel/visitors/postgresql_decorator.rb#27
  ...
  # source://active_record_extended//lib/active_record_extended/arel/visitors/postgresql_decorator.rb#86
  def visit_Arel_Nodes_Inet_ContainsEquals(object, collector); end

  # source://active_record_extended//lib/active_record_extended/arel/visitors/postgresql_decorator.rb#90
  def visit_Arel_Nodes_Inet_ContainsOrContainedWithin(object, collector); end

  # source://active_record_extended//lib/active_record_extended/arel/visitors/postgresql_decorator.rb#35
  def visit_Arel_Nodes_JsonBuildObject(object, collector); end

  # source://active_record_extended//lib/active_record_extended/arel/visitors/postgresql_decorator.rb#39
  def visit_Arel_Nodes_JsonbBuildObject(object, collector); end

  # source://active_record_extended//lib/active_record_extended/arel/visitors/postgresql_decorator.rb#31
  def visit_Arel_Nodes_RowToJson(object, collector); end

  # source://active_record_extended//lib/active_record_extended/arel/visitors/postgresql_decorator.rb#43
  def visit_Arel_Nodes_ToJson(object, collector); end

  # source://active_record_extended//lib/active_record_extended/arel/visitors/postgresql_decorator.rb#47
...
# source://active_record_extended//lib/active_record_extended/arel/nodes.rb#23
class Arel::Nodes::Array < ::Arel::Nodes::Function
  # source://active_record_extended//lib/active_record_extended/arel/nodes.rb#24
...
# source://active_record_extended//lib/active_record_extended/arel/nodes.rb#12
...
# source://active_record_extended//lib/active_record_extended/arel/nodes.rb#35
module Arel::Nodes::Inet; end

# source://active_record_extended//lib/active_record_extended/arel/nodes.rb#42
