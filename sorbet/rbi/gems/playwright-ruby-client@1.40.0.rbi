...
class Playwright::APIRequest < ::Playwright::PlaywrightApi
  ...
  def new_context(baseURL: T.unsafe(nil), extraHTTPHeaders: T.unsafe(nil), httpCredentials: T.unsafe(nil), ignoreHTTPSErrors: T.unsafe(nil), proxy: T.unsafe(nil), storageState: T.unsafe(nil), timeout: T.unsafe(nil), userAgent: T.unsafe(nil)); end
end
...
class Playwright::APIRequestContext < ::Playwright::PlaywrightApi
  ...
  def delete(url, data: T.unsafe(nil), failOnStatusCode: T.unsafe(nil), form: T.unsafe(nil), headers: T.unsafe(nil), ignoreHTTPSErrors: T.unsafe(nil), maxRedirects: T.unsafe(nil), multipart: T.unsafe(nil), params: T.unsafe(nil), timeout: T.unsafe(nil)); end
  ...
  #
  # source://playwright-ruby-client//lib/playwright_api/api_request_context.rb#90
  def dispose; end
  ...
  # ```
  #
  # source://playwright-ruby-client//lib/playwright_api/api_request_context.rb#122
  def fetch(urlOrRequest, data: T.unsafe(nil), failOnStatusCode: T.unsafe(nil), form: T.unsafe(nil), headers: T.unsafe(nil), ignoreHTTPSErrors: T.unsafe(nil), maxRedirects: T.unsafe(nil), method: T.unsafe(nil), multipart: T.unsafe(nil), params: T.unsafe(nil), timeout: T.unsafe(nil)); end
  ...
  # ```
  #
  # source://playwright-ruby-client//lib/playwright_api/api_request_context.rb#153
  def get(url, data: T.unsafe(nil), failOnStatusCode: T.unsafe(nil), form: T.unsafe(nil), headers: T.unsafe(nil), ignoreHTTPSErrors: T.unsafe(nil), maxRedirects: T.unsafe(nil), multipart: T.unsafe(nil), params: T.unsafe(nil), timeout: T.unsafe(nil)); end

  # Sends HTTP(S) [HEAD](https://developer.mozilla.org/en-US/docs/Web/HTTP/Methods/HEAD) request and returns its response.
  # The method will populate request cookies from the context and update
  # context cookies from the response. The method will automatically follow redirects.
  #
  # source://playwright-ruby-client//lib/playwright_api/api_request_context.rb#171
  def head(url, data: T.unsafe(nil), failOnStatusCode: T.unsafe(nil), form: T.unsafe(nil), headers: T.unsafe(nil), ignoreHTTPSErrors: T.unsafe(nil), maxRedirects: T.unsafe(nil), multipart: T.unsafe(nil), params: T.unsafe(nil), timeout: T.unsafe(nil)); end

  # -- inherited from EventEmitter --
  #
  # source://playwright-ruby-client//lib/playwright_api/api_request_context.rb#283
  def off(event, callback); end

  # -- inherited from EventEmitter --
  #
  # source://playwright-ruby-client//lib/playwright_api/api_request_context.rb#295
  def on(event, callback); end

  # -- inherited from EventEmitter --
  #
  # source://playwright-ruby-client//lib/playwright_api/api_request_context.rb#289
  ...
  # context cookies from the response. The method will automatically follow redirects.
  #
  # source://playwright-ruby-client//lib/playwright_api/api_request_context.rb#189
  def patch(url, data: T.unsafe(nil), failOnStatusCode: T.unsafe(nil), form: T.unsafe(nil), headers: T.unsafe(nil), ignoreHTTPSErrors: T.unsafe(nil), maxRedirects: T.unsafe(nil), multipart: T.unsafe(nil), params: T.unsafe(nil), timeout: T.unsafe(nil)); end
  ...
  # ```
  #
  # source://playwright-ruby-client//lib/playwright_api/api_request_context.rb#243
  def post(url, data: T.unsafe(nil), failOnStatusCode: T.unsafe(nil), form: T.unsafe(nil), headers: T.unsafe(nil), ignoreHTTPSErrors: T.unsafe(nil), maxRedirects: T.unsafe(nil), multipart: T.unsafe(nil), params: T.unsafe(nil), timeout: T.unsafe(nil)); end

  # Sends HTTP(S) [PUT](https://developer.mozilla.org/en-US/docs/Web/HTTP/Methods/PUT) request and returns its response.
  # The method will populate request cookies from the context and update
  # context cookies from the response. The method will automatically follow redirects.
  #
  # source://playwright-ruby-client//lib/playwright_api/api_request_context.rb#261
  def put(url, data: T.unsafe(nil), failOnStatusCode: T.unsafe(nil), form: T.unsafe(nil), headers: T.unsafe(nil), ignoreHTTPSErrors: T.unsafe(nil), maxRedirects: T.unsafe(nil), multipart: T.unsafe(nil), params: T.unsafe(nil), timeout: T.unsafe(nil)); end

  # Returns storage state for this request context, contains current cookies and local storage snapshot if it was passed to the constructor.
  #
  # @raise [NotImplementedError]
  #
  # source://playwright-ruby-client//lib/playwright_api/api_request_context.rb#277
  def storage_state(path: T.unsafe(nil)); end

  private

  # source://playwright-ruby-client//lib/playwright_api/api_request_context.rb#299
...
class Playwright::Accessibility < ::Playwright::PlaywrightApi
  ...
  # ```
  #
  # source://playwright-ruby-client//lib/playwright_api/accessibility.rb#51
...
# ```
#
# source://playwright-ruby-client//lib/playwright_api/android.rb#25
class Playwright::Android < ::Playwright::PlaywrightApi
  ...
  # -- inherited from EventEmitter --
  #
  # source://playwright-ruby-client//lib/playwright_api/android.rb#61
  def on(event, callback); end
  ...
  # source://playwright-ruby-client//lib/playwright_api/android.rb#65
  def event_emitter_proxy; end
end
...
class Playwright::AndroidDevice < ::Playwright::PlaywrightApi
  ...
  # @raise [NotImplementedError]
  #
  # source://playwright-ruby-client//lib/playwright_api/android_device.rb#149
  def default_timeout=(timeout); end
  ...
  def launch_browser(acceptDownloads: T.unsafe(nil), args: T.unsafe(nil), baseURL: T.unsafe(nil), bypassCSP: T.unsafe(nil), colorScheme: T.unsafe(nil), command: T.unsafe(nil), deviceScaleFactor: T.unsafe(nil), extraHTTPHeaders: T.unsafe(nil), forcedColors: T.unsafe(nil), geolocation: T.unsafe(nil), hasTouch: T.unsafe(nil), httpCredentials: T.unsafe(nil), ignoreHTTPSErrors: T.unsafe(nil), isMobile: T.unsafe(nil), javaScriptEnabled: T.unsafe(nil), locale: T.unsafe(nil), noViewport: T.unsafe(nil), offline: T.unsafe(nil), permissions: T.unsafe(nil), proxy: T.unsafe(nil), record_har_content: T.unsafe(nil), record_har_mode: T.unsafe(nil), record_har_omit_content: T.unsafe(nil), record_har_path: T.unsafe(nil), record_har_url_filter: T.unsafe(nil), record_video_dir: T.unsafe(nil), record_video_size: T.unsafe(nil), reducedMotion: T.unsafe(nil), screen: T.unsafe(nil), serviceWorkers: T.unsafe(nil), strictSelectors: T.unsafe(nil), timezoneId: T.unsafe(nil), userAgent: T.unsafe(nil), viewport: T.unsafe(nil), &block); end

  # Performs a long tap on the widget defined by `selector`.
  #
  # @raise [NotImplementedError]
  #
  # source://playwright-ruby-client//lib/playwright_api/android_device.rb#89
  def long_tap(selector); end

  # Device model.
  #
  # source://playwright-ruby-client//lib/playwright_api/android_device.rb#95
  def model; end

  # -- inherited from EventEmitter --
  #
  # source://playwright-ruby-client//lib/playwright_api/android_device.rb#208
  def off(event, callback); end

  # -- inherited from EventEmitter --
  #
  # source://playwright-ruby-client//lib/playwright_api/android_device.rb#220
  def on(event, callback); end

  # -- inherited from EventEmitter --
  #
  # source://playwright-ruby-client//lib/playwright_api/android_device.rb#214
  def once(event, callback); end
  ...
  # @raise [NotImplementedError]
  #
  # source://playwright-ruby-client//lib/playwright_api/android_device.rb#101
  ...
  # @raise [NotImplementedError]
  #
  # source://playwright-ruby-client//lib/playwright_api/android_device.rb#107
  ...
  # @raise [NotImplementedError]
  #
  # source://playwright-ruby-client//lib/playwright_api/android_device.rb#113
  ...
  # @raise [NotImplementedError]
  #
  # source://playwright-ruby-client//lib/playwright_api/android_device.rb#119
  ...
  # @raise [NotImplementedError]
  #
  # source://playwright-ruby-client//lib/playwright_api/android_device.rb#125
  def push(file, path, mode: T.unsafe(nil)); end

  # Returns the buffer with the captured screenshot of the device.
  #
  # source://playwright-ruby-client//lib/playwright_api/android_device.rb#131
  ...
  # @raise [NotImplementedError]
  #
  # source://playwright-ruby-client//lib/playwright_api/android_device.rb#137
  def scroll(selector, direction, percent, speed: T.unsafe(nil)); end

  # Device serial number.
  #
  # source://playwright-ruby-client//lib/playwright_api/android_device.rb#143
  def serial; end
  ...
  #
  # source://playwright-ruby-client//lib/playwright_api/android_device.rb#156
  def shell(command); end

  # source://playwright-ruby-client//lib/playwright_api/android_device.rb#202
  ...
  # @raise [NotImplementedError]
  #
  # source://playwright-ruby-client//lib/playwright_api/android_device.rb#162
  def swipe(selector, direction, percent, speed: T.unsafe(nil)); end

  # source://playwright-ruby-client//lib/playwright_api/android_device.rb#197
  ...
  # @raise [NotImplementedError]
  #
  # source://playwright-ruby-client//lib/playwright_api/android_device.rb#168
  ...
  # @raise [NotImplementedError]
  #
  # source://playwright-ruby-client//lib/playwright_api/android_device.rb#174
  ...
  # @raise [NotImplementedError]
  #
  # source://playwright-ruby-client//lib/playwright_api/android_device.rb#180
  ...
  # @raise [NotImplementedError]
  #
  # source://playwright-ruby-client//lib/playwright_api/android_device.rb#186
  ...
  # @raise [NotImplementedError]
  #
  # source://playwright-ruby-client//lib/playwright_api/android_device.rb#192
  def web_views; end

  private

  # source://playwright-ruby-client//lib/playwright_api/android_device.rb#224
  def event_emitter_proxy; end
end
...
# ```
#
# source://playwright-ruby-client//lib/playwright_api/browser.rb#19
class Playwright::Browser < ::Playwright::PlaywrightApi
  # Get the browser type (chromium, firefox or webkit) that the browser belongs to.
  #
  # source://playwright-ruby-client//lib/playwright_api/browser.rb#23
  ...
  #
  # source://playwright-ruby-client//lib/playwright_api/browser.rb#37
  ...
  # @return [Boolean]
  #
  # source://playwright-ruby-client//lib/playwright_api/browser.rb#58
  def connected?; end
  ...
  # ```
  #
  # source://playwright-ruby-client//lib/playwright_api/browser.rb#52
  def contexts; end
  ...
  #
  # source://playwright-ruby-client//lib/playwright_api/browser.rb#66
  ...
  #
  # source://playwright-ruby-client//lib/playwright_api/browser.rb#134
  ...
  # -- inherited from EventEmitter --
  #
  # source://playwright-ruby-client//lib/playwright_api/browser.rb#205
  def off(event, callback); end

  # -- inherited from EventEmitter --
  #
  # source://playwright-ruby-client//lib/playwright_api/browser.rb#217
  def on(event, callback); end

  # -- inherited from EventEmitter --
  #
  # source://playwright-ruby-client//lib/playwright_api/browser.rb#211
  def once(event, callback); end
  ...
  # ```
  #
  # source://playwright-ruby-client//lib/playwright_api/browser.rb#185
  ...
  #
  # source://playwright-ruby-client//lib/playwright_api/browser.rb#193
  def stop_tracing; end

  # Returns the browser version.
  #
  # source://playwright-ruby-client//lib/playwright_api/browser.rb#199
  def version; end

  private

  # source://playwright-ruby-client//lib/playwright_api/browser.rb#221
  def event_emitter_proxy; end
end
...
# ```
#
# source://playwright-ruby-client//lib/playwright_api/browser_context.rb#21
class Playwright::BrowserContext < ::Playwright::PlaywrightApi
  ...
  # ```
  #
  # source://playwright-ruby-client//lib/playwright_api/browser_context.rb#42
  ...
  #
  # source://playwright-ruby-client//lib/playwright_api/browser_context.rb#65
  ...
  #
  # source://playwright-ruby-client//lib/playwright_api/browser_context.rb#73
  def background_pages; end

  # Returns the browser instance of the context. If it was launched as a persistent context null gets returned.
  #
  # source://playwright-ruby-client//lib/playwright_api/browser_context.rb#79
  def browser; end

  # source://playwright-ruby-client//lib/playwright_api/browser_context.rb#456
  def browser=(req); end

  # Clears context cookies.
  #
  # source://playwright-ruby-client//lib/playwright_api/browser_context.rb#85
  ...
  #
  # source://playwright-ruby-client//lib/playwright_api/browser_context.rb#108
  def close(reason: T.unsafe(nil)); end
  ...
  #
  # source://playwright-ruby-client//lib/playwright_api/browser_context.rb#334
  ...
  # source://playwright-ruby-client//lib/playwright_api/browser_context.rb#451
  ...
  #
  # source://playwright-ruby-client//lib/playwright_api/browser_context.rb#398
  ...
  # ```
  #
  # source://playwright-ruby-client//lib/playwright_api/browser_context.rb#413
  ...
  # ```
  #
  # source://playwright-ruby-client//lib/playwright_api/browser_context.rb#172
  ...
  # ```
  #
  # source://playwright-ruby-client//lib/playwright_api/browser_context.rb#219
  ...
  #
  # source://playwright-ruby-client//lib/playwright_api/browser_context.rb#355
  ...
  # its geolocation.
  #
  # source://playwright-ruby-client//lib/playwright_api/browser_context.rb#371
  def geolocation=(geolocation); end

  # Grants specified permissions to the browser context. Only grants corresponding permissions to the given origin if
  # specified.
  #
  # source://playwright-ruby-client//lib/playwright_api/browser_context.rb#226
  ...
  #
  # source://playwright-ruby-client//lib/playwright_api/browser_context.rb#234
  def new_cdp_session(page); end

  # Creates a new page in the browser context.
  #
  # source://playwright-ruby-client//lib/playwright_api/browser_context.rb#240
  ...
  # source://playwright-ruby-client//lib/playwright_api/browser_context.rb#376
  def offline=(offline); end

  # -- inherited from EventEmitter --
  #
  # source://playwright-ruby-client//lib/playwright_api/browser_context.rb#474
  def on(event, callback); end

  # -- inherited from EventEmitter --
  #
  # source://playwright-ruby-client//lib/playwright_api/browser_context.rb#468
  def once(event, callback); end

  # source://playwright-ruby-client//lib/playwright_api/browser_context.rb#441
  def options=(req); end

  # source://playwright-ruby-client//lib/playwright_api/browser_context.rb#446
  def owner_page=(req); end

  # Returns all open pages in the context.
  #
  # source://playwright-ruby-client//lib/playwright_api/browser_context.rb#246
  def pages; end

  # source://playwright-ruby-client//lib/playwright_api/browser_context.rb#436
  def pause; end

  # API testing helper associated with this context. Requests made with this API will use context cookies.
  #
  # source://playwright-ruby-client//lib/playwright_api/browser_context.rb#25
  def request; end
  ...
  #
  # source://playwright-ruby-client//lib/playwright_api/browser_context.rb#297
  ...
  #
  # source://playwright-ruby-client//lib/playwright_api/browser_context.rb#305
  ...
  #
  # source://playwright-ruby-client//lib/playwright_api/browser_context.rb#319
  ...
  #
  # source://playwright-ruby-client//lib/playwright_api/browser_context.rb#383
  def storage_state(path: T.unsafe(nil)); end

  # property
  #
  # source://playwright-ruby-client//lib/playwright_api/browser_context.rb#29
  def tracing; end

  # Removes a route created with [`method: BrowserContext.route`]. When `handler` is not specified, removes all
  # routes for the `url`.
  #
  # source://playwright-ruby-client//lib/playwright_api/browser_context.rb#390
  ...
  # @raise [NotImplementedError]
  #
  # source://playwright-ruby-client//lib/playwright_api/browser_context.rb#431
  def wait_for_event(event, predicate: T.unsafe(nil), timeout: T.unsafe(nil)); end

  private

  # source://playwright-ruby-client//lib/playwright_api/browser_context.rb#478
  def event_emitter_proxy; end
end
...
class Playwright::BrowserType < ::Playwright::PlaywrightApi
  ...
  # @raise [NotImplementedError]
  #
  # source://playwright-ruby-client//lib/playwright_api/browser_type.rb#24
  ...
  # ```
  #
  # source://playwright-ruby-client//lib/playwright_api/browser_type.rb#47
  def connect_over_cdp(endpointURL, headers: T.unsafe(nil), slowMo: T.unsafe(nil), timeout: T.unsafe(nil), &block); end

  # A path where Playwright expects to find a bundled browser executable.
  #
  # source://playwright-ruby-client//lib/playwright_api/browser_type.rb#58
  ...
  #
  # source://playwright-ruby-client//lib/playwright_api/browser_type.rb#90
  ...
  #
  # source://playwright-ruby-client//lib/playwright_api/browser_type.rb#117
  ...
  #
  # source://playwright-ruby-client//lib/playwright_api/browser_type.rb#173
  def name; end
  ...
  # source://playwright-ruby-client//lib/playwright_api/browser_type.rb#195
  def event_emitter_proxy; end
end
...
# ```
#
# source://playwright-ruby-client//lib/playwright_api/cdp_session.rb#22
class Playwright::CDPSession < ::Playwright::PlaywrightApi
  # Detaches the CDPSession from the target. Once detached, the CDPSession object won't emit any events and can't be used to
  # send messages.
  #
  # source://playwright-ruby-client//lib/playwright_api/cdp_session.rb#27
  def detach; end

  # -- inherited from EventEmitter --
  #
  # source://playwright-ruby-client//lib/playwright_api/cdp_session.rb#37
  def off(event, callback); end

  # -- inherited from EventEmitter --
  #
  # source://playwright-ruby-client//lib/playwright_api/cdp_session.rb#49
  def on(event, callback); end

  # -- inherited from EventEmitter --
  #
  # source://playwright-ruby-client//lib/playwright_api/cdp_session.rb#43
  def once(event, callback); end

  # source://playwright-ruby-client//lib/playwright_api/cdp_session.rb#31
  def send_message(method, params: T.unsafe(nil)); end

  private

  # source://playwright-ruby-client//lib/playwright_api/cdp_session.rb#53
  def event_emitter_proxy; end
end
...
class Playwright::ChannelOwners::APIRequestContext < ::Playwright::ChannelOwner
  # source://playwright-ruby-client//lib/playwright/channel_owners/api_request_context.rb#13
  def delete(url, **options); end

  # source://playwright-ruby-client//lib/playwright/channel_owners/api_request_context.rb#9
  def dispose; end

  # source://playwright-ruby-client//lib/playwright/channel_owners/api_request_context.rb#43
  def fetch(urlOrRequest, data: T.unsafe(nil), failOnStatusCode: T.unsafe(nil), form: T.unsafe(nil), headers: T.unsafe(nil), ignoreHTTPSErrors: T.unsafe(nil), maxRedirects: T.unsafe(nil), method: T.unsafe(nil), multipart: T.unsafe(nil), params: T.unsafe(nil), timeout: T.unsafe(nil)); end

  # source://playwright-ruby-client//lib/playwright/channel_owners/api_request_context.rb#23
  def get(url, **options); end

  # source://playwright-ruby-client//lib/playwright/channel_owners/api_request_context.rb#18
  def head(url, **options); end

  # source://playwright-ruby-client//lib/playwright/channel_owners/api_request_context.rb#28
  def patch(url, **options); end

  # source://playwright-ruby-client//lib/playwright/channel_owners/api_request_context.rb#38
  def post(url, **options); end

  # source://playwright-ruby-client//lib/playwright/channel_owners/api_request_context.rb#33
  def put(url, **options); end

  private

  # source://playwright-ruby-client//lib/playwright/channel_owners/api_request_context.rb#82
  def _inner_fetch(request, url, data: T.unsafe(nil), failOnStatusCode: T.unsafe(nil), form: T.unsafe(nil), headers: T.unsafe(nil), ignoreHTTPSErrors: T.unsafe(nil), maxRedirects: T.unsafe(nil), method: T.unsafe(nil), multipart: T.unsafe(nil), params: T.unsafe(nil), timeout: T.unsafe(nil)); end

  # source://playwright-ruby-client//lib/playwright/channel_owners/api_request_context.rb#5
  def after_initialize; end

  # source://playwright-ruby-client//lib/playwright/channel_owners/api_request_context.rb#158
  def file_payload?(value); end

  # source://playwright-ruby-client//lib/playwright/channel_owners/api_request_context.rb#163
  def file_payload_to_json(payload); end

  # source://playwright-ruby-client//lib/playwright/channel_owners/api_request_context.rb#177
  def json_parsable?(data); end

  # source://playwright-ruby-client//lib/playwright/channel_owners/api_request_context.rb#171
...
class Playwright::ChannelOwners::BrowserContext < ::Playwright::ChannelOwner
  ...
  # source://playwright-ruby-client//lib/playwright/channel_owners/browser_context.rb#266
  def add_cookies(cookies); end

  # source://playwright-ruby-client//lib/playwright/channel_owners/browser_context.rb#299
  def add_init_script(path: T.unsafe(nil), script: T.unsafe(nil)); end

  # source://playwright-ruby-client//lib/playwright/channel_owners/browser_context.rb#213
  def background_pages; end
  ...
  # source://playwright-ruby-client//lib/playwright/channel_owners/browser_context.rb#270
  def clear_cookies; end

  # source://playwright-ruby-client//lib/playwright/channel_owners/browser_context.rb#282
  def clear_permissions; end

  # source://playwright-ruby-client//lib/playwright/channel_owners/browser_context.rb#406
  def close(reason: T.unsafe(nil)); end

  # source://playwright-ruby-client//lib/playwright/channel_owners/browser_context.rb#254
  def cookies(urls: T.unsafe(nil)); end

  # source://playwright-ruby-client//lib/playwright/channel_owners/browser_context.rb#436
  def enable_debug_console!; end

  # source://playwright-ruby-client//lib/playwright/channel_owners/browser_context.rb#478
  def expect_console_message(predicate: T.unsafe(nil), timeout: T.unsafe(nil), &block); end

  # source://playwright-ruby-client//lib/playwright/channel_owners/browser_context.rb#386
  def expect_event(event, predicate: T.unsafe(nil), timeout: T.unsafe(nil), &block); end

  # source://playwright-ruby-client//lib/playwright/channel_owners/browser_context.rb#486
  def expect_page(predicate: T.unsafe(nil), timeout: T.unsafe(nil), &block); end

  # source://playwright-ruby-client//lib/playwright/channel_owners/browser_context.rb#313
  def expose_binding(name, callback, handle: T.unsafe(nil)); end

  # source://playwright-ruby-client//lib/playwright/channel_owners/browser_context.rb#328
  def expose_function(name, callback); end

  # source://playwright-ruby-client//lib/playwright/channel_owners/browser_context.rb#274
  def grant_permissions(permissions, origin: T.unsafe(nil)); end

  # source://playwright-ruby-client//lib/playwright/channel_owners/browser_context.rb#221
  def new_cdp_session(page); end

  # source://playwright-ruby-client//lib/playwright/channel_owners/browser_context.rb#241
  def new_page(&block); end
  ...
  # source://playwright-ruby-client//lib/playwright/channel_owners/browser_context.rb#236
  def pages; end

  # source://playwright-ruby-client//lib/playwright/channel_owners/browser_context.rb#457
  def pause; end

  # source://playwright-ruby-client//lib/playwright/channel_owners/browser_context.rb#8
  def request; end

  # source://playwright-ruby-client//lib/playwright/channel_owners/browser_context.rb#332
  def route(url, handler, times: T.unsafe(nil)); end

  # source://playwright-ruby-client//lib/playwright/channel_owners/browser_context.rb#361
  def route_from_har(har, notFound: T.unsafe(nil), update: T.unsafe(nil), updateContent: T.unsafe(nil), updateMode: T.unsafe(nil), url: T.unsafe(nil)); end

  # source://playwright-ruby-client//lib/playwright/channel_owners/browser_context.rb#217
  def service_workers; end
  ...
  # source://playwright-ruby-client//lib/playwright/channel_owners/browser_context.rb#290
  def set_extra_http_headers(headers); end

  # source://playwright-ruby-client//lib/playwright/channel_owners/browser_context.rb#286
  def set_geolocation(geolocation); end

  # source://playwright-ruby-client//lib/playwright/channel_owners/browser_context.rb#295
  def set_offline(offline); end
  ...
  # source://playwright-ruby-client//lib/playwright/channel_owners/browser_context.rb#338
  def unroute(url, handler: T.unsafe(nil)); end

  private

  # source://playwright-ruby-client//lib/playwright/channel_owners/browser_context.rb#508
  def _timeout_settings; end

  # source://playwright-ruby-client//lib/playwright/channel_owners/browser_context.rb#10
  def after_initialize; end

  # source://playwright-ruby-client//lib/playwright/channel_owners/browser_context.rb#376
  def async_update_interception_patterns; end

  # source://playwright-ruby-client//lib/playwright/channel_owners/browser_context.rb#516
  def base_url; end

  # source://playwright-ruby-client//lib/playwright/channel_owners/browser_context.rb#523
  def create_temp_file(filepath); end

  # source://playwright-ruby-client//lib/playwright/channel_owners/browser_context.rb#474
  def effective_close_reason; end

  # source://playwright-ruby-client//lib/playwright/channel_owners/browser_context.rb#512
  def has_record_video_option?; end

  # source://playwright-ruby-client//lib/playwright/channel_owners/browser_context.rb#417
  def inner_close; end

  # source://playwright-ruby-client//lib/playwright/channel_owners/browser_context.rb#102
  def on_background_page(page); end

  # source://playwright-ruby-client//lib/playwright/channel_owners/browser_context.rb#143
  def on_binding(binding_call); end

  # source://playwright-ruby-client//lib/playwright/channel_owners/browser_context.rb#400
  def on_close; end

  # source://playwright-ruby-client//lib/playwright/channel_owners/browser_context.rb#168
  def on_console_message(message); end

  # source://playwright-ruby-client//lib/playwright/channel_owners/browser_context.rb#175
  ...
  # source://playwright-ruby-client//lib/playwright/channel_owners/browser_context.rb#190
  def on_page_error(error, page); end

  # source://playwright-ruby-client//lib/playwright/channel_owners/browser_context.rb#197
  def on_request(request, page); end

  # source://playwright-ruby-client//lib/playwright/channel_owners/browser_context.rb#150
  def on_request_failed(request, response_end_timing, failure_text, page); end

  # source://playwright-ruby-client//lib/playwright/channel_owners/browser_context.rb#157
  ...
  # source://playwright-ruby-client//lib/playwright/channel_owners/browser_context.rb#495
  def remove_page(page); end

  # source://playwright-ruby-client//lib/playwright/channel_owners/browser_context.rb#503
  def remove_service_worker(worker); end

  # source://playwright-ruby-client//lib/playwright/channel_owners/browser_context.rb#381
  def update_interception_patterns; end

  # source://playwright-ruby-client//lib/playwright/channel_owners/browser_context.rb#85
...
class Playwright::ChannelOwners::ElementHandle < ::Playwright::ChannelOwners::JSHandle
  ...
  # source://playwright-ruby-client//lib/playwright/channel_owners/element_handle.rb#344
  def eval_on_selector(selector, pageFunction, arg: T.unsafe(nil)); end

  # source://playwright-ruby-client//lib/playwright/channel_owners/element_handle.rb#348
  ...
  # source://playwright-ruby-client//lib/playwright/channel_owners/element_handle.rb#333
  def query_selector(selector); end

  # source://playwright-ruby-client//lib/playwright/channel_owners/element_handle.rb#338
  def query_selector_all(selector); end

  # source://playwright-ruby-client//lib/playwright/channel_owners/element_handle.rb#295
  def screenshot(animations: T.unsafe(nil), caret: T.unsafe(nil), mask: T.unsafe(nil), maskColor: T.unsafe(nil), omitBackground: T.unsafe(nil), path: T.unsafe(nil), quality: T.unsafe(nil), scale: T.unsafe(nil), timeout: T.unsafe(nil), type: T.unsafe(nil)); end
  ...
  # source://playwright-ruby-client//lib/playwright/channel_owners/element_handle.rb#352
...
class Playwright::ChannelOwners::Frame < ::Playwright::ChannelOwner
  ...
  # source://playwright-ruby-client//lib/playwright/channel_owners/frame.rb#289
  def add_script_tag(content: T.unsafe(nil), path: T.unsafe(nil), type: T.unsafe(nil), url: T.unsafe(nil)); end

  # source://playwright-ruby-client//lib/playwright/channel_owners/frame.rb#302
  def add_style_tag(content: T.unsafe(nil), path: T.unsafe(nil), url: T.unsafe(nil)); end

  # source://playwright-ruby-client//lib/playwright/channel_owners/frame.rb#600
  ...
  # source://playwright-ruby-client//lib/playwright/channel_owners/frame.rb#281
  def child_frames; end

  # source://playwright-ruby-client//lib/playwright/channel_owners/frame.rb#314
  ...
  # source://playwright-ruby-client//lib/playwright/channel_owners/frame.rb#257
  def content; end

  # source://playwright-ruby-client//lib/playwright/channel_owners/frame.rb#372
  ...
  # source://playwright-ruby-client//lib/playwright/channel_owners/frame.rb#285
  def detached?; end

  # source://playwright-ruby-client//lib/playwright/channel_owners/frame.rb#211
  ...
  # source://playwright-ruby-client//lib/playwright/channel_owners/frame.rb#345
  ...
  # source://playwright-ruby-client//lib/playwright/channel_owners/frame.rb#216
  ...
  # source://playwright-ruby-client//lib/playwright/channel_owners/frame.rb#249
  def eval_on_selector(selector, pageFunction, arg: T.unsafe(nil), strict: T.unsafe(nil)); end

  # source://playwright-ruby-client//lib/playwright/channel_owners/frame.rb#253
  def eval_on_selector_all(selector, pageFunction, arg: T.unsafe(nil)); end

  # source://playwright-ruby-client//lib/playwright/channel_owners/frame.rb#176
  def evaluate(pageFunction, arg: T.unsafe(nil)); end

  # source://playwright-ruby-client//lib/playwright/channel_owners/frame.rb#180
  ...
  # source://playwright-ruby-client//lib/playwright/channel_owners/frame.rb#425
  def fill(selector, value, force: T.unsafe(nil), noWaitAfter: T.unsafe(nil), strict: T.unsafe(nil), timeout: T.unsafe(nil)); end

  # source://playwright-ruby-client//lib/playwright/channel_owners/frame.rb#465
  def focus(selector, strict: T.unsafe(nil), timeout: T.unsafe(nil)); end

  # source://playwright-ruby-client//lib/playwright/channel_owners/frame.rb#171
  def frame_element; end

  # source://playwright-ruby-client//lib/playwright/channel_owners/frame.rb#461
  def frame_locator(selector); end

  # source://playwright-ruby-client//lib/playwright/channel_owners/frame.rb#486
  ...
  # source://playwright-ruby-client//lib/playwright/channel_owners/frame.rb#673
  def highlight(selector); end

  # source://playwright-ruby-client//lib/playwright/channel_owners/frame.rb#496
  ...
  # source://playwright-ruby-client//lib/playwright/channel_owners/frame.rb#481
  def inner_html(selector, strict: T.unsafe(nil), timeout: T.unsafe(nil)); end

  # source://playwright-ruby-client//lib/playwright/channel_owners/frame.rb#476
  def inner_text(selector, strict: T.unsafe(nil), timeout: T.unsafe(nil)); end

  # source://playwright-ruby-client//lib/playwright/channel_owners/frame.rb#540
  def input_value(selector, strict: T.unsafe(nil), timeout: T.unsafe(nil)); end

  # source://playwright-ruby-client//lib/playwright/channel_owners/frame.rb#445
  def locator(selector, has: T.unsafe(nil), hasNot: T.unsafe(nil), hasNotText: T.unsafe(nil), hasText: T.unsafe(nil)); end

  # source://playwright-ruby-client//lib/playwright/channel_owners/frame.rb#273
  def name; end
  ...
  # source://playwright-ruby-client//lib/playwright/channel_owners/frame.rb#579
  def press(selector, key, delay: T.unsafe(nil), noWaitAfter: T.unsafe(nil), strict: T.unsafe(nil), timeout: T.unsafe(nil)); end

  # source://playwright-ruby-client//lib/playwright/channel_owners/frame.rb#184
  def query_selector(selector, strict: T.unsafe(nil)); end

  # source://playwright-ruby-client//lib/playwright/channel_owners/frame.rb#193
  def query_selector_all(selector); end

  # source://playwright-ruby-client//lib/playwright/channel_owners/frame.rb#520
  ...
  # source://playwright-ruby-client//lib/playwright/channel_owners/frame.rb#646
  def set_checked(selector, checked, **options); end

  # source://playwright-ruby-client//lib/playwright/channel_owners/frame.rb#261
  def set_content(html, timeout: T.unsafe(nil), waitUntil: T.unsafe(nil)); end

  # source://playwright-ruby-client//lib/playwright/channel_owners/frame.rb#545
  def set_input_files(selector, files, noWaitAfter: T.unsafe(nil), strict: T.unsafe(nil), timeout: T.unsafe(nil)); end

  # source://playwright-ruby-client//lib/playwright/channel_owners/frame.rb#401
  ...
  # source://playwright-ruby-client//lib/playwright/channel_owners/frame.rb#471
  def text_content(selector, strict: T.unsafe(nil), timeout: T.unsafe(nil)); end

  # source://playwright-ruby-client//lib/playwright/channel_owners/frame.rb#669
  def title; end

  # source://playwright-ruby-client//lib/playwright/channel_owners/frame.rb#558
  def type(selector, text, delay: T.unsafe(nil), noWaitAfter: T.unsafe(nil), strict: T.unsafe(nil), timeout: T.unsafe(nil)); end

  # source://playwright-ruby-client//lib/playwright/channel_owners/frame.rb#623
  ...
  # source://playwright-ruby-client//lib/playwright/channel_owners/frame.rb#277
  def url; end
  ...
  # source://playwright-ruby-client//lib/playwright/channel_owners/frame.rb#654
  ...
  # source://playwright-ruby-client//lib/playwright/channel_owners/frame.rb#685
  ...
  # source://playwright-ruby-client//lib/playwright/channel_owners/frame.rb#679
...
class Playwright::ChannelOwners::JSHandle < ::Playwright::ChannelOwner
  # source://playwright-ruby-client//lib/playwright/channel_owners/js_handle.rb#34
  def as_element; end

  # source://playwright-ruby-client//lib/playwright/channel_owners/js_handle.rb#38
  def dispose; end

  # source://playwright-ruby-client//lib/playwright/channel_owners/js_handle.rb#16
  def evaluate(pageFunction, arg: T.unsafe(nil)); end

  # source://playwright-ruby-client//lib/playwright/channel_owners/js_handle.rb#20
  def evaluate_handle(pageFunction, arg: T.unsafe(nil)); end

  # source://playwright-ruby-client//lib/playwright/channel_owners/js_handle.rb#24
  def get_properties; end

  # source://playwright-ruby-client//lib/playwright/channel_owners/js_handle.rb#29
  def get_property(name); end

  # source://playwright-ruby-client//lib/playwright/channel_owners/js_handle.rb#42
  def json_value; end

  # source://playwright-ruby-client//lib/playwright/channel_owners/js_handle.rb#8
  def to_s; end

  private

  # source://playwright-ruby-client//lib/playwright/channel_owners/js_handle.rb#3
  def after_initialize; end

  # source://playwright-ruby-client//lib/playwright/channel_owners/js_handle.rb#12
...
class Playwright::ChannelOwners::Page < ::Playwright::ChannelOwner
  ...
  # source://playwright-ruby-client//lib/playwright/channel_owners/page.rb#80
  def accessibility; end

  # source://playwright-ruby-client//lib/playwright/channel_owners/page.rb#397
  def add_init_script(path: T.unsafe(nil), script: T.unsafe(nil)); end

  # source://playwright-ruby-client//lib/playwright/channel_owners/page.rb#294
  def add_script_tag(content: T.unsafe(nil), path: T.unsafe(nil), type: T.unsafe(nil), url: T.unsafe(nil)); end

  # source://playwright-ruby-client//lib/playwright/channel_owners/page.rb#298
  def add_style_tag(content: T.unsafe(nil), path: T.unsafe(nil), url: T.unsafe(nil)); end

  # source://playwright-ruby-client//lib/playwright/channel_owners/page.rb#392
  def bring_to_front; end

  # source://playwright-ruby-client//lib/playwright/channel_owners/page.rb#753
  def check(selector, force: T.unsafe(nil), noWaitAfter: T.unsafe(nil), position: T.unsafe(nil), strict: T.unsafe(nil), timeout: T.unsafe(nil), trial: T.unsafe(nil)); end

  # source://playwright-ruby-client//lib/playwright/channel_owners/page.rb#250
  def checked?(selector, strict: T.unsafe(nil), timeout: T.unsafe(nil)); end

  # source://playwright-ruby-client//lib/playwright/channel_owners/page.rb#511
  def click(selector, button: T.unsafe(nil), clickCount: T.unsafe(nil), delay: T.unsafe(nil), force: T.unsafe(nil), modifiers: T.unsafe(nil), noWaitAfter: T.unsafe(nil), position: T.unsafe(nil), strict: T.unsafe(nil), timeout: T.unsafe(nil), trial: T.unsafe(nil)); end

  # source://playwright-ruby-client//lib/playwright/channel_owners/page.rb#494
  def close(runBeforeUnload: T.unsafe(nil), reason: T.unsafe(nil)); end

  # source://playwright-ruby-client//lib/playwright/channel_owners/page.rb#507
  def closed?; end

  # source://playwright-ruby-client//lib/playwright/channel_owners/page.rb#325
  def content; end

  # source://playwright-ruby-client//lib/playwright/channel_owners/page.rb#195
  def context; end

  # source://playwright-ruby-client//lib/playwright/channel_owners/page.rb#562
  def dblclick(selector, button: T.unsafe(nil), delay: T.unsafe(nil), force: T.unsafe(nil), modifiers: T.unsafe(nil), noWaitAfter: T.unsafe(nil), position: T.unsafe(nil), strict: T.unsafe(nil), timeout: T.unsafe(nil), trial: T.unsafe(nil)); end

  # source://playwright-ruby-client//lib/playwright/channel_owners/page.rb#254
  def disabled?(selector, strict: T.unsafe(nil), timeout: T.unsafe(nil)); end

  # source://playwright-ruby-client//lib/playwright/channel_owners/page.rb#274
  def dispatch_event(selector, type, eventInit: T.unsafe(nil), strict: T.unsafe(nil), timeout: T.unsafe(nil)); end

  # source://playwright-ruby-client//lib/playwright/channel_owners/page.rb#539
  def drag_and_drop(source, target, force: T.unsafe(nil), noWaitAfter: T.unsafe(nil), sourcePosition: T.unsafe(nil), strict: T.unsafe(nil), targetPosition: T.unsafe(nil), timeout: T.unsafe(nil), trial: T.unsafe(nil)); end

  # source://playwright-ruby-client//lib/playwright/channel_owners/page.rb#258
  def editable?(selector, strict: T.unsafe(nil), timeout: T.unsafe(nil)); end

  # source://playwright-ruby-client//lib/playwright/channel_owners/page.rb#366
  def emulate_media(colorScheme: T.unsafe(nil), forcedColors: T.unsafe(nil), media: T.unsafe(nil), reducedMotion: T.unsafe(nil)); end

  # source://playwright-ruby-client//lib/playwright/channel_owners/page.rb#262
  def enabled?(selector, strict: T.unsafe(nil), timeout: T.unsafe(nil)); end

  # source://playwright-ruby-client//lib/playwright/channel_owners/page.rb#286
  def eval_on_selector(selector, pageFunction, arg: T.unsafe(nil), strict: T.unsafe(nil)); end

  # source://playwright-ruby-client//lib/playwright/channel_owners/page.rb#290
  def eval_on_selector_all(selector, pageFunction, arg: T.unsafe(nil)); end

  # source://playwright-ruby-client//lib/playwright/channel_owners/page.rb#278
  def evaluate(pageFunction, arg: T.unsafe(nil)); end

  # source://playwright-ruby-client//lib/playwright/channel_owners/page.rb#282
  def evaluate_handle(pageFunction, arg: T.unsafe(nil)); end

  # source://playwright-ruby-client//lib/playwright/channel_owners/page.rb#924
  def expect_console_message(predicate: T.unsafe(nil), timeout: T.unsafe(nil), &block); end

  # source://playwright-ruby-client//lib/playwright/channel_owners/page.rb#928
  def expect_download(predicate: T.unsafe(nil), timeout: T.unsafe(nil), &block); end

  # source://playwright-ruby-client//lib/playwright/channel_owners/page.rb#905
  def expect_event(event, predicate: T.unsafe(nil), timeout: T.unsafe(nil), &block); end

  # source://playwright-ruby-client//lib/playwright/channel_owners/page.rb#932
  def expect_file_chooser(predicate: T.unsafe(nil), timeout: T.unsafe(nil), &block); end

  # source://playwright-ruby-client//lib/playwright/channel_owners/page.rb#936
  def expect_navigation(timeout: T.unsafe(nil), url: T.unsafe(nil), waitUntil: T.unsafe(nil), &block); end

  # source://playwright-ruby-client//lib/playwright/channel_owners/page.rb#944
  def expect_popup(predicate: T.unsafe(nil), timeout: T.unsafe(nil), &block); end

  # source://playwright-ruby-client//lib/playwright/channel_owners/page.rb#948
  ...
  # source://playwright-ruby-client//lib/playwright/channel_owners/page.rb#967
  ...
  # source://playwright-ruby-client//lib/playwright/channel_owners/page.rb#986
  def expect_worker(predicate: T.unsafe(nil), timeout: T.unsafe(nil), &block); end

  # source://playwright-ruby-client//lib/playwright/channel_owners/page.rb#307
  def expose_binding(name, callback, handle: T.unsafe(nil)); end

  # source://playwright-ruby-client//lib/playwright/channel_owners/page.rb#302
  def expose_function(name, callback); end

  # source://playwright-ruby-client//lib/playwright/channel_owners/page.rb#608
  def fill(selector, value, force: T.unsafe(nil), noWaitAfter: T.unsafe(nil), strict: T.unsafe(nil), timeout: T.unsafe(nil)); end

  # source://playwright-ruby-client//lib/playwright/channel_owners/page.rb#642
  def focus(selector, strict: T.unsafe(nil), timeout: T.unsafe(nil)); end

  # source://playwright-ruby-client//lib/playwright/channel_owners/page.rb#213
  def frame(name: T.unsafe(nil), url: T.unsafe(nil)); end

  # source://playwright-ruby-client//lib/playwright/channel_owners/page.rb#638
  def frame_locator(selector); end

  # source://playwright-ruby-client//lib/playwright/channel_owners/page.rb#224
  def frames; end

  # source://playwright-ruby-client//lib/playwright/channel_owners/page.rb#658
  def get_attribute(selector, name, strict: T.unsafe(nil), timeout: T.unsafe(nil)); end

  # source://playwright-ruby-client//lib/playwright/channel_owners/page.rb#354
  ...
  # source://playwright-ruby-client//lib/playwright/channel_owners/page.rb#333
  def goto(url, timeout: T.unsafe(nil), waitUntil: T.unsafe(nil), referer: T.unsafe(nil)); end

  # source://playwright-ruby-client//lib/playwright/channel_owners/page.rb#1012
  def guid; end

  # source://playwright-ruby-client//lib/playwright/channel_owners/page.rb#266
  def hidden?(selector, strict: T.unsafe(nil), timeout: T.unsafe(nil)); end

  # source://playwright-ruby-client//lib/playwright/channel_owners/page.rb#662
  def hover(selector, force: T.unsafe(nil), modifiers: T.unsafe(nil), noWaitAfter: T.unsafe(nil), position: T.unsafe(nil), strict: T.unsafe(nil), timeout: T.unsafe(nil), trial: T.unsafe(nil)); end

  # source://playwright-ruby-client//lib/playwright/channel_owners/page.rb#654
  def inner_html(selector, strict: T.unsafe(nil), timeout: T.unsafe(nil)); end

  # source://playwright-ruby-client//lib/playwright/channel_owners/page.rb#650
  def inner_text(selector, strict: T.unsafe(nil), timeout: T.unsafe(nil)); end

  # source://playwright-ruby-client//lib/playwright/channel_owners/page.rb#706
  def input_value(selector, strict: T.unsafe(nil), timeout: T.unsafe(nil)); end

  # source://playwright-ruby-client//lib/playwright/channel_owners/page.rb#80
  def keyboard; end

  # source://playwright-ruby-client//lib/playwright/channel_owners/page.rb#624
  def locator(selector, has: T.unsafe(nil), hasNot: T.unsafe(nil), hasNotText: T.unsafe(nil), hasText: T.unsafe(nil)); end
  ...
  # source://playwright-ruby-client//lib/playwright/channel_owners/page.rb#199
  def opener; end

  # source://playwright-ruby-client//lib/playwright/channel_owners/page.rb#9
  def owned_context=(_arg0); end

  # source://playwright-ruby-client//lib/playwright/channel_owners/page.rb#815
  def pause; end

  # source://playwright-ruby-client//lib/playwright/channel_owners/page.rb#819
  def pdf(displayHeaderFooter: T.unsafe(nil), footerTemplate: T.unsafe(nil), format: T.unsafe(nil), headerTemplate: T.unsafe(nil), height: T.unsafe(nil), landscape: T.unsafe(nil), margin: T.unsafe(nil), pageRanges: T.unsafe(nil), path: T.unsafe(nil), preferCSSPageSize: T.unsafe(nil), printBackground: T.unsafe(nil), scale: T.unsafe(nil), width: T.unsafe(nil)); end

  # source://playwright-ruby-client//lib/playwright/channel_owners/page.rb#736
  def press(selector, key, delay: T.unsafe(nil), noWaitAfter: T.unsafe(nil), strict: T.unsafe(nil), timeout: T.unsafe(nil)); end

  # source://playwright-ruby-client//lib/playwright/channel_owners/page.rb#238
  def query_selector(selector, strict: T.unsafe(nil)); end

  # source://playwright-ruby-client//lib/playwright/channel_owners/page.rb#242
  def query_selector_all(selector); end

  # source://playwright-ruby-client//lib/playwright/channel_owners/page.rb#337
  def reload(timeout: T.unsafe(nil), waitUntil: T.unsafe(nil)); end

  # source://playwright-ruby-client//lib/playwright/channel_owners/page.rb#811
  def request; end

  # source://playwright-ruby-client//lib/playwright/channel_owners/page.rb#411
  def route(url, handler, times: T.unsafe(nil)); end

  # source://playwright-ruby-client//lib/playwright/channel_owners/page.rb#424
  ...
  # source://playwright-ruby-client//lib/playwright/channel_owners/page.rb#449
  def screenshot(animations: T.unsafe(nil), caret: T.unsafe(nil), clip: T.unsafe(nil), fullPage: T.unsafe(nil), mask: T.unsafe(nil), maskColor: T.unsafe(nil), omitBackground: T.unsafe(nil), path: T.unsafe(nil), quality: T.unsafe(nil), scale: T.unsafe(nil), timeout: T.unsafe(nil), type: T.unsafe(nil)); end

  # source://playwright-ruby-client//lib/playwright/channel_owners/page.rb#683
  def select_option(selector, element: T.unsafe(nil), index: T.unsafe(nil), value: T.unsafe(nil), label: T.unsafe(nil), force: T.unsafe(nil), noWaitAfter: T.unsafe(nil), strict: T.unsafe(nil), timeout: T.unsafe(nil)); end

  # source://playwright-ruby-client//lib/playwright/channel_owners/page.rb#791
  def set_checked(selector, checked, **options); end

  # source://playwright-ruby-client//lib/playwright/channel_owners/page.rb#329
  def set_content(html, timeout: T.unsafe(nil), waitUntil: T.unsafe(nil)); end

  # source://playwright-ruby-client//lib/playwright/channel_owners/page.rb#228
  def set_default_navigation_timeout(timeout); end

  # source://playwright-ruby-client//lib/playwright/channel_owners/page.rb#233
  def set_default_timeout(timeout); end

  # source://playwright-ruby-client//lib/playwright/channel_owners/page.rb#316
  def set_extra_http_headers(headers); end

  # source://playwright-ruby-client//lib/playwright/channel_owners/page.rb#710
  def set_input_files(selector, files, noWaitAfter: T.unsafe(nil), strict: T.unsafe(nil), timeout: T.unsafe(nil)); end

  # source://playwright-ruby-client//lib/playwright/channel_owners/page.rb#386
  def set_viewport_size(viewportSize); end

  # source://playwright-ruby-client//lib/playwright/channel_owners/page.rb#876
  def start_css_coverage(resetOnNavigation: T.unsafe(nil), reportAnonymousScripts: T.unsafe(nil)); end

  # source://playwright-ruby-client//lib/playwright/channel_owners/page.rb#863
  def start_js_coverage(resetOnNavigation: T.unsafe(nil), reportAnonymousScripts: T.unsafe(nil)); end

  # source://playwright-ruby-client//lib/playwright/channel_owners/page.rb#884
  def stop_css_coverage; end

  # source://playwright-ruby-client//lib/playwright/channel_owners/page.rb#872
  def stop_js_coverage; end

  # source://playwright-ruby-client//lib/playwright/channel_owners/page.rb#587
  def tap_point(selector, force: T.unsafe(nil), modifiers: T.unsafe(nil), noWaitAfter: T.unsafe(nil), position: T.unsafe(nil), strict: T.unsafe(nil), timeout: T.unsafe(nil), trial: T.unsafe(nil)); end

  # source://playwright-ruby-client//lib/playwright/channel_owners/page.rb#646
  def text_content(selector, strict: T.unsafe(nil), timeout: T.unsafe(nil)); end

  # source://playwright-ruby-client//lib/playwright/channel_owners/page.rb#490
  def title; end

  # source://playwright-ruby-client//lib/playwright/channel_owners/page.rb#80
  def touchscreen; end

  # source://playwright-ruby-client//lib/playwright/channel_owners/page.rb#719
  def type(selector, text, delay: T.unsafe(nil), noWaitAfter: T.unsafe(nil), strict: T.unsafe(nil), timeout: T.unsafe(nil)); end

  # source://playwright-ruby-client//lib/playwright/channel_owners/page.rb#772
  def uncheck(selector, force: T.unsafe(nil), noWaitAfter: T.unsafe(nil), position: T.unsafe(nil), strict: T.unsafe(nil), timeout: T.unsafe(nil), trial: T.unsafe(nil)); end

  # source://playwright-ruby-client//lib/playwright/channel_owners/page.rb#417
  def unroute(url, handler: T.unsafe(nil)); end

  # source://playwright-ruby-client//lib/playwright/channel_owners/page.rb#321
  def url; end

  # source://playwright-ruby-client//lib/playwright/channel_owners/page.rb#858
  def video; end

  # source://playwright-ruby-client//lib/playwright/channel_owners/page.rb#80
  def viewport_size; end

  # source://playwright-ruby-client//lib/playwright/channel_owners/page.rb#270
  def visible?(selector, strict: T.unsafe(nil), timeout: T.unsafe(nil)); end

  # source://playwright-ruby-client//lib/playwright/channel_owners/page.rb#803
  def wait_for_function(pageFunction, arg: T.unsafe(nil), polling: T.unsafe(nil), timeout: T.unsafe(nil)); end

  # source://playwright-ruby-client//lib/playwright/channel_owners/page.rb#346
  def wait_for_load_state(state: T.unsafe(nil), timeout: T.unsafe(nil)); end

  # source://playwright-ruby-client//lib/playwright/channel_owners/page.rb#246
  def wait_for_selector(selector, state: T.unsafe(nil), strict: T.unsafe(nil), timeout: T.unsafe(nil)); end

  # source://playwright-ruby-client//lib/playwright/channel_owners/page.rb#799
  def wait_for_timeout(timeout); end

  # source://playwright-ruby-client//lib/playwright/channel_owners/page.rb#350
  def wait_for_url(url, timeout: T.unsafe(nil), waitUntil: T.unsafe(nil)); end

  # source://playwright-ruby-client//lib/playwright/channel_owners/page.rb#807
  def workers; end

  private

  # source://playwright-ruby-client//lib/playwright/channel_owners/page.rb#12
  def after_initialize; end

  # source://playwright-ruby-client//lib/playwright/channel_owners/page.rb#439
  def async_update_interception_patterns; end

  # source://playwright-ruby-client//lib/playwright/channel_owners/page.rb#900
  ...
  # source://playwright-ruby-client//lib/playwright/channel_owners/page.rb#996
  def has_bindings?(name); end

  # source://playwright-ruby-client//lib/playwright/channel_owners/page.rb#378
  def no_override_if_null(target); end

  # source://playwright-ruby-client//lib/playwright/channel_owners/page.rb#134
  def on_binding(binding_call); end

  # source://playwright-ruby-client//lib/playwright/channel_owners/page.rb#148
  def on_close; end

  # source://playwright-ruby-client//lib/playwright/channel_owners/page.rb#158
  def on_crash; end

  # source://playwright-ruby-client//lib/playwright/channel_owners/page.rb#165
  def on_download(params); end

  # source://playwright-ruby-client//lib/playwright/channel_owners/page.rb#88
  def on_frame_attached(frame); end

  # source://playwright-ruby-client//lib/playwright/channel_owners/page.rb#94
  def on_frame_detached(frame); end

  # source://playwright-ruby-client//lib/playwright/channel_owners/page.rb#100
  def on_route(route); end

  # source://playwright-ruby-client//lib/playwright/channel_owners/page.rb#176
  def on_video(params); end

  # source://playwright-ruby-client//lib/playwright/channel_owners/page.rb#142
  ...
  # source://playwright-ruby-client//lib/playwright/channel_owners/page.rb#991
  def timeout_settings; end

  # source://playwright-ruby-client//lib/playwright/channel_owners/page.rb#444
  def update_interception_patterns; end
end
...
class Playwright::ChannelOwners::Route < ::Playwright::ChannelOwner
  ...
  # source://playwright-ruby-client//lib/playwright/channel_owners/route.rb#126
  ...
  def fetch(headers: T.unsafe(nil), method: T.unsafe(nil), postData: T.unsafe(nil), url: T.unsafe(nil), maxRedirects: T.unsafe(nil), timeout: T.unsafe(nil)); end
  ...
  # source://playwright-ruby-client//lib/playwright/channel_owners/route.rb#164
  ...
  # source://playwright-ruby-client//lib/playwright/channel_owners/route.rb#140
  ...
  # source://playwright-ruby-client//lib/playwright/channel_owners/route.rb#171
  ...
  # source://playwright-ruby-client//lib/playwright/channel_owners/route.rb#176
  def update_context(context); end
end

# source://playwright-ruby-client//lib/playwright/channel_owners/selectors.rb#0
...
class Playwright::Connection
  ...
  # source://playwright-ruby-client//lib/playwright/connection.rb#39
  def async_run; end

  # source://playwright-ruby-client//lib/playwright/connection.rb#72
  def async_send_message_to_server(guid, method, params, metadata: T.unsafe(nil)); end

  # source://playwright-ruby-client//lib/playwright/connection.rb#48
  def cleanup(cause: T.unsafe(nil)); end

  # source://playwright-ruby-client//lib/playwright/connection.rb#56
  def initialize_playwright; end

  # Returns the value of attribute local_utils.
  #
  # source://playwright-ruby-client//lib/playwright/connection.rb#29
  def local_utils; end

  # source://playwright-ruby-client//lib/playwright/connection.rb#31
  def mark_as_remote; end

  # @return [Boolean]
  #
  # source://playwright-ruby-client//lib/playwright/connection.rb#35
  def remote?; end

  # source://playwright-ruby-client//lib/playwright/connection.rb#115
  def send_message_to_server(guid, method, params, metadata: T.unsafe(nil)); end

  # source://playwright-ruby-client//lib/playwright/connection.rb#64
  def set_in_tracing(value); end

  # source://playwright-ruby-client//lib/playwright/connection.rb#43
  def stop; end
  ...
  # @return [Playwright::ChannelOwner|nil]
  #
  # source://playwright-ruby-client//lib/playwright/connection.rb#249
  ...
  # @param guid [String]
  #
  # source://playwright-ruby-client//lib/playwright/connection.rb#140
  def delete_object_from_channel_owner(guid); end

  # source://playwright-ruby-client//lib/playwright/connection.rb#144
  def dispatch(msg); end

  # source://playwright-ruby-client//lib/playwright/connection.rb#207
  def replace_channels_with_guids(payload); end

  # source://playwright-ruby-client//lib/playwright/connection.rb#227
  ...
  # ````
  #
  # source://playwright-ruby-client//lib/playwright/connection.rb#126
...
# source://playwright-ruby-client//lib/playwright/channel_owners/browser_context.rb#451
...
class Playwright::DifferentFrameError < ::StandardError
  # source://playwright-ruby-client//lib/playwright/locator_impl.rb#50
...
class Playwright::ElementHandle < ::Playwright::JSHandle
  ...
  #
  # source://playwright-ruby-client//lib/playwright_api/element_handle.rb#243
  def [](name); end
  ...
  #
  # source://playwright-ruby-client//lib/playwright_api/element_handle.rb#76
  def check(force: T.unsafe(nil), noWaitAfter: T.unsafe(nil), position: T.unsafe(nil), timeout: T.unsafe(nil), trial: T.unsafe(nil)); end
  ...
  # `TimeoutError`. Passing zero timeout disables this.
  #
  # source://playwright-ruby-client//lib/playwright_api/element_handle.rb#452
  ...
  # @return [Boolean]
  #
  # source://playwright-ruby-client//lib/playwright_api/element_handle.rb#291
  def checked?; end
  ...
  # `TimeoutError`. Passing zero timeout disables this.
  #
  # source://playwright-ruby-client//lib/playwright_api/element_handle.rb#96
  def click(button: T.unsafe(nil), clickCount: T.unsafe(nil), delay: T.unsafe(nil), force: T.unsafe(nil), modifiers: T.unsafe(nil), noWaitAfter: T.unsafe(nil), position: T.unsafe(nil), timeout: T.unsafe(nil), trial: T.unsafe(nil)); end

  # Returns the content frame for element handles referencing iframe nodes, or `null` otherwise
  #
  # source://playwright-ruby-client//lib/playwright_api/element_handle.rb#111
  def content_frame; end
  ...
  #
  # source://playwright-ruby-client//lib/playwright_api/element_handle.rb#128
  def dblclick(button: T.unsafe(nil), delay: T.unsafe(nil), force: T.unsafe(nil), modifiers: T.unsafe(nil), noWaitAfter: T.unsafe(nil), position: T.unsafe(nil), timeout: T.unsafe(nil), trial: T.unsafe(nil)); end
  ...
  # @return [Boolean]
  #
  # source://playwright-ruby-client//lib/playwright_api/element_handle.rb#297
  def disabled?; end
  ...
  # ```
  #
  # source://playwright-ruby-client//lib/playwright_api/element_handle.rb#175
  def dispatch_event(type, eventInit: T.unsafe(nil)); end
  ...
  # @return [Boolean]
  #
  # source://playwright-ruby-client//lib/playwright_api/element_handle.rb#303
  def editable?; end
  ...
  # @return [Boolean]
  #
  # source://playwright-ruby-client//lib/playwright_api/element_handle.rb#309
  def enabled?; end
  ...
  # ```
  #
  # source://playwright-ruby-client//lib/playwright_api/element_handle.rb#195
  ...
  # ```
  #
  # source://playwright-ruby-client//lib/playwright_api/element_handle.rb#221
  ...
  #
  # source://playwright-ruby-client//lib/playwright_api/element_handle.rb#231
  def fill(value, force: T.unsafe(nil), noWaitAfter: T.unsafe(nil), timeout: T.unsafe(nil)); end

  # Calls [focus](https://developer.mozilla.org/en-US/docs/Web/API/HTMLElement/focus) on the element.
  #
  # source://playwright-ruby-client//lib/playwright_api/element_handle.rb#237
  def focus; end
  ...
  # @return [Boolean]
  #
  # source://playwright-ruby-client//lib/playwright_api/element_handle.rb#315
  def hidden?; end
  ...
  # `TimeoutError`. Passing zero timeout disables this.
  #
  # source://playwright-ruby-client//lib/playwright_api/element_handle.rb#259
  def hover(force: T.unsafe(nil), modifiers: T.unsafe(nil), noWaitAfter: T.unsafe(nil), position: T.unsafe(nil), timeout: T.unsafe(nil), trial: T.unsafe(nil)); end

  # Returns the `element.innerHTML`.
  #
  # source://playwright-ruby-client//lib/playwright_api/element_handle.rb#271
  def inner_html; end

  # Returns the `element.innerText`.
  #
  # source://playwright-ruby-client//lib/playwright_api/element_handle.rb#277
  def inner_text; end
  ...
  #
  # source://playwright-ruby-client//lib/playwright_api/element_handle.rb#285
  def input_value(timeout: T.unsafe(nil)); end
  ...
  #
  # source://playwright-ruby-client//lib/playwright_api/element_handle.rb#327
  def owner_frame; end
  ...
  #
  # source://playwright-ruby-client//lib/playwright_api/element_handle.rb#351
  def press(key, delay: T.unsafe(nil), noWaitAfter: T.unsafe(nil), timeout: T.unsafe(nil)); end
  ...
  # returns `null`.
  #
  # source://playwright-ruby-client//lib/playwright_api/element_handle.rb#358
  def query_selector(selector); end
  ...
  # returns empty array.
  #
  # source://playwright-ruby-client//lib/playwright_api/element_handle.rb#365
  def query_selector_all(selector); end
  ...
  #
  # source://playwright-ruby-client//lib/playwright_api/element_handle.rb#376
  def screenshot(animations: T.unsafe(nil), caret: T.unsafe(nil), mask: T.unsafe(nil), maskColor: T.unsafe(nil), omitBackground: T.unsafe(nil), path: T.unsafe(nil), quality: T.unsafe(nil), scale: T.unsafe(nil), timeout: T.unsafe(nil), type: T.unsafe(nil)); end
  ...
  #
  # source://playwright-ruby-client//lib/playwright_api/element_handle.rb#487
  def tap_point(force: T.unsafe(nil), modifiers: T.unsafe(nil), noWaitAfter: T.unsafe(nil), position: T.unsafe(nil), timeout: T.unsafe(nil), trial: T.unsafe(nil)); end

  # Returns the `node.textContent`.
  #
  # source://playwright-ruby-client//lib/playwright_api/element_handle.rb#499
  def text_content; end
  ...
  # **Usage**
  #
  # source://playwright-ruby-client//lib/playwright_api/element_handle.rb#509
  def type(text, delay: T.unsafe(nil), noWaitAfter: T.unsafe(nil), timeout: T.unsafe(nil)); end
  ...
  # @return [Boolean]
  #
  # source://playwright-ruby-client//lib/playwright_api/element_handle.rb#321
  def visible?; end
...
module Playwright::EventEmitter
  ...
  # @raise [ArgumentError]
  #
  # source://playwright-ruby-client//lib/playwright/event_emitter.rb#77
  def off(event, callback); end
  ...
  # @raise [ArgumentError]
  #
  # source://playwright-ruby-client//lib/playwright/event_emitter.rb#58
  def on(event, callback); end
  ...
  # @raise [ArgumentError]
  #
  # source://playwright-ruby-client//lib/playwright/event_emitter.rb#67
  def once(event, callback); end

  private

  # source://playwright-ruby-client//lib/playwright/event_emitter.rb#47
  def listener_count(event); end

  # can be overriden
  #
  # source://playwright-ruby-client//lib/playwright/event_emitter.rb#52
  def perform_event_emitter_callback(event, callback, args); end
end
...
class Playwright::Frame < ::Playwright::PlaywrightApi
  ...
  # `TimeoutError`. Passing zero timeout disables this.
  #
  # source://playwright-ruby-client//lib/playwright_api/frame.rb#63
  def check(selector, force: T.unsafe(nil), noWaitAfter: T.unsafe(nil), position: T.unsafe(nil), strict: T.unsafe(nil), timeout: T.unsafe(nil), trial: T.unsafe(nil)); end
  ...
  # @return [Boolean]
  #
  # source://playwright-ruby-client//lib/playwright_api/frame.rb#623
  def checked?(selector, strict: T.unsafe(nil), timeout: T.unsafe(nil)); end

  # source://playwright-ruby-client//lib/playwright_api/frame.rb#74
  def child_frames; end
  ...
  # `TimeoutError`. Passing zero timeout disables this.
  #
  # source://playwright-ruby-client//lib/playwright_api/frame.rb#88
  def click(selector, button: T.unsafe(nil), clickCount: T.unsafe(nil), delay: T.unsafe(nil), force: T.unsafe(nil), modifiers: T.unsafe(nil), noWaitAfter: T.unsafe(nil), position: T.unsafe(nil), strict: T.unsafe(nil), timeout: T.unsafe(nil), trial: T.unsafe(nil)); end

  # Gets the full HTML contents of the frame, including the doctype.
  #
  # source://playwright-ruby-client//lib/playwright_api/frame.rb#105
  def content; end
  ...
  #
  # source://playwright-ruby-client//lib/playwright_api/frame.rb#121
  def dblclick(selector, button: T.unsafe(nil), delay: T.unsafe(nil), force: T.unsafe(nil), modifiers: T.unsafe(nil), noWaitAfter: T.unsafe(nil), position: T.unsafe(nil), strict: T.unsafe(nil), timeout: T.unsafe(nil), trial: T.unsafe(nil)); end

  # source://playwright-ruby-client//lib/playwright_api/frame.rb#1041
  ...
  # @return [Boolean]
  #
  # source://playwright-ruby-client//lib/playwright_api/frame.rb#629
  def detached?; end
  ...
  # @return [Boolean]
  #
  # source://playwright-ruby-client//lib/playwright_api/frame.rb#635
  def disabled?(selector, strict: T.unsafe(nil), timeout: T.unsafe(nil)); end
  ...
  # ```
  #
  # source://playwright-ruby-client//lib/playwright_api/frame.rb#170
  def dispatch_event(selector, type, eventInit: T.unsafe(nil), strict: T.unsafe(nil), timeout: T.unsafe(nil)); end

  # source://playwright-ruby-client//lib/playwright_api/frame.rb#179
  def drag_and_drop(source, target, force: T.unsafe(nil), noWaitAfter: T.unsafe(nil), sourcePosition: T.unsafe(nil), strict: T.unsafe(nil), targetPosition: T.unsafe(nil), timeout: T.unsafe(nil), trial: T.unsafe(nil)); end
  ...
  # @return [Boolean]
  #
  # source://playwright-ruby-client//lib/playwright_api/frame.rb#641
  def editable?(selector, strict: T.unsafe(nil), timeout: T.unsafe(nil)); end
  ...
  # @return [Boolean]
  #
  # source://playwright-ruby-client//lib/playwright_api/frame.rb#647
  def enabled?(selector, strict: T.unsafe(nil), timeout: T.unsafe(nil)); end
  ...
  # ```
  #
  # source://playwright-ruby-client//lib/playwright_api/frame.rb#209
  ...
  # ```
  #
  # source://playwright-ruby-client//lib/playwright_api/frame.rb#227
  def eval_on_selector_all(selector, expression, arg: T.unsafe(nil)); end
  ...
  # ```
  #
  # source://playwright-ruby-client//lib/playwright_api/frame.rb#263
  def evaluate(expression, arg: T.unsafe(nil)); end
  ...
  # ```
  #
  # source://playwright-ruby-client//lib/playwright_api/frame.rb#297
  def evaluate_handle(expression, arg: T.unsafe(nil)); end
  ...
  # a navigation.
  #
  # source://playwright-ruby-client//lib/playwright_api/frame.rb#978
  def expect_navigation(timeout: T.unsafe(nil), url: T.unsafe(nil), waitUntil: T.unsafe(nil), &block); end
  ...
  # To send fine-grained keyboard events, use [`method: Locator.pressSequentially`].
  #
  # source://playwright-ruby-client//lib/playwright_api/frame.rb#307
  def fill(selector, value, force: T.unsafe(nil), noWaitAfter: T.unsafe(nil), strict: T.unsafe(nil), timeout: T.unsafe(nil)); end
  ...
  #
  # source://playwright-ruby-client//lib/playwright_api/frame.rb#320
  def focus(selector, strict: T.unsafe(nil), timeout: T.unsafe(nil)); end
  ...
  # ```
  #
  # source://playwright-ruby-client//lib/playwright_api/frame.rb#339
  def frame_element; end
  ...
  # ```
  #
  # source://playwright-ruby-client//lib/playwright_api/frame.rb#355
  def frame_locator(selector); end

  # Returns element attribute value.
  #
  # source://playwright-ruby-client//lib/playwright_api/frame.rb#361
  def get_attribute(selector, name, strict: T.unsafe(nil), timeout: T.unsafe(nil)); end
  ...
  # ```
  #
  # source://playwright-ruby-client//lib/playwright_api/frame.rb#379
  ...
  # ```
  #
  # source://playwright-ruby-client//lib/playwright_api/frame.rb#400
  ...
  # ```
  #
  # source://playwright-ruby-client//lib/playwright_api/frame.rb#420
  ...
  #
  # source://playwright-ruby-client//lib/playwright_api/frame.rb#455
  ...
  #
  # source://playwright-ruby-client//lib/playwright_api/frame.rb#489
  ...
  #
  # source://playwright-ruby-client//lib/playwright_api/frame.rb#531
  ...
  # ```
  #
  # source://playwright-ruby-client//lib/playwright_api/frame.rb#551
  ...
  #
  # source://playwright-ruby-client//lib/playwright_api/frame.rb#575
  ...
  # @return [Boolean]
  #
  # source://playwright-ruby-client//lib/playwright_api/frame.rb#653
  def hidden?(selector, strict: T.unsafe(nil), timeout: T.unsafe(nil)); end

  # source://playwright-ruby-client//lib/playwright_api/frame.rb#1046
  def highlight(selector); end
  ...
  # `TimeoutError`. Passing zero timeout disables this.
  #
  # source://playwright-ruby-client//lib/playwright_api/frame.rb#589
  def hover(selector, force: T.unsafe(nil), modifiers: T.unsafe(nil), noWaitAfter: T.unsafe(nil), position: T.unsafe(nil), strict: T.unsafe(nil), timeout: T.unsafe(nil), trial: T.unsafe(nil)); end

  # Returns `element.innerHTML`.
  #
  # source://playwright-ruby-client//lib/playwright_api/frame.rb#603
  def inner_html(selector, strict: T.unsafe(nil), timeout: T.unsafe(nil)); end

  # Returns `element.innerText`.
  #
  # source://playwright-ruby-client//lib/playwright_api/frame.rb#609
  def inner_text(selector, strict: T.unsafe(nil), timeout: T.unsafe(nil)); end
  ...
  # Throws for non-input elements. However, if the element is inside the `<label>` element that has an associated [control](https://developer.mozilla.org/en-US/docs/Web/API/HTMLLabelElement/control), returns the value of the control.
  #
  # source://playwright-ruby-client//lib/playwright_api/frame.rb#617
  def input_value(selector, strict: T.unsafe(nil), timeout: T.unsafe(nil)); end
  ...
  # [Learn more about locators](../locators.md).
  #
  # source://playwright-ruby-client//lib/playwright_api/frame.rb#670
  def locator(selector, has: T.unsafe(nil), hasNot: T.unsafe(nil), hasNotText: T.unsafe(nil), hasText: T.unsafe(nil)); end
  ...
  #
  # source://playwright-ruby-client//lib/playwright_api/frame.rb#685
  def name; end

  # -- inherited from EventEmitter --
  #
  # source://playwright-ruby-client//lib/playwright_api/frame.rb#1052
  def off(event, callback); end

  # -- inherited from EventEmitter --
  #
  # source://playwright-ruby-client//lib/playwright_api/frame.rb#1064
  def on(event, callback); end

  # -- inherited from EventEmitter --
  #
  # source://playwright-ruby-client//lib/playwright_api/frame.rb#1058
  def once(event, callback); end

  # Returns the page containing this frame.
  #
  # source://playwright-ruby-client//lib/playwright_api/frame.rb#691
  def page; end

  # Parent frame, if any. Detached frames and main frames return `null`.
  #
  # source://playwright-ruby-client//lib/playwright_api/frame.rb#697
  def parent_frame; end
  ...
  # modifier, modifier is pressed and being held while the subsequent key is being pressed.
  #
  # source://playwright-ruby-client//lib/playwright_api/frame.rb#719
  def press(selector, key, delay: T.unsafe(nil), noWaitAfter: T.unsafe(nil), strict: T.unsafe(nil), timeout: T.unsafe(nil)); end
  ...
  # returns `null`.
  #
  # source://playwright-ruby-client//lib/playwright_api/frame.rb#736
  def query_selector(selector, strict: T.unsafe(nil)); end
  ...
  # returns empty array.
  #
  # source://playwright-ruby-client//lib/playwright_api/frame.rb#747
  def query_selector_all(selector); end
  ...
  # ```
  #
  # source://playwright-ruby-client//lib/playwright_api/frame.rb#770
  def select_option(selector, element: T.unsafe(nil), index: T.unsafe(nil), value: T.unsafe(nil), label: T.unsafe(nil), force: T.unsafe(nil), noWaitAfter: T.unsafe(nil), strict: T.unsafe(nil), timeout: T.unsafe(nil)); end
  ...
  # `TimeoutError`. Passing zero timeout disables this.
  #
  # source://playwright-ruby-client//lib/playwright_api/frame.rb#796
  ...
  # [input element](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/input). However, if the element is inside the `<label>` element that has an associated [control](https://developer.mozilla.org/en-US/docs/Web/API/HTMLLabelElement/control), targets the control instead.
  #
  # source://playwright-ruby-client//lib/playwright_api/frame.rb#821
  def set_input_files(selector, files, noWaitAfter: T.unsafe(nil), strict: T.unsafe(nil), timeout: T.unsafe(nil)); end
  ...
  #
  # source://playwright-ruby-client//lib/playwright_api/frame.rb#842
  def tap_point(selector, force: T.unsafe(nil), modifiers: T.unsafe(nil), noWaitAfter: T.unsafe(nil), position: T.unsafe(nil), strict: T.unsafe(nil), timeout: T.unsafe(nil), trial: T.unsafe(nil)); end

  # Returns `element.textContent`.
  #
  # source://playwright-ruby-client//lib/playwright_api/frame.rb#856
  def text_content(selector, strict: T.unsafe(nil), timeout: T.unsafe(nil)); end

  # Returns the page title.
  #
  # source://playwright-ruby-client//lib/playwright_api/frame.rb#862
  def title; end
  ...
  # **Usage**
  #
  # source://playwright-ruby-client//lib/playwright_api/frame.rb#873
  def type(selector, text, delay: T.unsafe(nil), noWaitAfter: T.unsafe(nil), strict: T.unsafe(nil), timeout: T.unsafe(nil)); end
  ...
  # `TimeoutError`. Passing zero timeout disables this.
  #
  # source://playwright-ruby-client//lib/playwright_api/frame.rb#895
  def uncheck(selector, force: T.unsafe(nil), noWaitAfter: T.unsafe(nil), position: T.unsafe(nil), strict: T.unsafe(nil), timeout: T.unsafe(nil), trial: T.unsafe(nil)); end

  # Returns frame's url.
  #
  # source://playwright-ruby-client//lib/playwright_api/frame.rb#908
  def url; end
  ...
  # @return [Boolean]
  #
  # source://playwright-ruby-client//lib/playwright_api/frame.rb#659
  def visible?(selector, strict: T.unsafe(nil), timeout: T.unsafe(nil)); end
  ...
  # ```
  #
  # source://playwright-ruby-client//lib/playwright_api/frame.rb#940
  ...
  # ```
  #
  # source://playwright-ruby-client//lib/playwright_api/frame.rb#1014
  def wait_for_selector(selector, state: T.unsafe(nil), strict: T.unsafe(nil), timeout: T.unsafe(nil)); end
  ...
  #
  # source://playwright-ruby-client//lib/playwright_api/frame.rb#1023
  def wait_for_timeout(timeout); end
  ...
  # ```
  #
  # source://playwright-ruby-client//lib/playwright_api/frame.rb#1036
  def wait_for_url(url, timeout: T.unsafe(nil), waitUntil: T.unsafe(nil)); end

  private

  # source://playwright-ruby-client//lib/playwright_api/frame.rb#1068
  def event_emitter_proxy; end
end
...
class Playwright::FrameAlreadyDetachedError < ::StandardError
  # source://playwright-ruby-client//lib/playwright/channel_owners/page.rb#895
  def initialize; end
end
...
class Playwright::FrameLocator < ::Playwright::PlaywrightApi
  ...
  #
  # source://playwright-ruby-client//lib/playwright_api/frame_locator.rb#33
  def first; end

  # When working with iframes, you can create a frame locator that will enter the iframe and allow selecting elements
  # in that iframe.
  #
  # source://playwright-ruby-client//lib/playwright_api/frame_locator.rb#40
  def frame_locator(selector); end
  ...
  # ```
  #
  # source://playwright-ruby-client//lib/playwright_api/frame_locator.rb#58
  def get_by_alt_text(text, exact: T.unsafe(nil)); end
  ...
  # ```
  #
  # source://playwright-ruby-client//lib/playwright_api/frame_locator.rb#79
  def get_by_label(text, exact: T.unsafe(nil)); end
  ...
  # ```
  #
  # source://playwright-ruby-client//lib/playwright_api/frame_locator.rb#99
  def get_by_placeholder(text, exact: T.unsafe(nil)); end
  ...
  # Many html elements have an implicitly [defined role](https://w3c.github.io/html-aam/#html-element-role-mappings) that is recognized by the role selector. You can find all the [supported roles here](https://www.w3.org/TR/wai-aria-1.2/#role_definitions). ARIA guidelines **do not recommend** duplicating implicit roles and attributes by setting `role` and/or `aria-*` attributes to default values.
  #
  # source://playwright-ruby-client//lib/playwright_api/frame_locator.rb#134
  def get_by_role(role, checked: T.unsafe(nil), disabled: T.unsafe(nil), exact: T.unsafe(nil), expanded: T.unsafe(nil), includeHidden: T.unsafe(nil), level: T.unsafe(nil), name: T.unsafe(nil), pressed: T.unsafe(nil), selected: T.unsafe(nil)); end
  ...
  # By default, the `data-testid` attribute is used as a test id. Use [`method: Selectors.setTestIdAttribute`] to configure a different test id attribute if necessary.
  #
  # source://playwright-ruby-client//lib/playwright_api/frame_locator.rb#168
  def get_by_test_id(testId); end
  ...
  # Input elements of the type `button` and `submit` are matched by their `value` instead of the text content. For example, locating by text `"Log in"` matches `<input type=button value="Log in">`.
  #
  # source://playwright-ruby-client//lib/playwright_api/frame_locator.rb#210
  def get_by_text(text, exact: T.unsafe(nil)); end
  ...
  # ```
  #
  # source://playwright-ruby-client//lib/playwright_api/frame_locator.rb#230
  def get_by_title(text, exact: T.unsafe(nil)); end

  # Returns locator to the last matching frame.
  #
  # source://playwright-ruby-client//lib/playwright_api/frame_locator.rb#236
  def last; end
  ...
  # [Learn more about locators](../locators.md).
  #
  # source://playwright-ruby-client//lib/playwright_api/frame_locator.rb#244
  ...
  #
  # source://playwright-ruby-client//lib/playwright_api/frame_locator.rb#255
  def nth(index); end
end
...
class Playwright::HarRouter
  ...
  # source://playwright-ruby-client//lib/playwright/har_router.rb#68
  def add_context_route(context); end

  # source://playwright-ruby-client//lib/playwright/har_router.rb#73
  def add_page_route(page); end

  # source://playwright-ruby-client//lib/playwright/har_router.rb#78
  def dispose; end
...
class Playwright::InputFiles
  ...
  # source://playwright-ruby-client//lib/playwright/input_files.rb#16
  ...
  # @return [Boolean]
  #
  # source://playwright-ruby-client//lib/playwright/input_files.rb#24
  def has_large_file?; end

  # source://playwright-ruby-client//lib/playwright/input_files.rb#39
  def params_for_set_input_file_paths; end

  # source://playwright-ruby-client//lib/playwright/input_files.rb#63
  def params_for_set_input_files; end

  # @raise [ArgumentError]
  #
  # source://playwright-ruby-client//lib/playwright/input_files.rb#84
...
# source://playwright-ruby-client//lib/playwright/javascript/value_parser.rb#5
class Playwright::JavaScript::ValueParser
  ...
  # @return [Hash]
  #
  # source://playwright-ruby-client//lib/playwright/javascript/value_parser.rb#12
  def parse; end
  ...
  # @raise [ArgumentError]
  #
  # source://playwright-ruby-client//lib/playwright/javascript/value_parser.rb#22
...
# ```
#
# source://playwright-ruby-client//lib/playwright_api/keyboard.rb#38
class Playwright::Keyboard < ::Playwright::PlaywrightApi
  ...
  #
  # source://playwright-ruby-client//lib/playwright_api/keyboard.rb#66
  def down(key); end
  ...
  #
  # source://playwright-ruby-client//lib/playwright_api/keyboard.rb#80
  ...
  #
  # source://playwright-ruby-client//lib/playwright_api/keyboard.rb#120
  ...
  #
  # source://playwright-ruby-client//lib/playwright_api/keyboard.rb#141
  def type(text, delay: T.unsafe(nil)); end

  # Dispatches a `keyup` event.
  #
  # source://playwright-ruby-client//lib/playwright_api/keyboard.rb#147
  def up(key); end
end
...
class Playwright::Locator < ::Playwright::PlaywrightApi
  ...
  #
  # source://playwright-ruby-client//lib/playwright_api/locator.rb#72
  ...
  # ```
  #
  # source://playwright-ruby-client//lib/playwright_api/locator.rb#98
  ...
  # ```
  #
  # source://playwright-ruby-client//lib/playwright_api/locator.rb#125
  def check(force: T.unsafe(nil), noWaitAfter: T.unsafe(nil), position: T.unsafe(nil), timeout: T.unsafe(nil), trial: T.unsafe(nil)); end
  ...
  # `TimeoutError`. Passing zero timeout disables this.
  #
  # source://playwright-ruby-client//lib/playwright_api/locator.rb#1042
  def checked=(checked, force: T.unsafe(nil), noWaitAfter: T.unsafe(nil), position: T.unsafe(nil), timeout: T.unsafe(nil), trial: T.unsafe(nil)); end
  ...
  # @return [Boolean]
  #
  # source://playwright-ruby-client//lib/playwright_api/locator.rb#729
  ...
  # ```
  #
  # source://playwright-ruby-client//lib/playwright_api/locator.rb#148
  ...
  # ```
  #
  # source://playwright-ruby-client//lib/playwright_api/locator.rb#183
  def click(button: T.unsafe(nil), clickCount: T.unsafe(nil), delay: T.unsafe(nil), force: T.unsafe(nil), modifiers: T.unsafe(nil), noWaitAfter: T.unsafe(nil), position: T.unsafe(nil), timeout: T.unsafe(nil), trial: T.unsafe(nil)); end
  ...
  # ```
  #
  # source://playwright-ruby-client//lib/playwright_api/locator.rb#206
  def count; end
  ...
  #
  # source://playwright-ruby-client//lib/playwright_api/locator.rb#227
  def dblclick(button: T.unsafe(nil), delay: T.unsafe(nil), force: T.unsafe(nil), modifiers: T.unsafe(nil), noWaitAfter: T.unsafe(nil), position: T.unsafe(nil), timeout: T.unsafe(nil), trial: T.unsafe(nil)); end
  ...
  # @return [Boolean]
  #
  # source://playwright-ruby-client//lib/playwright_api/locator.rb#743
  ...
  # ```
  #
  # source://playwright-ruby-client//lib/playwright_api/locator.rb#278
  ...
  # ```
  #
  # source://playwright-ruby-client//lib/playwright_api/locator.rb#305
  ...
  # @return [Boolean]
  #
  # source://playwright-ruby-client//lib/playwright_api/locator.rb#757
  def editable?(timeout: T.unsafe(nil)); end

  # Resolves given locator to the first matching DOM element. If there are no matching elements, waits for one. If multiple elements match the locator, throws.
  #
  # source://playwright-ruby-client//lib/playwright_api/locator.rb#318
  def element_handle(timeout: T.unsafe(nil)); end

  # Resolves given locator to all matching DOM elements. If there are no matching elements, returns an empty list.
  #
  # source://playwright-ruby-client//lib/playwright_api/locator.rb#324
  ...
  # @return [Boolean]
  #
  # source://playwright-ruby-client//lib/playwright_api/locator.rb#771
  ...
  # ```
  #
  # source://playwright-ruby-client//lib/playwright_api/locator.rb#345
  ...
  # ```
  #
  # source://playwright-ruby-client//lib/playwright_api/locator.rb#366
  ...
  # See [`method: Page.evaluateHandle`] for more details.
  #
  # source://playwright-ruby-client//lib/playwright_api/locator.rb#384
  def evaluate_handle(expression, arg: T.unsafe(nil), timeout: T.unsafe(nil)); end

  # source://playwright-ruby-client//lib/playwright_api/locator.rb#1182
  ...
  # To send fine-grained keyboard events, use [`method: Locator.pressSequentially`].
  #
  # source://playwright-ruby-client//lib/playwright_api/locator.rb#404
  def fill(value, force: T.unsafe(nil), noWaitAfter: T.unsafe(nil), timeout: T.unsafe(nil)); end
  ...
  # ```
  #
  # source://playwright-ruby-client//lib/playwright_api/locator.rb#421
  def filter(has: T.unsafe(nil), hasNot: T.unsafe(nil), hasNotText: T.unsafe(nil), hasText: T.unsafe(nil)); end

  # Returns locator to the first matching element.
  #
  # source://playwright-ruby-client//lib/playwright_api/locator.rb#427
  def first; end

  # Calls [focus](https://developer.mozilla.org/en-US/docs/Web/API/HTMLElement/focus) on the matching element.
  #
  # source://playwright-ruby-client//lib/playwright_api/locator.rb#433
  ...
  # ```
  #
  # source://playwright-ruby-client//lib/playwright_api/locator.rb#447
  def frame_locator(selector); end
  ...
  # ```
  #
  # source://playwright-ruby-client//lib/playwright_api/locator.rb#474
  def get_by_alt_text(text, exact: T.unsafe(nil)); end
  ...
  # ```
  #
  # source://playwright-ruby-client//lib/playwright_api/locator.rb#495
  def get_by_label(text, exact: T.unsafe(nil)); end
  ...
  # ```
  #
  # source://playwright-ruby-client//lib/playwright_api/locator.rb#515
  def get_by_placeholder(text, exact: T.unsafe(nil)); end
  ...
  # Many html elements have an implicitly [defined role](https://w3c.github.io/html-aam/#html-element-role-mappings) that is recognized by the role selector. You can find all the [supported roles here](https://www.w3.org/TR/wai-aria-1.2/#role_definitions). ARIA guidelines **do not recommend** duplicating implicit roles and attributes by setting `role` and/or `aria-*` attributes to default values.
  #
  # source://playwright-ruby-client//lib/playwright_api/locator.rb#550
  def get_by_role(role, checked: T.unsafe(nil), disabled: T.unsafe(nil), exact: T.unsafe(nil), expanded: T.unsafe(nil), includeHidden: T.unsafe(nil), level: T.unsafe(nil), name: T.unsafe(nil), pressed: T.unsafe(nil), selected: T.unsafe(nil)); end
  ...
  # By default, the `data-testid` attribute is used as a test id. Use [`method: Selectors.setTestIdAttribute`] to configure a different test id attribute if necessary.
  #
  # source://playwright-ruby-client//lib/playwright_api/locator.rb#584
  def get_by_test_id(testId); end
  ...
  # Input elements of the type `button` and `submit` are matched by their `value` instead of the text content. For example, locating by text `"Log in"` matches `<input type=button value="Log in">`.
  #
  # source://playwright-ruby-client//lib/playwright_api/locator.rb#626
  def get_by_text(text, exact: T.unsafe(nil)); end
  ...
  # ```
  #
  # source://playwright-ruby-client//lib/playwright_api/locator.rb#646
  def get_by_title(text, exact: T.unsafe(nil)); end
  ...
  # @return [Boolean]
  #
  # source://playwright-ruby-client//lib/playwright_api/locator.rb#785
  ...
  #
  # source://playwright-ruby-client//lib/playwright_api/locator.rb#652
  def highlight; end
  ...
  # `TimeoutError`. Passing zero timeout disables this.
  #
  # source://playwright-ruby-client//lib/playwright_api/locator.rb#677
  def hover(force: T.unsafe(nil), modifiers: T.unsafe(nil), noWaitAfter: T.unsafe(nil), position: T.unsafe(nil), timeout: T.unsafe(nil), trial: T.unsafe(nil)); end

  # Returns the [`element.innerHTML`](https://developer.mozilla.org/en-US/docs/Web/API/Element/innerHTML).
  #
  # source://playwright-ruby-client//lib/playwright_api/locator.rb#689
  ...
  # **NOTE**: If you need to assert text on the page, prefer [`method: LocatorAssertions.toHaveText`] with `useInnerText` option to avoid flakiness. See [assertions guide](../test-assertions.md) for more details.
  #
  # source://playwright-ruby-client//lib/playwright_api/locator.rb#697
  ...
  # [input element](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/input). However, if the element is inside the `<label>` element that has an associated [control](https://developer.mozilla.org/en-US/docs/Web/API/HTMLLabelElement/control), targets the control instead.
  #
  # source://playwright-ruby-client//lib/playwright_api/locator.rb#1083
  def input_files=(files, noWaitAfter: T.unsafe(nil), timeout: T.unsafe(nil)); end
  ...
  #
  # source://playwright-ruby-client//lib/playwright_api/locator.rb#715
  def input_value(timeout: T.unsafe(nil)); end
  ...
  # ```
  #
  # source://playwright-ruby-client//lib/playwright_api/locator.rb#811
  def last; end
  ...
  # [Learn more about locators](../locators.md).
  #
  # source://playwright-ruby-client//lib/playwright_api/locator.rb#819
  def locator(selectorOrLocator, has: T.unsafe(nil), hasNot: T.unsafe(nil), hasNotText: T.unsafe(nil), hasText: T.unsafe(nil)); end
  ...
  # ```
  #
  # source://playwright-ruby-client//lib/playwright_api/locator.rb#836
  def nth(index); end
  ...
  # ```
  #
  # source://playwright-ruby-client//lib/playwright_api/locator.rb#855
  def or(locator); end

  # A page this locator belongs to.
  #
  # source://playwright-ruby-client//lib/playwright_api/locator.rb#861
  def page; end
  ...
  # modifier, modifier is pressed and being held while the subsequent key is being pressed.
  #
  # source://playwright-ruby-client//lib/playwright_api/locator.rb#895
  def press(key, delay: T.unsafe(nil), noWaitAfter: T.unsafe(nil), timeout: T.unsafe(nil)); end
  ...
  # ```
  #
  # source://playwright-ruby-client//lib/playwright_api/locator.rb#920
  ...
  # Returns the buffer with the captured screenshot.
  #
  # source://playwright-ruby-client//lib/playwright_api/locator.rb#947
  def screenshot(animations: T.unsafe(nil), caret: T.unsafe(nil), mask: T.unsafe(nil), maskColor: T.unsafe(nil), omitBackground: T.unsafe(nil), path: T.unsafe(nil), quality: T.unsafe(nil), scale: T.unsafe(nil), timeout: T.unsafe(nil), type: T.unsafe(nil)); end
  ...
  # [IntersectionObserver](https://developer.mozilla.org/en-US/docs/Web/API/Intersection_Observer_API)'s `ratio`.
  #
  # source://playwright-ruby-client//lib/playwright_api/locator.rb#965
  def scroll_into_view_if_needed(timeout: T.unsafe(nil)); end
  ...
  # ```
  #
  # source://playwright-ruby-client//lib/playwright_api/locator.rb#1000
  def select_option(element: T.unsafe(nil), index: T.unsafe(nil), value: T.unsafe(nil), label: T.unsafe(nil), force: T.unsafe(nil), noWaitAfter: T.unsafe(nil), timeout: T.unsafe(nil)); end
  ...
  # If the element is inside the `<label>` element that has an associated [control](https://developer.mozilla.org/en-US/docs/Web/API/HTMLLabelElement/control), focuses and selects text in the control instead.
  #
  # source://playwright-ruby-client//lib/playwright_api/locator.rb#1016
  def select_text(force: T.unsafe(nil), timeout: T.unsafe(nil)); end
  ...
  # **NOTE**: If you need to assert text on the page, prefer [`method: LocatorAssertions.toHaveText`] to avoid flakiness. See [assertions guide](../test-assertions.md) for more details.
  #
  # source://playwright-ruby-client//lib/playwright_api/locator.rb#1119
  def text_content(timeout: T.unsafe(nil)); end

  # source://playwright-ruby-client//lib/playwright_api/locator.rb#1187
  def to_s; end
  ...
  # **Usage**
  #
  # source://playwright-ruby-client//lib/playwright_api/locator.rb#1129
  def type(text, delay: T.unsafe(nil), noWaitAfter: T.unsafe(nil), timeout: T.unsafe(nil)); end
  ...
  # `TimeoutError`. Passing zero timeout disables this.
  #
  # source://playwright-ruby-client//lib/playwright_api/locator.rb#1156
  def uncheck(force: T.unsafe(nil), noWaitAfter: T.unsafe(nil), position: T.unsafe(nil), timeout: T.unsafe(nil), trial: T.unsafe(nil)); end
  ...
  # @return [Boolean]
  #
  # source://playwright-ruby-client//lib/playwright_api/locator.rb#799
  ...
  # ```
  #
  # source://playwright-ruby-client//lib/playwright_api/locator.rb#1177
...
class Playwright::LocatorAssertions < ::Playwright::PlaywrightApi
  ...
  def not_to_have_attribute(name, value, timeout: T.unsafe(nil)); end
  ...
  # ```
  #
  # source://playwright-ruby-client//lib/playwright_api/locator_assertions.rb#158
  def to_be_checked(checked: T.unsafe(nil), timeout: T.unsafe(nil)); end
  ...
  # ```
  #
  # source://playwright-ruby-client//lib/playwright_api/locator_assertions.rb#177
  ...
  # ```
  #
  # source://playwright-ruby-client//lib/playwright_api/locator_assertions.rb#192
  ...
  # ```
  #
  # source://playwright-ruby-client//lib/playwright_api/locator_assertions.rb#207
  ...
  # ```
  #
  # source://playwright-ruby-client//lib/playwright_api/locator_assertions.rb#222
  ...
  # ```
  #
  # source://playwright-ruby-client//lib/playwright_api/locator_assertions.rb#237
  ...
  # ```
  #
  # source://playwright-ruby-client//lib/playwright_api/locator_assertions.rb#252
  ...
  # ```
  #
  # source://playwright-ruby-client//lib/playwright_api/locator_assertions.rb#272
  ...
  # ```
  #
  # source://playwright-ruby-client//lib/playwright_api/locator_assertions.rb#297
  ...
  # ```
  #
  # source://playwright-ruby-client//lib/playwright_api/locator_assertions.rb#353
  ...
  # ```
  #
  # source://playwright-ruby-client//lib/playwright_api/locator_assertions.rb#368
  ...
  # ```
  #
  # source://playwright-ruby-client//lib/playwright_api/locator_assertions.rb#398
  ...
  # ```
  #
  # source://playwright-ruby-client//lib/playwright_api/locator_assertions.rb#413
  ...
  # ```
  #
  # source://playwright-ruby-client//lib/playwright_api/locator_assertions.rb#428
  ...
  # ```
  #
  # source://playwright-ruby-client//lib/playwright_api/locator_assertions.rb#443
  ...
  # ```
  #
  # source://playwright-ruby-client//lib/playwright_api/locator_assertions.rb#459
  ...
  # ```
  #
  # source://playwright-ruby-client//lib/playwright_api/locator_assertions.rb#514
  ...
  # ```
  #
  # source://playwright-ruby-client//lib/playwright_api/locator_assertions.rb#530
  ...
  # ```
  #
  # source://playwright-ruby-client//lib/playwright_api/locator_assertions.rb#557
...
class Playwright::LocatorAssertionsImpl
  ...
  # source://playwright-ruby-client//lib/playwright/locator_assertions_impl.rb#316
  def to_be_attached(attached: T.unsafe(nil), timeout: T.unsafe(nil)); end

  # source://playwright-ruby-client//lib/playwright/locator_assertions_impl.rb#326
  def to_be_checked(checked: T.unsafe(nil), timeout: T.unsafe(nil)); end

  # source://playwright-ruby-client//lib/playwright/locator_assertions_impl.rb#336
  def to_be_disabled(timeout: T.unsafe(nil)); end

  # source://playwright-ruby-client//lib/playwright/locator_assertions_impl.rb#346
  def to_be_editable(editable: T.unsafe(nil), timeout: T.unsafe(nil)); end

  # source://playwright-ruby-client//lib/playwright/locator_assertions_impl.rb#356
  def to_be_empty(timeout: T.unsafe(nil)); end

  # source://playwright-ruby-client//lib/playwright/locator_assertions_impl.rb#366
  def to_be_enabled(enabled: T.unsafe(nil), timeout: T.unsafe(nil)); end

  # source://playwright-ruby-client//lib/playwright/locator_assertions_impl.rb#396
  def to_be_focused(timeout: T.unsafe(nil)); end

  # source://playwright-ruby-client//lib/playwright/locator_assertions_impl.rb#376
  def to_be_hidden(timeout: T.unsafe(nil)); end

  # source://playwright-ruby-client//lib/playwright/locator_assertions_impl.rb#406
  def to_be_in_viewport(ratio: T.unsafe(nil), timeout: T.unsafe(nil)); end

  # source://playwright-ruby-client//lib/playwright/locator_assertions_impl.rb#386
  def to_be_visible(timeout: T.unsafe(nil), visible: T.unsafe(nil)); end

  # source://playwright-ruby-client//lib/playwright/locator_assertions_impl.rb#106
  def to_contain_text(expected, ignoreCase: T.unsafe(nil), timeout: T.unsafe(nil), useInnerText: T.unsafe(nil)); end

  # source://playwright-ruby-client//lib/playwright/locator_assertions_impl.rb#149
  def to_have_attribute(name, value, ignoreCase: T.unsafe(nil), timeout: T.unsafe(nil)); end

  # source://playwright-ruby-client//lib/playwright/locator_assertions_impl.rb#164
  def to_have_class(expected, timeout: T.unsafe(nil)); end

  # source://playwright-ruby-client//lib/playwright/locator_assertions_impl.rb#191
  def to_have_count(count, timeout: T.unsafe(nil)); end

  # source://playwright-ruby-client//lib/playwright/locator_assertions_impl.rb#204
  def to_have_css(name, value, timeout: T.unsafe(nil)); end

  # source://playwright-ruby-client//lib/playwright/locator_assertions_impl.rb#219
  def to_have_id(id, timeout: T.unsafe(nil)); end

  # source://playwright-ruby-client//lib/playwright/locator_assertions_impl.rb#233
  def to_have_js_property(name, value, timeout: T.unsafe(nil)); end

  # source://playwright-ruby-client//lib/playwright/locator_assertions_impl.rb#277
  def to_have_text(expected, ignoreCase: T.unsafe(nil), timeout: T.unsafe(nil), useInnerText: T.unsafe(nil)); end

  # source://playwright-ruby-client//lib/playwright/locator_assertions_impl.rb#247
  def to_have_value(value, timeout: T.unsafe(nil)); end

  # source://playwright-ruby-client//lib/playwright/locator_assertions_impl.rb#262
  def to_have_values(values, timeout: T.unsafe(nil)); end
...
class Playwright::LocatorImpl
  ...
  def initialize(frame:, timeout_settings:, selector:, has: T.unsafe(nil), hasNot: T.unsafe(nil), hasNotText: T.unsafe(nil), hasText: T.unsafe(nil)); end

  # source://playwright-ruby-client//lib/playwright/locator_impl.rb#306
  def all; end

  # source://playwright-ruby-client//lib/playwright/locator_impl.rb#476
  def all_inner_texts; end

  # source://playwright-ruby-client//lib/playwright/locator_impl.rb#480
  def all_text_contents; end

  # source://playwright-ruby-client//lib/playwright/locator_impl.rb#271
  def and(locator); end

  # source://playwright-ruby-client//lib/playwright/locator_impl.rb#297
  def blur(timeout: T.unsafe(nil)); end

  # source://playwright-ruby-client//lib/playwright/locator_impl.rb#87
  def bounding_box(timeout: T.unsafe(nil)); end

  # source://playwright-ruby-client//lib/playwright/locator_impl.rb#93
  def check(force: T.unsafe(nil), noWaitAfter: T.unsafe(nil), position: T.unsafe(nil), timeout: T.unsafe(nil), trial: T.unsafe(nil)); end

  # source://playwright-ruby-client//lib/playwright/locator_impl.rb#348
  def checked?(timeout: T.unsafe(nil)); end

  # source://playwright-ruby-client//lib/playwright/locator_impl.rb#200
  def clear(force: T.unsafe(nil), noWaitAfter: T.unsafe(nil), timeout: T.unsafe(nil)); end

  # source://playwright-ruby-client//lib/playwright/locator_impl.rb#109
  def click(button: T.unsafe(nil), clickCount: T.unsafe(nil), delay: T.unsafe(nil), force: T.unsafe(nil), modifiers: T.unsafe(nil), noWaitAfter: T.unsafe(nil), position: T.unsafe(nil), timeout: T.unsafe(nil), trial: T.unsafe(nil)); end

  # source://playwright-ruby-client//lib/playwright/locator_impl.rb#310
  def count; end

  # source://playwright-ruby-client//lib/playwright/locator_impl.rb#133
  def dblclick(button: T.unsafe(nil), delay: T.unsafe(nil), force: T.unsafe(nil), modifiers: T.unsafe(nil), noWaitAfter: T.unsafe(nil), position: T.unsafe(nil), timeout: T.unsafe(nil), trial: T.unsafe(nil)); end

  # source://playwright-ruby-client//lib/playwright/locator_impl.rb#348
  def disabled?(timeout: T.unsafe(nil)); end

  # source://playwright-ruby-client//lib/playwright/locator_impl.rb#155
  def dispatch_event(type, eventInit: T.unsafe(nil), timeout: T.unsafe(nil)); end
  ...
  # source://playwright-ruby-client//lib/playwright/locator_impl.rb#228
  def element_handle(timeout: T.unsafe(nil)); end
  ...
  # source://playwright-ruby-client//lib/playwright/locator_impl.rb#180
  def evaluate(expression, arg: T.unsafe(nil), timeout: T.unsafe(nil)); end

  # source://playwright-ruby-client//lib/playwright/locator_impl.rb#186
  def evaluate_all(expression, arg: T.unsafe(nil)); end
  ...
  # source://playwright-ruby-client//lib/playwright/locator_impl.rb#196
  def fill(value, force: T.unsafe(nil), noWaitAfter: T.unsafe(nil), timeout: T.unsafe(nil)); end

  # source://playwright-ruby-client//lib/playwright/locator_impl.rb#236
  def filter(has: T.unsafe(nil), hasNot: T.unsafe(nil), hasNotText: T.unsafe(nil), hasText: T.unsafe(nil)); end

  # source://playwright-ruby-client//lib/playwright/locator_impl.rb#247
  def first; end

  # source://playwright-ruby-client//lib/playwright/locator_impl.rb#293
  def focus(timeout: T.unsafe(nil)); end

  # source://playwright-ruby-client//lib/playwright/locator_impl.rb#220
  def frame_locator(selector); end

  # source://playwright-ruby-client//lib/playwright/locator_impl.rb#314
  def get_attribute(name, timeout: T.unsafe(nil)); end

  # source://playwright-ruby-client//lib/playwright/locator_impl.rb#348
  def hidden?(timeout: T.unsafe(nil)); end

  # source://playwright-ruby-client//lib/playwright/locator_impl.rb#484
  def highlight; end

  # source://playwright-ruby-client//lib/playwright/locator_impl.rb#318
  def hover(force: T.unsafe(nil), modifiers: T.unsafe(nil), noWaitAfter: T.unsafe(nil), position: T.unsafe(nil), timeout: T.unsafe(nil), trial: T.unsafe(nil)); end

  # source://playwright-ruby-client//lib/playwright/locator_impl.rb#335
  def inner_html(timeout: T.unsafe(nil)); end

  # source://playwright-ruby-client//lib/playwright/locator_impl.rb#339
  def inner_text(timeout: T.unsafe(nil)); end

  # source://playwright-ruby-client//lib/playwright/locator_impl.rb#343
  def input_value(timeout: T.unsafe(nil)); end

  # source://playwright-ruby-client//lib/playwright/locator_impl.rb#255
  def last; end

  # source://playwright-ruby-client//lib/playwright/locator_impl.rb#204
  def locator(selector, has: T.unsafe(nil), hasNot: T.unsafe(nil), hasNotText: T.unsafe(nil), hasText: T.unsafe(nil)); end

  # source://playwright-ruby-client//lib/playwright/locator_impl.rb#263
  def nth(index); end

  # source://playwright-ruby-client//lib/playwright/locator_impl.rb#282
  def or(locator); end

  # source://playwright-ruby-client//lib/playwright/locator_impl.rb#83
  def page; end

  # source://playwright-ruby-client//lib/playwright/locator_impl.rb#353
  def press(key, delay: T.unsafe(nil), noWaitAfter: T.unsafe(nil), timeout: T.unsafe(nil)); end

  # source://playwright-ruby-client//lib/playwright/locator_impl.rb#445
  def press_sequentially(text, delay: T.unsafe(nil), noWaitAfter: T.unsafe(nil), timeout: T.unsafe(nil)); end

  # source://playwright-ruby-client//lib/playwright/locator_impl.rb#357
  def screenshot(animations: T.unsafe(nil), caret: T.unsafe(nil), mask: T.unsafe(nil), maskColor: T.unsafe(nil), omitBackground: T.unsafe(nil), path: T.unsafe(nil), quality: T.unsafe(nil), scale: T.unsafe(nil), timeout: T.unsafe(nil), type: T.unsafe(nil)); end

  # source://playwright-ruby-client//lib/playwright/locator_impl.rb#384
  def scroll_into_view_if_needed(timeout: T.unsafe(nil)); end

  # source://playwright-ruby-client//lib/playwright/locator_impl.rb#390
  def select_option(element: T.unsafe(nil), index: T.unsafe(nil), value: T.unsafe(nil), label: T.unsafe(nil), force: T.unsafe(nil), noWaitAfter: T.unsafe(nil), timeout: T.unsafe(nil)); end

  # source://playwright-ruby-client//lib/playwright/locator_impl.rb#410
  def select_text(force: T.unsafe(nil), timeout: T.unsafe(nil)); end

  # source://playwright-ruby-client//lib/playwright/locator_impl.rb#468
  def set_checked(checked, **options); end

  # source://playwright-ruby-client//lib/playwright/locator_impl.rb#416
  def set_input_files(files, noWaitAfter: T.unsafe(nil), timeout: T.unsafe(nil)); end

  # source://playwright-ruby-client//lib/playwright/locator_impl.rb#420
  def tap_point(force: T.unsafe(nil), modifiers: T.unsafe(nil), noWaitAfter: T.unsafe(nil), position: T.unsafe(nil), timeout: T.unsafe(nil), trial: T.unsafe(nil)); end

  # source://playwright-ruby-client//lib/playwright/locator_impl.rb#437
  def text_content(timeout: T.unsafe(nil)); end

  # source://playwright-ruby-client//lib/playwright/locator_impl.rb#38
  def to_s; end

  # source://playwright-ruby-client//lib/playwright/locator_impl.rb#441
  def type(text, delay: T.unsafe(nil), noWaitAfter: T.unsafe(nil), timeout: T.unsafe(nil)); end

  # source://playwright-ruby-client//lib/playwright/locator_impl.rb#449
  def uncheck(force: T.unsafe(nil), noWaitAfter: T.unsafe(nil), position: T.unsafe(nil), timeout: T.unsafe(nil), trial: T.unsafe(nil)); end

  # source://playwright-ruby-client//lib/playwright/locator_impl.rb#348
  def visible?(timeout: T.unsafe(nil)); end

  # source://playwright-ruby-client//lib/playwright/locator_impl.rb#464
  def wait_for(state: T.unsafe(nil), timeout: T.unsafe(nil)); end

  private

  # source://playwright-ruby-client//lib/playwright/locator_impl.rb#55
...
# ```
#
# source://playwright-ruby-client//lib/playwright_api/page.rb#45
class Playwright::Page < ::Playwright::PlaywrightApi
  # property
  #
  # source://playwright-ruby-client//lib/playwright_api/page.rb#47
  def accessibility; end
  ...
  # [`method: Page.addInitScript`] is not defined.
  #
  # source://playwright-ruby-client//lib/playwright_api/page.rb#89
  def add_init_script(path: T.unsafe(nil), script: T.unsafe(nil)); end

  # Adds a `<script>` tag into the page with the desired url or content. Returns the added tag when the script's onload
  # fires or when the script content was injected into frame.
  #
  # source://playwright-ruby-client//lib/playwright_api/page.rb#96
  def add_script_tag(content: T.unsafe(nil), path: T.unsafe(nil), type: T.unsafe(nil), url: T.unsafe(nil)); end

  # Adds a `<link rel="stylesheet">` tag into the page with the desired url or a `<style type="text/css">` tag with the
  # content. Returns the added tag when the stylesheet's onload fires or when the CSS content was injected into frame.
  #
  # source://playwright-ruby-client//lib/playwright_api/page.rb#103
  def add_style_tag(content: T.unsafe(nil), path: T.unsafe(nil), url: T.unsafe(nil)); end

  # Brings page to front (activates tab).
  #
  # source://playwright-ruby-client//lib/playwright_api/page.rb#109
  def bring_to_front; end
  ...
  # `TimeoutError`. Passing zero timeout disables this.
  #
  # source://playwright-ruby-client//lib/playwright_api/page.rb#125
  def check(selector, force: T.unsafe(nil), noWaitAfter: T.unsafe(nil), position: T.unsafe(nil), strict: T.unsafe(nil), timeout: T.unsafe(nil), trial: T.unsafe(nil)); end
  ...
  # @return [Boolean]
  #
  # source://playwright-ruby-client//lib/playwright_api/page.rb#877
  def checked?(selector, strict: T.unsafe(nil), timeout: T.unsafe(nil)); end
  ...
  # `TimeoutError`. Passing zero timeout disables this.
  #
  # source://playwright-ruby-client//lib/playwright_api/page.rb#146
  def click(selector, button: T.unsafe(nil), clickCount: T.unsafe(nil), delay: T.unsafe(nil), force: T.unsafe(nil), modifiers: T.unsafe(nil), noWaitAfter: T.unsafe(nil), position: T.unsafe(nil), strict: T.unsafe(nil), timeout: T.unsafe(nil), trial: T.unsafe(nil)); end
  ...
  #
  # source://playwright-ruby-client//lib/playwright_api/page.rb#169
  ...
  # @return [Boolean]
  #
  # source://playwright-ruby-client//lib/playwright_api/page.rb#883
  def closed?; end

  # Gets the full HTML contents of the page, including the doctype.
  #
  # source://playwright-ruby-client//lib/playwright_api/page.rb#175
  def content; end

  # This method internally calls [document.write()](https://developer.mozilla.org/en-US/docs/Web/API/Document/write), inheriting all its specific characteristics and behaviors.
  #
  # source://playwright-ruby-client//lib/playwright_api/page.rb#1229
  def content=(html, timeout: T.unsafe(nil), waitUntil: T.unsafe(nil)); end

  # Get the browser context that the page belongs to.
  #
  # source://playwright-ruby-client//lib/playwright_api/page.rb#181
  def context; end
  ...
  #
  # source://playwright-ruby-client//lib/playwright_api/page.rb#197
  def dblclick(selector, button: T.unsafe(nil), delay: T.unsafe(nil), force: T.unsafe(nil), modifiers: T.unsafe(nil), noWaitAfter: T.unsafe(nil), position: T.unsafe(nil), strict: T.unsafe(nil), timeout: T.unsafe(nil), trial: T.unsafe(nil)); end
  ...
  #
  # source://playwright-ruby-client//lib/playwright_api/page.rb#1246
  def default_navigation_timeout=(timeout); end
  ...
  # **NOTE**: [`method: Page.setDefaultNavigationTimeout`] takes priority over [`method: Page.setDefaultTimeout`].
  #
  # source://playwright-ruby-client//lib/playwright_api/page.rb#1255
  def default_timeout=(timeout); end
  ...
  # @return [Boolean]
  #
  # source://playwright-ruby-client//lib/playwright_api/page.rb#889
  def disabled?(selector, strict: T.unsafe(nil), timeout: T.unsafe(nil)); end
  ...
  # ```
  #
  # source://playwright-ruby-client//lib/playwright_api/page.rb#246
  def dispatch_event(selector, type, eventInit: T.unsafe(nil), strict: T.unsafe(nil), timeout: T.unsafe(nil)); end
  ...
  # ```
  #
  # source://playwright-ruby-client//lib/playwright_api/page.rb#272
  def drag_and_drop(source, target, force: T.unsafe(nil), noWaitAfter: T.unsafe(nil), sourcePosition: T.unsafe(nil), strict: T.unsafe(nil), targetPosition: T.unsafe(nil), timeout: T.unsafe(nil), trial: T.unsafe(nil)); end
  ...
  # @return [Boolean]
  #
  # source://playwright-ruby-client//lib/playwright_api/page.rb#895
  def editable?(selector, strict: T.unsafe(nil), timeout: T.unsafe(nil)); end
  ...
  # ```
  #
  # source://playwright-ruby-client//lib/playwright_api/page.rb#317
  def emulate_media(colorScheme: T.unsafe(nil), forcedColors: T.unsafe(nil), media: T.unsafe(nil), reducedMotion: T.unsafe(nil)); end
  ...
  # @return [Boolean]
  #
  # source://playwright-ruby-client//lib/playwright_api/page.rb#901
  def enabled?(selector, strict: T.unsafe(nil), timeout: T.unsafe(nil)); end
  ...
  # ```
  #
  # source://playwright-ruby-client//lib/playwright_api/page.rb#336
  def eval_on_selector(selector, expression, arg: T.unsafe(nil), strict: T.unsafe(nil)); end
  ...
  # ```
  #
  # source://playwright-ruby-client//lib/playwright_api/page.rb#352
  def eval_on_selector_all(selector, expression, arg: T.unsafe(nil)); end
  ...
  # ```
  #
  # source://playwright-ruby-client//lib/playwright_api/page.rb#390
  def evaluate(expression, arg: T.unsafe(nil)); end
  ...
  # ```
  #
  # source://playwright-ruby-client//lib/playwright_api/page.rb#423
  def evaluate_handle(expression, arg: T.unsafe(nil)); end
  ...
  #
  # source://playwright-ruby-client//lib/playwright_api/page.rb#1404
  def expect_console_message(predicate: T.unsafe(nil), timeout: T.unsafe(nil), &block); end
  ...
  #
  # source://playwright-ruby-client//lib/playwright_api/page.rb#1412
  def expect_download(predicate: T.unsafe(nil), timeout: T.unsafe(nil), &block); end
  ...
  # ```
  #
  # source://playwright-ruby-client//lib/playwright_api/page.rb#1427
  def expect_event(event, predicate: T.unsafe(nil), timeout: T.unsafe(nil), &block); end
  ...
  #
  # source://playwright-ruby-client//lib/playwright_api/page.rb#1435
  def expect_file_chooser(predicate: T.unsafe(nil), timeout: T.unsafe(nil), &block); end
  ...
  # a navigation.
  #
  # source://playwright-ruby-client//lib/playwright_api/page.rb#1516
  def expect_navigation(timeout: T.unsafe(nil), url: T.unsafe(nil), waitUntil: T.unsafe(nil), &block); end
  ...
  #
  # source://playwright-ruby-client//lib/playwright_api/page.rb#1524
  def expect_popup(predicate: T.unsafe(nil), timeout: T.unsafe(nil), &block); end
  ...
  # ```
  #
  # source://playwright-ruby-client//lib/playwright_api/page.rb#1572
  def expect_response(urlOrPredicate, timeout: T.unsafe(nil), &block); end
  ...
  #
  # source://playwright-ruby-client//lib/playwright_api/page.rb#1645
  def expect_websocket(predicate: T.unsafe(nil), timeout: T.unsafe(nil), &block); end
  ...
  #
  # source://playwright-ruby-client//lib/playwright_api/page.rb#1653
  def expect_worker(predicate: T.unsafe(nil), timeout: T.unsafe(nil), &block); end
  ...
  # ```
  #
  # source://playwright-ruby-client//lib/playwright_api/page.rb#482
  def expose_binding(name, callback, handle: T.unsafe(nil)); end
  ...
  # ```
  #
  # source://playwright-ruby-client//lib/playwright_api/page.rb#529
  def expose_function(name, callback); end
  ...
  #
  # source://playwright-ruby-client//lib/playwright_api/page.rb#1264
  def extra_http_headers=(headers); end
  ...
  # To send fine-grained keyboard events, use [`method: Locator.pressSequentially`].
  #
  # source://playwright-ruby-client//lib/playwright_api/page.rb#539
  def fill(selector, value, force: T.unsafe(nil), noWaitAfter: T.unsafe(nil), strict: T.unsafe(nil), timeout: T.unsafe(nil)); end

  # This method fetches an element with `selector` and focuses it. If there's no element matching
  # `selector`, the method waits until a matching element appears in the DOM.
  #
  # source://playwright-ruby-client//lib/playwright_api/page.rb#552
  def focus(selector, strict: T.unsafe(nil), timeout: T.unsafe(nil)); end
  ...
  # ```
  #
  # source://playwright-ruby-client//lib/playwright_api/page.rb#568
  def frame(name: T.unsafe(nil), url: T.unsafe(nil)); end
  ...
  # ```
  #
  # source://playwright-ruby-client//lib/playwright_api/page.rb#585
  def frame_locator(selector); end

  # An array of all frames attached to the page.
  #
  # source://playwright-ruby-client//lib/playwright_api/page.rb#591
  def frames; end

  # Returns element attribute value.
  #
  # source://playwright-ruby-client//lib/playwright_api/page.rb#597
  def get_attribute(selector, name, strict: T.unsafe(nil), timeout: T.unsafe(nil)); end
  ...
  # ```
  #
  # source://playwright-ruby-client//lib/playwright_api/page.rb#615
  def get_by_alt_text(text, exact: T.unsafe(nil)); end
  ...
  # ```
  #
  # source://playwright-ruby-client//lib/playwright_api/page.rb#636
  def get_by_label(text, exact: T.unsafe(nil)); end
  ...
  # ```
  #
  # source://playwright-ruby-client//lib/playwright_api/page.rb#656
  def get_by_placeholder(text, exact: T.unsafe(nil)); end
  ...
  # Many html elements have an implicitly [defined role](https://w3c.github.io/html-aam/#html-element-role-mappings) that is recognized by the role selector. You can find all the [supported roles here](https://www.w3.org/TR/wai-aria-1.2/#role_definitions). ARIA guidelines **do not recommend** duplicating implicit roles and attributes by setting `role` and/or `aria-*` attributes to default values.
  #
  # source://playwright-ruby-client//lib/playwright_api/page.rb#691
  def get_by_role(role, checked: T.unsafe(nil), disabled: T.unsafe(nil), exact: T.unsafe(nil), expanded: T.unsafe(nil), includeHidden: T.unsafe(nil), level: T.unsafe(nil), name: T.unsafe(nil), pressed: T.unsafe(nil), selected: T.unsafe(nil)); end
  ...
  # By default, the `data-testid` attribute is used as a test id. Use [`method: Selectors.setTestIdAttribute`] to configure a different test id attribute if necessary.
  #
  # source://playwright-ruby-client//lib/playwright_api/page.rb#725
  def get_by_test_id(testId); end
  ...
  # Input elements of the type `button` and `submit` are matched by their `value` instead of the text content. For example, locating by text `"Log in"` matches `<input type=button value="Log in">`.
  #
  # source://playwright-ruby-client//lib/playwright_api/page.rb#767
  def get_by_text(text, exact: T.unsafe(nil)); end
  ...
  #
  # source://playwright-ruby-client//lib/playwright_api/page.rb#805
  def go_forward(timeout: T.unsafe(nil), waitUntil: T.unsafe(nil)); end
  ...
  # [upstream issue](https://bugs.chromium.org/p/chromium/issues/detail?id=761295).
  #
  # source://playwright-ruby-client//lib/playwright_api/page.rb#829
  def goto(url, referer: T.unsafe(nil), timeout: T.unsafe(nil), waitUntil: T.unsafe(nil)); end

  # source://playwright-ruby-client//lib/playwright_api/page.rb#1702
  def guid; end
  ...
  # @return [Boolean]
  #
  # source://playwright-ruby-client//lib/playwright_api/page.rb#907
  def hidden?(selector, strict: T.unsafe(nil), timeout: T.unsafe(nil)); end
  ...
  # `TimeoutError`. Passing zero timeout disables this.
  #
  # source://playwright-ruby-client//lib/playwright_api/page.rb#843
  def hover(selector, force: T.unsafe(nil), modifiers: T.unsafe(nil), noWaitAfter: T.unsafe(nil), position: T.unsafe(nil), strict: T.unsafe(nil), timeout: T.unsafe(nil), trial: T.unsafe(nil)); end

  # Returns `element.innerHTML`.
  #
  # source://playwright-ruby-client//lib/playwright_api/page.rb#857
  def inner_html(selector, strict: T.unsafe(nil), timeout: T.unsafe(nil)); end

  # Returns `element.innerText`.
  #
  # source://playwright-ruby-client//lib/playwright_api/page.rb#863
  def inner_text(selector, strict: T.unsafe(nil), timeout: T.unsafe(nil)); end
  ...
  # property
  #
  # source://playwright-ruby-client//lib/playwright_api/page.rb#51
  def keyboard; end
  ...
  # [Learn more about locators](../locators.md).
  #
  # source://playwright-ruby-client//lib/playwright_api/page.rb#922
  def locator(selector, has: T.unsafe(nil), hasNot: T.unsafe(nil), hasNotText: T.unsafe(nil), hasText: T.unsafe(nil)); end

  # The page's main frame. Page is guaranteed to have a main frame which persists during navigations.
  #
  # source://playwright-ruby-client//lib/playwright_api/page.rb#933
  def main_frame; end

  # property
  #
  # source://playwright-ruby-client//lib/playwright_api/page.rb#55
  def mouse; end

  # -- inherited from EventEmitter --
  #
  # source://playwright-ruby-client//lib/playwright_api/page.rb#1708
  def off(event, callback); end

  # -- inherited from EventEmitter --
  #
  # source://playwright-ruby-client//lib/playwright_api/page.rb#1720
  def on(event, callback); end

  # -- inherited from EventEmitter --
  #
  # source://playwright-ruby-client//lib/playwright_api/page.rb#1714
  def once(event, callback); end

  # Returns the opener for popup pages and `null` for others. If the opener has been closed already the returns `null`.
  #
  # source://playwright-ruby-client//lib/playwright_api/page.rb#939
  def opener; end

  # source://playwright-ruby-client//lib/playwright_api/page.rb#1697
  ...
  #
  # source://playwright-ruby-client//lib/playwright_api/page.rb#952
  def pause; end
  ...
  #
  # source://playwright-ruby-client//lib/playwright_api/page.rb#1005
  def pdf(displayHeaderFooter: T.unsafe(nil), footerTemplate: T.unsafe(nil), format: T.unsafe(nil), headerTemplate: T.unsafe(nil), height: T.unsafe(nil), landscape: T.unsafe(nil), margin: T.unsafe(nil), pageRanges: T.unsafe(nil), path: T.unsafe(nil), preferCSSPageSize: T.unsafe(nil), printBackground: T.unsafe(nil), scale: T.unsafe(nil), width: T.unsafe(nil)); end
  ...
  # ```
  #
  # source://playwright-ruby-client//lib/playwright_api/page.rb#1056
  def press(selector, key, delay: T.unsafe(nil), noWaitAfter: T.unsafe(nil), strict: T.unsafe(nil), timeout: T.unsafe(nil)); end

  # The method finds an element matching the specified selector within the page. If no elements match the selector, the
  # return value resolves to `null`. To wait for an element on the page, use [`method: Locator.waitFor`].
  #
  # source://playwright-ruby-client//lib/playwright_api/page.rb#1069
  def query_selector(selector, strict: T.unsafe(nil)); end
  ...
  #
  # source://playwright-ruby-client//lib/playwright_api/page.rb#62
  def request; end
  ...
  # **NOTE**: Enabling routing disables http cache.
  #
  # source://playwright-ruby-client//lib/playwright_api/page.rb#1134
  def route(url, handler, times: T.unsafe(nil)); end
  ...
  # Playwright will not serve requests intercepted by Service Worker from the HAR file. See [this](https://github.com/microsoft/playwright/issues/1090) issue. We recommend disabling Service Workers when using request interception by setting `Browser.newContext.serviceWorkers` to `'block'`.
  #
  # source://playwright-ruby-client//lib/playwright_api/page.rb#1142
  def route_from_har(har, notFound: T.unsafe(nil), update: T.unsafe(nil), updateContent: T.unsafe(nil), updateMode: T.unsafe(nil), url: T.unsafe(nil)); end
  ...
  # ```
  #
  # source://playwright-ruby-client//lib/playwright_api/page.rb#1189
  def select_option(selector, element: T.unsafe(nil), index: T.unsafe(nil), value: T.unsafe(nil), label: T.unsafe(nil), force: T.unsafe(nil), noWaitAfter: T.unsafe(nil), strict: T.unsafe(nil), timeout: T.unsafe(nil)); end
  ...
  # `TimeoutError`. Passing zero timeout disables this.
  #
  # source://playwright-ruby-client//lib/playwright_api/page.rb#1215
  def set_checked(selector, checked, force: T.unsafe(nil), noWaitAfter: T.unsafe(nil), position: T.unsafe(nil), strict: T.unsafe(nil), timeout: T.unsafe(nil), trial: T.unsafe(nil)); end
  ...
  # [input element](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/input). However, if the element is inside the `<label>` element that has an associated [control](https://developer.mozilla.org/en-US/docs/Web/API/HTMLLabelElement/control), targets the control instead.
  #
  # source://playwright-ruby-client//lib/playwright_api/page.rb#1275
  def set_input_files(selector, files, noWaitAfter: T.unsafe(nil), strict: T.unsafe(nil), timeout: T.unsafe(nil)); end
  ...
  # source://playwright-ruby-client//lib/playwright_api/page.rb#1687
  def start_css_coverage(resetOnNavigation: T.unsafe(nil), reportAnonymousScripts: T.unsafe(nil)); end

  # source://playwright-ruby-client//lib/playwright_api/page.rb#1682
  def start_js_coverage(resetOnNavigation: T.unsafe(nil), reportAnonymousScripts: T.unsafe(nil)); end

  # source://playwright-ruby-client//lib/playwright_api/page.rb#1692
  def stop_css_coverage; end

  # source://playwright-ruby-client//lib/playwright_api/page.rb#1677
  def stop_js_coverage; end
  ...
  #
  # source://playwright-ruby-client//lib/playwright_api/page.rb#1315
  def tap_point(selector, force: T.unsafe(nil), modifiers: T.unsafe(nil), noWaitAfter: T.unsafe(nil), position: T.unsafe(nil), strict: T.unsafe(nil), timeout: T.unsafe(nil), trial: T.unsafe(nil)); end

  # Returns `element.textContent`.
  #
  # source://playwright-ruby-client//lib/playwright_api/page.rb#1329
  def text_content(selector, strict: T.unsafe(nil), timeout: T.unsafe(nil)); end

  # Returns the page's title.
  #
  # source://playwright-ruby-client//lib/playwright_api/page.rb#1335
  def title; end

  # property
  #
  # source://playwright-ruby-client//lib/playwright_api/page.rb#66
  def touchscreen; end
  ...
  # **Usage**
  #
  # source://playwright-ruby-client//lib/playwright_api/page.rb#1346
  def type(selector, text, delay: T.unsafe(nil), noWaitAfter: T.unsafe(nil), strict: T.unsafe(nil), timeout: T.unsafe(nil)); end
  ...
  # `TimeoutError`. Passing zero timeout disables this.
  #
  # source://playwright-ruby-client//lib/playwright_api/page.rb#1368
  def uncheck(selector, force: T.unsafe(nil), noWaitAfter: T.unsafe(nil), position: T.unsafe(nil), strict: T.unsafe(nil), timeout: T.unsafe(nil), trial: T.unsafe(nil)); end

  # Removes a route created with [`method: Page.route`]. When `handler` is not specified, removes all routes for
  # the `url`.
  #
  # source://playwright-ruby-client//lib/playwright_api/page.rb#1382
  def unroute(url, handler: T.unsafe(nil)); end

  # source://playwright-ruby-client//lib/playwright_api/page.rb#1386
  def url; end

  # Video object associated with this page.
  #
  # source://playwright-ruby-client//lib/playwright_api/page.rb#1392
  def video; end

  # source://playwright-ruby-client//lib/playwright_api/page.rb#1396
  def viewport_size; end
  ...
  # @return [Boolean]
  #
  # source://playwright-ruby-client//lib/playwright_api/page.rb#913
  def visible?(selector, strict: T.unsafe(nil), timeout: T.unsafe(nil)); end
  ...
  # @raise [NotImplementedError]
  #
  # source://playwright-ruby-client//lib/playwright_api/page.rb#1672
  def wait_for_event(event, predicate: T.unsafe(nil), timeout: T.unsafe(nil)); end
  ...
  # ```
  #
  # source://playwright-ruby-client//lib/playwright_api/page.rb#1467
  def wait_for_function(expression, arg: T.unsafe(nil), polling: T.unsafe(nil), timeout: T.unsafe(nil)); end
  ...
  # ```
  #
  # source://playwright-ruby-client//lib/playwright_api/page.rb#1492
  def wait_for_load_state(state: T.unsafe(nil), timeout: T.unsafe(nil)); end
  ...
  # ```
  #
  # source://playwright-ruby-client//lib/playwright_api/page.rb#1608
  def wait_for_selector(selector, state: T.unsafe(nil), strict: T.unsafe(nil), timeout: T.unsafe(nil)); end
  ...
  # ```
  #
  # source://playwright-ruby-client//lib/playwright_api/page.rb#1624
  def wait_for_timeout(timeout); end
  ...
  # ```
  #
  # source://playwright-ruby-client//lib/playwright_api/page.rb#1637
  def wait_for_url(url, timeout: T.unsafe(nil), waitUntil: T.unsafe(nil)); end
  ...
  # source://playwright-ruby-client//lib/playwright_api/page.rb#1724
  def event_emitter_proxy; end
end
...
class Playwright::Route < ::Playwright::PlaywrightApi
  ...
  #
  # source://playwright-ruby-client//lib/playwright_api/route.rb#36
  def continue(headers: T.unsafe(nil), method: T.unsafe(nil), postData: T.unsafe(nil), url: T.unsafe(nil)); end
  ...
  # ```
  #
  # source://playwright-ruby-client//lib/playwright_api/route.rb#94
  def fallback(headers: T.unsafe(nil), method: T.unsafe(nil), postData: T.unsafe(nil), url: T.unsafe(nil)); end
  ...
  #
  # source://playwright-ruby-client//lib/playwright_api/route.rb#117
  def fetch(headers: T.unsafe(nil), maxRedirects: T.unsafe(nil), method: T.unsafe(nil), postData: T.unsafe(nil), timeout: T.unsafe(nil), url: T.unsafe(nil)); end
  ...
  # ```
  #
  # source://playwright-ruby-client//lib/playwright_api/route.rb#146
  ...
  # -- inherited from EventEmitter --
  #
  # source://playwright-ruby-client//lib/playwright_api/route.rb#170
  def off(event, callback); end

  # -- inherited from EventEmitter --
  #
  # source://playwright-ruby-client//lib/playwright_api/route.rb#182
  def on(event, callback); end

  # -- inherited from EventEmitter --
  #
  # source://playwright-ruby-client//lib/playwright_api/route.rb#176
  def once(event, callback); end

  # source://playwright-ruby-client//lib/playwright_api/route.rb#164
  def redirect_navigation_request(url); end

  # A request to be routed.
  #
  # source://playwright-ruby-client//lib/playwright_api/route.rb#159
  def request; end

  private

  # source://playwright-ruby-client//lib/playwright_api/route.rb#186
  def event_emitter_proxy; end
end
...
#
# source://playwright-ruby-client//lib/playwright_api/touchscreen.rb#5
class Playwright::Touchscreen < ::Playwright::PlaywrightApi
  # Dispatches a `touchstart` and `touchend` event with a single touch at the position (`x`,`y`).
  #
  # **NOTE**: [`method: Page.tap`] the method will throw if `hasTouch` option of the browser context is false.
  #
  # source://playwright-ruby-client//lib/playwright_api/touchscreen.rb#11
...
class Playwright::Tracing < ::Playwright::PlaywrightApi
  # -- inherited from EventEmitter --
  #
  # source://playwright-ruby-client//lib/playwright_api/tracing.rb#75
  def off(event, callback); end

  # -- inherited from EventEmitter --
  #
  # source://playwright-ruby-client//lib/playwright_api/tracing.rb#87
  def on(event, callback); end

  # -- inherited from EventEmitter --
  #
  # source://playwright-ruby-client//lib/playwright_api/tracing.rb#81
  def once(event, callback); end
  ...
  # Stop tracing.
  #
  # source://playwright-ruby-client//lib/playwright_api/tracing.rb#63
  def stop(path: T.unsafe(nil)); end

  # Stop the trace chunk. See [`method: Tracing.startChunk`] for more details about multiple trace chunks.
  #
  # source://playwright-ruby-client//lib/playwright_api/tracing.rb#69
  def stop_chunk(path: T.unsafe(nil)); end

  private

  # source://playwright-ruby-client//lib/playwright_api/tracing.rb#91
  def event_emitter_proxy; end
end
...
class Playwright::Transport
  ...
  #
  # source://playwright-ruby-client//lib/playwright/transport.rb#48
  def async_run; end
  ...
  # @param message [Hash]
  #
  # source://playwright-ruby-client//lib/playwright/transport.rb#28
  def send_message(message); end

  # Terminate playwright-cli driver.
  #
  # source://playwright-ruby-client//lib/playwright/transport.rb#40
  def stop; end
  ...
  # source://playwright-ruby-client//lib/playwright/transport.rb#111
  def debug_send_message(message); end

  # source://playwright-ruby-client//lib/playwright/transport.rb#88
  def handle_stderr; end

  # source://playwright-ruby-client//lib/playwright/transport.rb#70
  def handle_stdout(packet_size: T.unsafe(nil)); end

  # source://playwright-ruby-client//lib/playwright/transport.rb#58
  def run_driver_with_open3; end

  # source://playwright-ruby-client//lib/playwright/transport.rb#121
...
# source://playwright-ruby-client//lib/playwright/utils.rb#2
module Playwright::Utils; end

# source://playwright-ruby-client//lib/playwright/utils.rb#72
module Playwright::Utils::Errors; end

# source://playwright-ruby-client//lib/playwright/utils.rb#73
module Playwright::Utils::Errors::TargetClosedErrorMethods
  ...
  # @return [Boolean]
  #
  # source://playwright-ruby-client//lib/playwright/utils.rb#75
  def target_closed_error?(err); end
end

# source://playwright-ruby-client//lib/playwright/utils.rb#3
module Playwright::Utils::PrepareBrowserContextOptions
  private

  # @see https://github.com/microsoft/playwright/blob/5a2cfdbd47ed3c3deff77bb73e5fac34241f649d/src/client/browserContext.ts#L265
  #
  # source://playwright-ruby-client//lib/playwright/utils.rb#35
...
class Playwright::Waiter
  ...
  #
  # source://playwright-ruby-client//lib/playwright/waiter.rb#114
  def result; end

  # @param [Playwright::EventEmitter]
  # @param
  #
  # source://playwright-ruby-client//lib/playwright/waiter.rb#98
  ...
  #
  # source://playwright-ruby-client//lib/playwright/waiter.rb#135
  def format_log_recording(logs); end

  # source://playwright-ruby-client//lib/playwright/waiter.rb#78
  def fulfill(result); end

  # source://playwright-ruby-client//lib/playwright/waiter.rb#86
...
#
# source://playwright-ruby-client//lib/playwright_api/web_socket.rb#4
class Playwright::WebSocket < ::Playwright::PlaywrightApi
  # Indicates that the web socket has been closed.
  #
  # @return [Boolean]
  #
  # source://playwright-ruby-client//lib/playwright_api/web_socket.rb#8
  def closed?; end

  # Waits for event to fire and passes its value into the predicate function. Returns when the predicate returns truthy
  # value. Will throw an error if the webSocket is closed before the event is fired. Returns the event data value.
  #
  # source://playwright-ruby-client//lib/playwright_api/web_socket.rb#21
  def expect_event(event, predicate: T.unsafe(nil), timeout: T.unsafe(nil), &block); end

  # -- inherited from EventEmitter --
  #
  # source://playwright-ruby-client//lib/playwright_api/web_socket.rb#37
  def off(event, callback); end

  # -- inherited from EventEmitter --
  #
  # source://playwright-ruby-client//lib/playwright_api/web_socket.rb#49
  def on(event, callback); end

  # -- inherited from EventEmitter --
  #
  # source://playwright-ruby-client//lib/playwright_api/web_socket.rb#43
  def once(event, callback); end

  # Contains the URL of the WebSocket.
  #
  # source://playwright-ruby-client//lib/playwright_api/web_socket.rb#14
  def url; end
  ...
  #
  # source://playwright-ruby-client//lib/playwright_api/web_socket.rb#31
  def wait_for_event(event, predicate: T.unsafe(nil), timeout: T.unsafe(nil), &block); end

  private

  # source://playwright-ruby-client//lib/playwright_api/web_socket.rb#53
  def event_emitter_proxy; end
end
