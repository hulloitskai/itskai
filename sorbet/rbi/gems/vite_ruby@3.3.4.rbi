...
class ViteRuby::CLI::Build < ::ViteRuby::CLI::Vite
  # source://vite_rails/3.0.15/lib/vite_rails/cli.rb#9
...
class ViteRuby::CLI::Install < ::Dry::CLI::Command
  ...
  #
  # source://vite_rails/3.0.15/lib/vite_rails/cli.rb#60
  def install_sample_files; end

  # Internal: Setup for a plain Rack application.
  #
  # source://vite_rails/3.0.15/lib/vite_rails/cli.rb#28
...
class ViteRuby::Config
  ...
  class << self
    ...
    #
    # source://vite_rails/3.0.15/lib/vite_rails/config.rb#7
