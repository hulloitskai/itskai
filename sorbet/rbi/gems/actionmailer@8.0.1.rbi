...
class ActionMailer::Base < ::AbstractController::Base
  ...
  class << self
    ...
    # source://activesupport/8.0.1/lib/active_support/class_attribute.rb#15
    def __class_attr_mailjet_api_settings; end

    # source://activesupport/8.0.1/lib/active_support/class_attribute.rb#17
    def __class_attr_mailjet_api_settings=(new_value); end

    # source://activesupport/8.0.1/lib/active_support/class_attribute.rb#15
    def __class_attr_mailjet_settings; end

    # source://activesupport/8.0.1/lib/active_support/class_attribute.rb#17
    def __class_attr_mailjet_settings=(new_value); end
...
module ActionMailer::Base::HelperMethods
  ...
  # source://actionpack/8.0.1/lib/abstract_controller/caching/fragments.rb#34
  def combined_fragment_cache_key(*_arg0, **_arg1, &_arg2); end

  # source://actionpack/8.0.1/lib/abstract_controller/caching.rb#45
