...
class GraphQL::Query
  # source://graphql/2.0.15/lib/graphql/query.rb#86
  ...
  # source://graphql/2.0.15/lib/graphql/query.rb#293
  ...
  # source://graphql/2.0.15/lib/graphql/query.rb#246
  def arguments_cache; end

  # source://graphql/2.0.15/lib/graphql/query.rb#242
  ...
  # source://graphql/2.0.15/lib/graphql/query.rb#51
  def document; end

  # source://graphql/2.0.15/lib/graphql/query.rb#204
  def executed?; end

  # source://graphql/2.0.15/lib/graphql/query.rb#272
  def fingerprint; end

  # source://graphql/2.0.15/lib/graphql/query.rb#187
  def fragments; end
  ...
  # source://graphql/2.0.15/lib/graphql/query.rb#343
  def handle_or_reraise(err); end

  # source://graphql/2.0.15/lib/graphql/query.rb#60
  def inspect; end

  # source://graphql/2.0.15/lib/graphql/query.rb#154
  def interpreter?; end

  # source://graphql/2.0.15/lib/graphql/query.rb#166
  def lookahead; end
  ...
  # source://graphql/2.0.15/lib/graphql/query.rb#329
  def merge_filters(only: T.unsafe(nil), except: T.unsafe(nil)); end

  # source://graphql/2.0.15/lib/graphql/query.rb#158
  def multiplex; end

  # source://graphql/2.0.15/lib/graphql/query.rb#158
  def multiplex=(_arg0); end

  # source://graphql/2.0.15/lib/graphql/query.rb#320
  def mutation?; end

  # source://graphql/2.0.15/lib/graphql/query.rb#277
  def operation_fingerprint; end

  # source://graphql/2.0.15/lib/graphql/query.rb#34
  def operation_name; end

  # source://graphql/2.0.15/lib/graphql/query.rb#34
  def operation_name=(_arg0); end

  # source://graphql/2.0.15/lib/graphql/query.rb#191
  def operations; end
  ...
  # source://graphql/2.0.15/lib/graphql/query.rb#324
  def query?; end

  # source://graphql/2.0.15/lib/graphql/query.rb#150
  def query_string; end

  # source://graphql/2.0.15/lib/graphql/query.rb#48
  def query_string=(_arg0); end

  # source://graphql/2.0.15/lib/graphql/query.rb#308
  def resolve_type(abstract_type, value = T.unsafe(nil)); end

  # source://graphql/2.0.15/lib/graphql/query.rb#197
  def result; end

  # source://graphql/2.0.15/lib/graphql/query.rb#185
  def result_values; end

  # source://graphql/2.0.15/lib/graphql/query.rb#175
  def result_values=(result_hash); end

  # source://forwardable/1.3.2/forwardable.rb#229
  def root_type_for_operation(*args, **_arg1, &block); end

  # source://graphql/2.0.15/lib/graphql/query.rb#31
  def root_value; end

  # source://graphql/2.0.15/lib/graphql/query.rb#31
  def root_value=(_arg0); end

  # source://graphql/2.0.15/lib/graphql/query.rb#254
  def sanitized_query_string(inline_variables: T.unsafe(nil)); end

  # source://graphql/2.0.15/lib/graphql/query.rb#28
  def schema; end

  # source://graphql/2.0.15/lib/graphql/query.rb#215
  def selected_operation; end

  # source://graphql/2.0.15/lib/graphql/query.rb#65
  def selected_operation_name; end

  # source://graphql/2.0.15/lib/graphql/query.rb#208
  def static_errors; end

  # source://graphql/2.0.15/lib/graphql/query.rb#338
  def subscription?; end

  # source://graphql/2.0.15/lib/graphql/query.rb#71
  def subscription_topic; end

  # source://graphql/2.0.15/lib/graphql/query.rb#160
  def subscription_update?; end

  # source://graphql/2.0.15/lib/graphql/query.rb#73
  def tracers; end

  # source://graphql/2.0.15/lib/graphql/query.rb#294
  def valid?; end

  # source://graphql/2.0.15/lib/graphql/query.rb#37
  def validate; end

  # source://graphql/2.0.15/lib/graphql/query.rb#40
  def validate=(new_validate); end

  # source://forwardable/1.3.2/forwardable.rb#229
  def validation_errors(*args, **_arg1, &block); end

  # source://graphql/2.0.15/lib/graphql/query.rb#286
  def validation_pipeline; end

  # source://graphql/2.0.15/lib/graphql/query.rb#225
  def variables; end

  # source://graphql/2.0.15/lib/graphql/query.rb#282
  def variables_fingerprint; end

  # source://graphql/2.0.15/lib/graphql/query.rb#298
  def warden; end

  private

  # source://graphql/2.0.15/lib/graphql/query.rb#349
  def find_operation(operations, operation_name); end

  # source://graphql/2.0.15/lib/graphql/query.rb#423
