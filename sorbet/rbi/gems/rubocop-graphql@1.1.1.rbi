...
#   end
#
# source://rubocop-graphql//lib/rubocop/cop/graphql/not_authorized_node_type.rb#45
class RuboCop::Cop::GraphQL::NotAuthorizedNodeType < ::RuboCop::Cop::Base
  # source://rubocop-graphql//lib/rubocop/cop/graphql/not_authorized_node_type.rb#58
  ...
  # source://rubocop-graphql//lib/rubocop/cop/graphql/not_authorized_node_type.rb#62
  def on_class(node); end
end

# source://rubocop-graphql//lib/rubocop/cop/graphql/not_authorized_node_type.rb#46
...
class RuboCop::Cop::GraphQL::OrderedFields < ::RuboCop::Cop::Base
  ...
  # source://rubocop-graphql//lib/rubocop/cop/graphql/ordered_fields.rb#43
  def field_declarations(param0); end

  # source://rubocop-graphql//lib/rubocop/cop/graphql/ordered_fields.rb#51
  def on_class(node); end

  private

  # source://rubocop-graphql//lib/rubocop/cop/graphql/ordered_fields.rb#62
  def consecutive_fields(previous, current); end

  # source://rubocop-graphql//lib/rubocop/cop/graphql/ordered_fields.rb#82
  def field_name(node); end

  # source://rubocop-graphql//lib/rubocop/cop/graphql/ordered_fields.rb#70
  def register_offense(previous, current); end
end
...
class RuboCop::Cop::GraphQL::UnnecessaryFieldAlias < ::RuboCop::Cop::Base
  ...
  # source://rubocop-graphql//lib/rubocop/cop/graphql/unnecessary_field_alias.rb#41
