...
# source://rails-dom-testing//lib/rails/dom/testing/assertions/selector_assertions/html_selector.rb#6
class HTMLSelector
  include ::Minitest::Assertions

  # @return [HTMLSelector] a new instance of HTMLSelector
  #
  # source://rails-dom-testing//lib/rails/dom/testing/assertions/selector_assertions/html_selector.rb#11
  def initialize(values, previous_selection = T.unsafe(nil), &root_fallback); end

  # source://rails-dom-testing//lib/rails/dom/testing/assertions/selector_assertions/html_selector.rb#41
  def context; end
  ...
  # @return [Boolean]
  #
  # source://rails-dom-testing//lib/rails/dom/testing/assertions/selector_assertions/html_selector.rb#27
  ...
  # source://rails-dom-testing//lib/rails/dom/testing/assertions/selector_assertions/html_selector.rb#95
  def extract_equality_tests; end

  # source://rails-dom-testing//lib/rails/dom/testing/assertions/selector_assertions/html_selector.rb#67
  def extract_root(previous_selection, root_fallback); end

  # source://rails-dom-testing//lib/rails/dom/testing/assertions/selector_assertions/html_selector.rb#84
  def extract_selectors; end

  # source://rails-dom-testing//lib/rails/dom/testing/assertions/selector_assertions/html_selector.rb#43
...
# source://rails-dom-testing//lib/rails/dom/testing/assertions/dom_assertions.rb#1
module Rails
  class << self
...
# source://rails-dom-testing//lib/rails/dom/testing/assertions/dom_assertions.rb#2
...
module Rails::Dom::Testing::Assertions::DomAssertions
  ...
  # @return [Boolean]
  #
  # source://rails-dom-testing//lib/rails/dom/testing/assertions/dom_assertions.rb#81
  ...
  # @return [Boolean]
  #
  # source://rails-dom-testing//lib/rails/dom/testing/assertions/dom_assertions.rb#60
  def equal_child?(child, other_child, strict); end

  # @return [Boolean]
  #
  # source://rails-dom-testing//lib/rails/dom/testing/assertions/dom_assertions.rb#48
  def equal_children?(child, other_child, strict); end

  # source://rails-dom-testing//lib/rails/dom/testing/assertions/dom_assertions.rb#40
...
#
# source://rails-dom-testing//lib/rails/dom/testing/assertions/selector_assertions/count_describable.rb#5
module Rails::Dom::Testing::Assertions::SelectorAssertions
  ...
  #  end
  #
  # source://rails-dom-testing//lib/rails/dom/testing/assertions/selector_assertions.rb#251
  ...
  #   end
  #
  # source://rails-dom-testing//lib/rails/dom/testing/assertions/selector_assertions.rb#214
  ...
  #
  # source://rails-dom-testing//lib/rails/dom/testing/assertions/selector_assertions.rb#275
  def assert_size_match!(size, equals, css_selector, message = T.unsafe(nil)); end

  # @raise [NotImplementedError]
  #
  # source://rails-dom-testing//lib/rails/dom/testing/assertions/selector_assertions.rb#269
  def document_root_element; end

  # source://rails-dom-testing//lib/rails/dom/testing/assertions/selector_assertions.rb#287
  def nest_selection(selection); end

  # source://rails-dom-testing//lib/rails/dom/testing/assertions/selector_assertions.rb#296
  def nodeset(node); end
end

# source://rails-dom-testing//lib/rails/dom/testing/assertions/selector_assertions/count_describable.rb#6
module Rails::Dom::Testing::Assertions::SelectorAssertions::CountDescribable
  ...
  # source://rails-dom-testing//lib/rails/dom/testing/assertions/selector_assertions/count_describable.rb#20
...
class SubstitutionContext
  ...
  # source://rails-dom-testing//lib/rails/dom/testing/assertions/selector_assertions/substitution_context.rb#18
  def matcher_for(value, format_for_presentation); end

  # @return [Boolean]
  #
  # source://rails-dom-testing//lib/rails/dom/testing/assertions/selector_assertions/substitution_context.rb#27
