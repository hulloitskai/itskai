...
class MemoryProfiler::Reporter
  ...
  #
  # source://memory_profiler//lib/memory_profiler/reporter.rb#71
  def run(&block); end

  # source://memory_profiler//lib/memory_profiler/reporter.rb#36
  def start; end

  # source://memory_profiler//lib/memory_profiler/reporter.rb#46
  def stop; end
  ...
  #
  # source://memory_profiler//lib/memory_profiler/reporter.rb#88
...
class MemoryProfiler::Results
  ...
  #
  # source://memory_profiler//lib/memory_profiler/results.rb#113
  def pretty_print(io = T.unsafe(nil), **options); end

  # source://memory_profiler//lib/memory_profiler/results.rb#150
  def print_string_reports(io, options); end

  # source://memory_profiler//lib/memory_profiler/results.rb#41
  ...
  # source://memory_profiler//lib/memory_profiler/results.rb#67
  def scale_bytes(bytes); end

  # source://memory_profiler//lib/memory_profiler/results.rb#75
  def string_report(data, top); end

  # Returns the value of attribute strings_allocated.
  #
  # source://memory_profiler//lib/memory_profiler/results.rb#37
  ...
  #
  # source://memory_profiler//lib/memory_profiler/results.rb#38
  ...
  #
  # source://memory_profiler//lib/memory_profiler/results.rb#39
  ...
  # source://memory_profiler//lib/memory_profiler/results.rb#215
  def dump_strings(io, type, options); end

  # source://memory_profiler//lib/memory_profiler/results.rb#191
  def print_output(io, topic, detail); end

  # source://memory_profiler//lib/memory_profiler/results.rb#185
  def print_title(io, title); end

  # source://memory_profiler//lib/memory_profiler/results.rb#177
