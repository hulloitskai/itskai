...
module OmniAuth::Strategy
  ...
  # source://omniauth//lib/omniauth/strategy.rb#533
  ...
  # source://omniauth//lib/omniauth/strategy.rb#512
  def name; end
  ...
  # source://omniauth//lib/omniauth/strategy.rb#516
  def redirect(uri); end

  # source://omniauth//lib/omniauth/strategy.rb#508
  def request; end
  ...
  # source://omniauth//lib/omniauth/strategy.rb#529
  def user_info; end
  ...
  # source://omniauth//lib/omniauth/strategy.rb#556
  def merge_stack(stack); end

  # @return [Boolean]
  #
  # source://omniauth//lib/omniauth/strategy.rb#563
  def ssl?; end

  private

  # source://omniauth//lib/omniauth/strategy.rb#551
...
# source://omniauth//lib/omniauth/strategy.rb#547
