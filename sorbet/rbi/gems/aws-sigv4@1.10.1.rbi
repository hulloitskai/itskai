...
module Aws
  class << self
    # source://aws-sdk-core/3.212.0/lib/aws-sdk-core.rb#93
    def config; end

    # source://aws-sdk-core/3.212.0/lib/aws-sdk-core.rb#96
    def config=(config); end

    # source://aws-sdk-core/3.212.0/lib/aws-sdk-core.rb#155
    def eager_autoload!(*args); end

    # source://aws-sdk-core/3.212.0/lib/aws-sdk-core.rb#148
    def empty_connection_pools!; end

    # source://aws-sdk-core/3.212.0/lib/aws-sdk-core.rb#105
    def partition(partition_name); end

    # source://aws-sdk-core/3.212.0/lib/aws-sdk-core.rb#110
    def partitions; end

    # source://aws-sdk-core/3.212.0/lib/aws-sdk-core.rb#86
    def shared_config; end

    # source://aws-sdk-core/3.212.0/lib/aws-sdk-core.rb#125
...
class Aws::Sigv4::Signer
  ...
  #
  # source://aws-sigv4//lib/aws-sigv4/signer.rb#135
  def initialize(options = T.unsafe(nil)); end
  ...
  #   * `#set?` => Boolean
  #
  # source://aws-sigv4//lib/aws-sigv4/signer.rb#165
  ...
  #
  # source://aws-sigv4//lib/aws-sigv4/signer.rb#413
  def presign_url(options); end

  # @return [String]
  #
  # source://aws-sigv4//lib/aws-sigv4/signer.rb#154
  def region; end

  # @return [String]
  #
  # source://aws-sigv4//lib/aws-sigv4/signer.rb#151
  def service; end
  ...
  #
  # source://aws-sigv4//lib/aws-sigv4/signer.rb#327
  ...
  #
  # source://aws-sigv4//lib/aws-sigv4/signer.rb#222
  ...
  # source://aws-sigv4//lib/aws-sigv4/signer.rb#543
  ...
  #
  # source://aws-sigv4//lib/aws-sigv4/signer.rb#562
  ...
  #
  # source://aws-sigv4//lib/aws-sigv4/signer.rb#508
  def event_string_to_sign(datetime, headers, payload, prior_signature, encoder); end

  # source://aws-sigv4//lib/aws-sigv4/signer.rb#688
  def extract_credentials_provider(options); end

  # source://aws-sigv4//lib/aws-sigv4/signer.rb#723
  def extract_expires_in(options); end

  # source://aws-sigv4//lib/aws-sigv4/signer.rb#698
  def extract_http_method(request); end

  # source://aws-sigv4//lib/aws-sigv4/signer.rb#680
  def extract_region(options); end

  # source://aws-sigv4//lib/aws-sigv4/signer.rb#671
  def extract_service(options); end

  # source://aws-sigv4//lib/aws-sigv4/signer.rb#707
  def extract_url(request); end

  # source://aws-sigv4//lib/aws-sigv4/signer.rb#741
  def fetch_credentials; end

  # source://aws-sigv4//lib/aws-sigv4/signer.rb#667
  def hexhmac(key, value); end

  # source://aws-sigv4//lib/aws-sigv4/signer.rb#663
  def hmac(key, value); end

  # source://aws-sigv4//lib/aws-sigv4/signer.rb#635
  def host(uri); end

  # source://aws-sigv4//lib/aws-sigv4/signer.rb#580
  def normalized_querystring(querystring); end

  # source://aws-sigv4//lib/aws-sigv4/signer.rb#570
  def path(url); end

  # source://aws-sigv4//lib/aws-sigv4/signer.rb#766
  ...
  # source://aws-sigv4//lib/aws-sigv4/signer.rb#535
  def signature(secret_access_key, date, string_to_sign); end

  # source://aws-sigv4//lib/aws-sigv4/signer.rb#609
  def signed_headers(headers); end

  # source://aws-sigv4//lib/aws-sigv4/signer.rb#490
  def string_to_sign(datetime, canonical_request, algorithm); end

  # source://aws-sigv4//lib/aws-sigv4/signer.rb#475
  def sts_algorithm; end

  # source://aws-sigv4//lib/aws-sigv4/signer.rb#733
  ...
  class << self
    # @api private
    #
    # source://aws-sigv4//lib/aws-sigv4/signer.rb#804
    ...
    # @api private
    #
    # source://aws-sigv4//lib/aws-sigv4/signer.rb#790
    ...
    # @return [Boolean]
    #
    # source://aws-sigv4//lib/aws-sigv4/signer.rb#785
    def use_crt?; end
  end
end
