...
module Faraday
  class << self
    # source://faraday/2.7.1/lib/faraday.rb#55
    def default_adapter; end

    # source://faraday/2.7.1/lib/faraday.rb#102
    def default_adapter=(adapter); end

    # source://faraday/2.7.1/lib/faraday.rb#59
    def default_adapter_options; end

    # source://faraday/2.7.1/lib/faraday.rb#59
    def default_adapter_options=(_arg0); end

    # source://faraday/2.7.1/lib/faraday.rb#120
    def default_connection; end

    # source://faraday/2.7.1/lib/faraday.rb#62
    def default_connection=(_arg0); end

    # source://faraday/2.7.1/lib/faraday.rb#127
    def default_connection_options; end

    # source://faraday/2.7.1/lib/faraday.rb#134
    def default_connection_options=(options); end

    # source://faraday/2.7.1/lib/faraday.rb#67
    def ignore_env_proxy; end

    # source://faraday/2.7.1/lib/faraday.rb#67
    def ignore_env_proxy=(_arg0); end

    # source://faraday/2.7.1/lib/faraday.rb#46
    def lib_path; end

    # source://faraday/2.7.1/lib/faraday.rb#46
    def lib_path=(_arg0); end

    # source://faraday/2.7.1/lib/faraday.rb#96
    def new(url = T.unsafe(nil), options = T.unsafe(nil), &block); end

    # source://faraday/2.7.1/lib/faraday.rb#107
    def respond_to_missing?(symbol, include_private = T.unsafe(nil)); end

    # source://faraday/2.7.1/lib/faraday.rb#42
    def root_path; end
    ...
    # source://faraday/2.7.1/lib/faraday.rb#143
...
class Faraday::Adapter
  # source://faraday/2.7.1/lib/faraday/adapter.rb#28
  def initialize(_app = T.unsafe(nil), opts = T.unsafe(nil), &block); end

  # source://faraday/2.7.1/lib/faraday/adapter.rb#55
  def call(env); end

  # source://faraday/2.7.1/lib/faraday/adapter.rb#50
  def close; end

  # source://faraday/2.7.1/lib/faraday/adapter.rb#41
  def connection(env); end

  private

  # source://faraday/2.7.1/lib/faraday/adapter.rb#86
  def request_timeout(type, options); end

  # source://faraday/2.7.1/lib/faraday/adapter.rb#62
  def save_response(env, status, body, headers = T.unsafe(nil), reason_phrase = T.unsafe(nil), finished: T.unsafe(nil)); end
end

# source://faraday/2.7.1/lib/faraday/adapter.rb#9
...
# source://faraday/2.7.1/lib/faraday/adapter.rb#94
Faraday::Adapter::TIMEOUT_KEYS = T.let(T.unsafe(nil), Hash)

# source://faraday/2.7.1/lib/faraday.rb#34
Faraday::CONTENT_TYPE = T.let(T.unsafe(nil), String)

# source://faraday/2.7.1/lib/faraday/methods.rb#5
Faraday::METHODS_WITH_BODY = T.let(T.unsafe(nil), Array)

# source://faraday/2.7.1/lib/faraday/methods.rb#4
...
# source://faraday/2.7.1/lib/faraday/version.rb#4
