...
module GraphQL
  class << self
    # source://graphql/2.1.6/lib/graphql.rb#35
    def default_parser; end

    # source://graphql/2.1.6/lib/graphql.rb#39
    def default_parser=(_arg0); end

    # source://graphql/2.1.6/lib/graphql.rb#45
    def parse(graphql_string, trace: T.unsafe(nil)); end

    # source://graphql/2.1.6/lib/graphql.rb#52
    def parse_file(filename); end

    # source://graphql/2.1.6/lib/graphql.rb#62
    def parse_with_racc(string, filename: T.unsafe(nil), trace: T.unsafe(nil)); end

    # source://graphql/2.1.6/lib/graphql.rb#58
    def scan(graphql_string); end

    # source://graphql/2.1.6/lib/graphql.rb#66
...
class GraphQL::Connections::PrimaryKey::Base < ::GraphQL::Connections::Base
  ...
  # source://graphql-connections//lib/graphql/connections/primary_key/base.rb#42
  def cursor_for(item); end
  ...
  # @return [Boolean]
  #
  # source://graphql-connections//lib/graphql/connections/primary_key/base.rb#54
  def items_exist?(type:, search:, page_type:); end

  # @raise [NotImplementedError]
  #
  # source://graphql-connections//lib/graphql/connections/primary_key/base.rb#105
  def last_limited_sorted_table; end

  # source://graphql-connections//lib/graphql/connections/primary_key/base.rb#64
  def limited_relation; end
  ...
  # source://graphql-connections//lib/graphql/connections/primary_key/base.rb#87
  def sliced_relation; end
end
