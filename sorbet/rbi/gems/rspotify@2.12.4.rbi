...
module RSpotify
  class << self
    ...
    # source://rspotify//lib/rspotify/connection.rb#116
    def get_headers(params); end

    # @return [Boolean]
    #
    # source://rspotify//lib/rspotify/connection.rb#94
    def request_was_user_authenticated?(*params); end

    # Added this method for testing
    #
    # source://rspotify//lib/rspotify/connection.rb#90
...
class RSpotify::Playlist < ::RSpotify::Base
  ...
  #
  # source://rspotify//lib/rspotify/playlist.rb#155
  ...
  # @return [Playlist]
  #
  # source://rspotify//lib/rspotify/playlist.rb#193
  ...
  #
  # source://rspotify//lib/rspotify/playlist.rb#212
  def complete!; end
  ...
  #
  # source://rspotify//lib/rspotify/playlist.rb#229
  ...
  # @return [Playlist]
  #
  # source://rspotify//lib/rspotify/playlist.rb#308
  ...
  # @return [Playlist]
  #
  # source://rspotify//lib/rspotify/playlist.rb#349
  ...
  #
  # source://rspotify//lib/rspotify/playlist.rb#373
  ...
  #
  # source://rspotify//lib/rspotify/playlist.rb#393
  ...
  # @return [Array<Track>]
  #
  # source://rspotify//lib/rspotify/playlist.rb#258
  def tracks(limit: T.unsafe(nil), offset: T.unsafe(nil), market: T.unsafe(nil)); end
...
class RSpotify::User < ::RSpotify::Base
  ...
  #
  # source://rspotify//lib/rspotify/user.rb#94
  def initialize(options = T.unsafe(nil)); end
  ...
  # @return [Playlist]
  #
  # source://rspotify//lib/rspotify/user.rb#134
  ...
  # @return [Array<Device>]
  #
  # source://rspotify//lib/rspotify/user.rb#523
  def devices; end
  ...
  #
  # source://rspotify//lib/rspotify/user.rb#203
  ...
  # @return [Array<Artist>]
  #
  # source://rspotify//lib/rspotify/user.rb#238
  ...
  # @return [Array<Boolean>]
  #
  # source://rspotify//lib/rspotify/user.rb#257
  ...
  #   player = user.player
  #
  # source://rspotify//lib/rspotify/user.rb#151
  def player; end
  ...
  # @return [Array<Playlist>]
  #
  # source://rspotify//lib/rspotify/user.rb#281
  ...
  # @return [Array<Track>]
  #
  # source://rspotify//lib/rspotify/user.rb#171
  ...
  #
  # source://rspotify//lib/rspotify/user.rb#376
  ...
  #
  # source://rspotify//lib/rspotify/user.rb#299
  ...
  #
  # source://rspotify//lib/rspotify/user.rb#394
  ...
  #
  # source://rspotify//lib/rspotify/user.rb#317
  ...
  # @return [Array<Album>]
  #
  # source://rspotify//lib/rspotify/user.rb#413
  ...
  #
  # source://rspotify//lib/rspotify/user.rb#433
  ...
  # @return [Array<Track>]
  #
  # source://rspotify//lib/rspotify/user.rb#336
  ...
  #
  # source://rspotify//lib/rspotify/user.rb#359
  def saved_tracks?(tracks); end

  # Returns a hash containing all user attributes
  #
  # source://rspotify//lib/rspotify/user.rb#440
  def to_hash; end
  ...
  # @return [Array<Artist>]
  #
  # source://rspotify//lib/rspotify/user.rb#458
  ...
  # @return [Array<Track>]
  #
  # source://rspotify//lib/rspotify/user.rb#476
  ...
  # @return [Artist, Array<Artist>, User, Array<User>, Playlist]
  #
  # source://rspotify//lib/rspotify/user.rb#497
  ...
  class << self
    ...
    # source://rspotify//lib/rspotify/user.rb#89
    ...
    # source://rspotify//lib/rspotify/user.rb#74
