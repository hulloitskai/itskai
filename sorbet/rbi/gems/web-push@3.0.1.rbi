...
module WebPush
  class << self
    # source://web-push//lib/web_push.rb#58
    def decode64(str); end

    # source://web-push//lib/web_push.rb#54
    ...
    #
    # source://web-push//lib/web_push.rb#50
    ...
    # source://web-push//lib/web_push.rb#68
...
module WebPush::Encryption
  ...
  # @raise [ArgumentError]
  #
  # source://web-push//lib/web_push/encryption.rb#65
  def assert_arguments(message, p256dh, auth); end

  # @return [Boolean]
  #
  # source://web-push//lib/web_push/encryption.rb#71
  def blank?(value); end

  # source://web-push//lib/web_push/encryption.rb#61
  def convert16bit(key); end

  # source://web-push//lib/web_push/encryption.rb#48
