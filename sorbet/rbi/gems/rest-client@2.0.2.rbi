...
module RestClient
  class << self
    ...
    # @raise [ArgumentError]
    #
    # source://rest-client//lib/restclient.rb#170
    def add_before_execution_proc(&proc); end

    # source://rest-client//lib/restclient.rb#180
    def before_execution_procs; end

    # Create a log that respond to << like a logger
    # param can be 'stdout', 'stderr', a string (then we will log to that file) or a logger (then we return it)
    #
    # source://rest-client//lib/restclient.rb#123
    def create_log(param); end

    # source://rest-client//lib/restclient.rb#82
    def delete(url, headers = T.unsafe(nil), &block); end

    # source://rest-client//lib/restclient.rb#66
    def get(url, headers = T.unsafe(nil), &block); end

    # source://rest-client//lib/restclient.rb#86
    def head(url, headers = T.unsafe(nil), &block); end

    # source://rest-client//lib/restclient.rb#162
    def log; end
    ...
    #
    # source://rest-client//lib/restclient.rb#117
    def log=(log); end

    # source://rest-client//lib/restclient.rb#90
    def options(url, headers = T.unsafe(nil), &block); end

    # source://rest-client//lib/restclient.rb#74
    def patch(url, payload, headers = T.unsafe(nil), &block); end

    # source://rest-client//lib/restclient.rb#70
    ...
    #
    # source://rest-client//lib/restclient.rb#96
    def proxy; end

    # source://rest-client//lib/restclient.rb#100
    def proxy=(value); end
    ...
    # @return [Boolean]
    #
    # source://rest-client//lib/restclient.rb#110
    def proxy_set?; end

    # source://rest-client//lib/restclient.rb#78
    def put(url, payload, headers = T.unsafe(nil), &block); end

    # Reset the procs to be called before each request is executed.
    #
    # source://rest-client//lib/restclient.rb#176
...
module RestClient::AbstractResponse
  ...
  #
  # source://rest-client//lib/restclient/abstract_response.rb#66
  def cookie_jar; end
  ...
  # source://rest-client//lib/restclient/abstract_response.rb#112
  def description; end

  # Follow a redirection response, but change the HTTP method to GET and drop
  # the payload from the original request.
  #
  # source://rest-client//lib/restclient/abstract_response.rb#124
  def follow_get_redirection(&block); end

  # Follow a redirection response by making a new HTTP request to the
  # redirection target.
  #
  # source://rest-client//lib/restclient/abstract_response.rb#118
  def follow_redirection(&block); end

  # A hash of the headers, beautified with symbols and underscores.
  # e.g. "Content-type" will become :content_type.
  #
  # source://rest-client//lib/restclient/abstract_response.rb#25
  def headers; end
  ...
  def response_set_vars(net_http_res, request); end
  ...
  #
  # source://rest-client//lib/restclient/abstract_response.rb#87
  def return!(&block); end

  # source://rest-client//lib/restclient/abstract_response.rb#107
  def to_i; end
  ...
  #
  # source://rest-client//lib/restclient/abstract_response.rb#176
  def _follow_redirection(new_args, &block); end

  # source://rest-client//lib/restclient/abstract_response.rb#210
  def check_max_redirects; end

  # @raise [klass]
  #
  # source://rest-client//lib/restclient/abstract_response.rb#216
  ...
  class << self
    ...
    # @return [Hash]
    #
    # source://rest-client//lib/restclient/abstract_response.rb#153
...
# source://rest-client//lib/restclient/payload.rb#8
module RestClient::Payload
  extend ::RestClient::Payload

  # @return [Boolean]
  #
  # source://rest-client//lib/restclient/payload.rb#34
  def _has_file?(obj); end

  # source://rest-client//lib/restclient/payload.rb#11
  def generate(params); end

  # @return [Boolean]
  #
  # source://rest-client//lib/restclient/payload.rb#27
  def has_file?(params); end
end

# source://rest-client//lib/restclient/payload.rb#45
class RestClient::Payload::Base
  # @return [Base] a new instance of Base
  #
  # source://rest-client//lib/restclient/payload.rb#46
  def initialize(params); end

  # source://rest-client//lib/restclient/payload.rb#50
  def build_stream(params); end

  # source://rest-client//lib/restclient/payload.rb#75
  def close; end

  # source://rest-client//lib/restclient/payload.rb#65
  def headers; end

  # source://rest-client//lib/restclient/payload.rb#69
  def length; end

  # source://rest-client//lib/restclient/payload.rb#55
  def read(*args); end
...
class RestClient::Payload::Multipart < ::RestClient::Payload::Base
  # source://rest-client//lib/restclient/payload.rb#176
  def boundary; end

  # source://rest-client//lib/restclient/payload.rb#119
  def build_stream(params); end

  # source://rest-client//lib/restclient/payload.rb#204
  def close; end

  # source://rest-client//lib/restclient/payload.rb#156
  def create_file_field(s, k, v); end

  # source://rest-client//lib/restclient/payload.rb#149
  ...
  # source://rest-client//lib/restclient/payload.rb#200
  def headers; end

  # source://rest-client//lib/restclient/payload.rb#171
  def mime_for(path); end
end

# source://rest-client//lib/restclient/payload.rb#117
...
class RestClient::Payload::Streamed < ::RestClient::Payload::Base
  # source://rest-client//lib/restclient/payload.rb#90
  def build_stream(params = T.unsafe(nil)); end

  # source://rest-client//lib/restclient/payload.rb#94
  def length; end
...
# source://rest-client//lib/restclient/payload.rb#105
class RestClient::Payload::UrlEncoded < ::RestClient::Payload::Base
  # source://rest-client//lib/restclient/payload.rb#106
  def build_stream(params = T.unsafe(nil)); end
...
class RestClient::RawResponse
  ...
  #
  # source://rest-client//lib/restclient/raw_response.rb#22
  def initialize(tempfile, net_http_res, request); end
  ...
  # source://rest-client//lib/restclient/raw_response.rb#33
  def size; end

  # source://rest-client//lib/restclient/raw_response.rb#28
  def to_s; end
end
...
#
# source://rest-client//lib/restclient/request.rb#41
class RestClient::Request
  ...
  #
  # source://rest-client//lib/restclient/request.rb#43
  def args; end

  # @return [HTTP::CookieJar]
  #
  # source://rest-client//lib/restclient/request.rb#233
  def cookie_jar; end
  ...
  #
  # source://rest-client//lib/restclient/request.rb#222
  def cookies; end

  # source://rest-client//lib/restclient/request.rb#576
  def default_headers; end

  # source://rest-client//lib/restclient/request.rb#142
  ...
  # source://rest-client//lib/restclient/request.rb#58
  def inspect; end

  # source://rest-client//lib/restclient/request.rb#528
  def log_request; end

  # source://rest-client//lib/restclient/request.rb#539
  ...
  # @see Request#cookie_jar
  #
  # source://rest-client//lib/restclient/request.rb#244
  ...
  #
  # source://rest-client//lib/restclient/request.rb#363
  ...
  # source://rest-client//lib/restclient/request.rb#443
  def net_http_do_request(http, req, body = T.unsafe(nil), &block); end

  # source://rest-client//lib/restclient/request.rb#423
  def net_http_object(hostname, port); end

  # source://rest-client//lib/restclient/request.rb#439
  ...
  # @return [String]
  #
  # source://rest-client//lib/restclient/request.rb#462
  ...
  #
  # source://rest-client//lib/restclient/request.rb#301
  ...
  #
  # source://rest-client//lib/restclient/request.rb#405
  def proxy_uri; end
  ...
  # source://rest-client//lib/restclient/request.rb#514
  def redacted_uri; end

  # source://rest-client//lib/restclient/request.rb#524
  def redacted_url; end

  # An array of previous redirection responses
  #
  # source://rest-client//lib/restclient/request.rb#49
  ...
  # source://rest-client//lib/restclient/request.rb#155
  def ssl_ca_file; end
  ...
  #
  # source://rest-client//lib/restclient/request.rb#552
  ...
  # @return [Boolean]
  #
  # source://rest-client//lib/restclient/request.rb#164
  def use_ssl?; end
  ...
  # SSL-related options
  #
  # source://rest-client//lib/restclient/request.rb#151
  def verify_ssl; end

  private

  # source://rest-client//lib/restclient/request.rb#768
  ...
  # @return [String]
  #
  # source://rest-client//lib/restclient/request.rb#834
  ...
  #
  # source://rest-client//lib/restclient/request.rb#637
  ...
  # @return [URI]
  #
  # source://rest-client//lib/restclient/request.rb#596
  def parse_url_with_auth!(url); end

  # source://rest-client//lib/restclient/request.rb#814
  def parser; end

  # source://rest-client//lib/restclient/request.rb#612
  def print_verify_callback_warnings; end

  # source://rest-client//lib/restclient/request.rb#797
  def process_result(res, &block); end

  # source://rest-client//lib/restclient/request.rb#764
  def setup_credentials(req); end

  # source://rest-client//lib/restclient/request.rb#642
  def transmit(uri, req, payload, &block); end

  class << self
    # source://rest-client//lib/restclient/request.rb#496
    def decode(content_encoding, body); end
    ...
    #
    # source://rest-client//lib/restclient/request.rb#476
    def default_ssl_cert_store; end

    # source://rest-client//lib/restclient/request.rb#51
    def execute(args, &block); end
  end
end

# source://rest-client//lib/restclient/request.rb#55
...
class RestClient::Resource
  ...
  #
  # source://rest-client//lib/restclient/resource.rb#150
  ...
  # source://rest-client//lib/restclient/resource.rb#158
  def concat_urls(url, suburl); end

  # source://rest-client//lib/restclient/resource.rb#92
  ...
  # source://rest-client//lib/restclient/resource.rb#57
  def head(additional_headers = T.unsafe(nil), &block); end

  # source://rest-client//lib/restclient/resource.rb#112
  def headers; end

  # source://rest-client//lib/restclient/resource.rb#120
  def open_timeout; end
  ...
  # source://rest-client//lib/restclient/resource.rb#108
  def password; end

  # source://rest-client//lib/restclient/resource.rb#83
  def patch(payload, additional_headers = T.unsafe(nil), &block); end

  # source://rest-client//lib/restclient/resource.rb#65
  def post(payload, additional_headers = T.unsafe(nil), &block); end

  # source://rest-client//lib/restclient/resource.rb#74
  def put(payload, additional_headers = T.unsafe(nil), &block); end

  # source://rest-client//lib/restclient/resource.rb#116
  def read_timeout; end

  # source://rest-client//lib/restclient/resource.rb#100
  def to_s; end
  ...
  # source://rest-client//lib/restclient/resource.rb#104
  def user; end
end
...
class RestClient::Response < ::String
  ...
  # source://rest-client//lib/restclient/response.rb#71
  def body_truncated(length); end

  class << self
    # source://rest-client//lib/restclient/response.rb#41
    def create(body, net_http_res, request); end

    # source://rest-client//lib/restclient/response.rb#50
...
#
# source://rest-client//lib/restclient/utils.rb#3
module RestClient::Utils
  class << self
    ...
    # @private
    #
    # source://rest-client//lib/restclient/utils.rb#40
    ...
    #
    # source://rest-client//lib/restclient/utils.rb#73
    ...
    # @since 2.0.0
    #
    # source://rest-client//lib/restclient/utils.rb#167
    ...
    #
    # source://rest-client//lib/restclient/utils.rb#231
    ...
    #
    # source://rest-client//lib/restclient/utils.rb#186
    ...
    #   header is found.
    #
    # source://rest-client//lib/restclient/utils.rb#23
