...
export type HomePageQuery = (
  ...
  & { entry: Types.Maybe<(
    ...
    { __typename?: 'Location' }
    & Pick<Types.Location, 'approximateAddress' | 'googleMapsAreaUrl' | 'id' | 'timestamp'>
  )>, viewer: Types.Maybe<(
    { __typename?: 'User' }
    & Pick<Types.User, 'id' | 'isOwner' | 'name'>
  )> }
...
export type SyncJournalMutationVariables = Types.Exact<{
  input: Types.SyncJournalInput;
}>;


export type SyncJournalMutation = (
  { __typename?: 'Mutation' }
  & { payload: (
    { __typename?: 'SyncJournalPayload' }
    & Pick<Types.SyncJournalPayload, 'success'>
  ) }
);

export type SyncLocationMutationVariables = Types.Exact<{
  input: Types.SyncLocationInput;
}>;


export type SyncLocationMutation = (
  { __typename?: 'Mutation' }
  & { payload: (
    { __typename?: 'SyncLocationPayload' }
    & Pick<Types.SyncLocationPayload, 'success'>
  ) }
);
...
export type UserSettingsPageOAuthCredentialsFragment = (
  ...
  & Pick<Types.OAuthCredentials, 'accessToken' | 'refreshToken' | 'uid'>
);
...
export type UserSettingsPageQuery = (
  ...
  & { icloudCredentials: Types.Maybe<(
    ...
    { __typename?: 'OAuthCredentials' }
    & Pick<Types.OAuthCredentials, 'id' | 'accessToken' | 'refreshToken' | 'uid'>
  )>, viewer: Types.Maybe<(
    { __typename?: 'User' }
...
export const SyncJournalMutationDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"SyncJournalMutation"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"input"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"SyncJournalInput"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","alias":{"kind":"Name","value":"payload"},"name":{"kind":"Name","value":"syncJournal"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"input"},"value":{"kind":"Variable","name":{"kind":"Name","value":"input"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"success"}}]}}]}}]} as unknown as DocumentNode<SyncJournalMutation, SyncJournalMutationVariables>;
export const SyncLocationMutationDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"SyncLocationMutation"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"input"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"SyncLocationInput"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","alias":{"kind":"Name","value":"payload"},"name":{"kind":"Name","value":"syncLocation"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"input"},"value":{"kind":"Variable","name":{"kind":"Name","value":"input"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"success"}}]}}]}}]} as unknown as DocumentNode<SyncLocationMutation, SyncLocationMutationVariables>;
