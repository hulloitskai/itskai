...
export type SyncAllObsidianNotesMutationVariables = Types.Exact<{
  input: Types.SyncAllObsidianNotesInput;
}>;


export type SyncAllObsidianNotesMutation = (
  { __typename?: 'Mutation' }
  & { payload: (
    { __typename?: 'SyncAllObsidianNotesPayload' }
    & Pick<Types.SyncAllObsidianNotesPayload, 'success'>
  ) }
);
...
export const SyncAllObsidianNotesMutationDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"SyncAllObsidianNotesMutation"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"input"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"SyncAllObsidianNotesInput"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","alias":{"kind":"Name","value":"payload"},"name":{"kind":"Name","value":"syncAllObsidianNotes"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"input"},"value":{"kind":"Variable","name":{"kind":"Name","value":"input"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"success"}}]}}]}}]} as unknown as DocumentNode<SyncAllObsidianNotesMutation, SyncAllObsidianNotesMutationVariables>;
