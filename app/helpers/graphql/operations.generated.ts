...
export type JourneyHomePageQueryVariables = Types.Exact<{ [key: string]: never; }>;


export type JourneyHomePageQuery = (
  { __typename?: 'Query' }
  & { viewer: Types.Maybe<(
    { __typename?: 'User' }
    & Pick<Types.User, 'id' | 'isOwner' | 'name'>
...
export type JourneySessionPageQueryVariables = Types.Exact<{
  sessionId: Types.Scalars['ID']['input'];
}>;


export type JourneySessionPageQuery = (
  { __typename?: 'Query' }
  & { session: Types.Maybe<(
    { __typename?: 'JourneySession' }
    & Pick<Types.JourneySession, 'id' | 'startedAt'>
    & { participations: Array<(
      { __typename?: 'JourneySessionParticipation' }
      & Pick<Types.JourneySessionParticipation, 'goal' | 'id' | 'participantIsViewer' | 'participantName'>
    )> }
  )>, viewer: Types.Maybe<(
    { __typename?: 'User' }
    & Pick<Types.User, 'id' | 'isOwner' | 'name'>
...
export type JourneySessionPageSubscriptionVariables = Types.Exact<{
  sessionId: Types.Scalars['ID']['input'];
}>;


export type JourneySessionPageSubscription = (
  { __typename?: 'Subscription' }
  & { participation: Types.Maybe<(
    { __typename?: 'JourneySessionParticipation' }
    & Pick<Types.JourneySessionParticipation, 'id'>
  )> }
);
