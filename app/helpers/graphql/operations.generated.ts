...
export type PensieveMessageFragment = (
  ...
  & Pick<Types.PensieveMessage, 'from' | 'id' | 'timestamp' | 'isEdited' | 'text'>
);

export type PensieveMessageMessageFragment = (
  { __typename?: 'PensieveMessage' }
  & Pick<Types.PensieveMessage, 'from' | 'id' | 'isEdited' | 'text' | 'timestamp'>
);
...
export type PensieveQuery = (
  ...
  & { messages: Array<(
    { __typename?: 'PensieveMessage' }
    & Pick<Types.PensieveMessage, 'id' | 'from' | 'timestamp' | 'isEdited' | 'text'>
  )> }
);
