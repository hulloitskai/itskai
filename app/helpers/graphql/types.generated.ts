...
/** Autogenerated input type of CreatePensieveRecording */
export type CreatePensieveRecordingInput = {
  audio: UploadInput;
  /** A unique identifier for the client performing the mutation. */
  clientMutationId?: InputMaybe<Scalars['String']['input']>;
};

/** Autogenerated return type of CreatePensieveRecording. */
export type CreatePensieveRecordingPayload = {
...
export type Mutation = {
  ...
  createPensieveRecording: CreatePensieveRecordingPayload;
...
export type MutationCreatePensieveRecordingArgs = {
  input: CreatePensieveRecordingInput;
};
...
export type PensieveRecording = Node & {
...
export type Subscription = {
  ...
  journeysSessionParticipation?: Maybe<JourneysSessionParticipation>;
  location?: Maybe<LocationLog>;
  pensieveRecording: PensieveRecording;
...
export type SubscriptionPensieveRecordingArgs = {
  id: Scalars['ID']['input'];
};
...
export type User = Node & {
  ...
  name: Scalars['String']['output'];
  pensieveRecordings: Array<PensieveRecording>;
