...
export type JourneySession = Node & {
  __typename?: 'JourneySession';
  /** ID of the object. */
  id: Scalars['ID']['output'];
  participations: Array<JourneySessionParticipation>;
  startedAt: Scalars['DateTime']['output'];
  url: Scalars['String']['output'];
};

export type JourneySessionParticipation = Node & {
...
export type Query = {
  ...
  journeySession?: Maybe<JourneySession>;
...
export type Subscription = {
  ...
  activityStatus?: Maybe<Scalars['String']['output']>;
  currentlyPlaying?: Maybe<CurrentlyPlaying>;
  journeySessionParticipation?: Maybe<JourneySessionParticipation>;
  location?: Maybe<LocationLog>;
...
export type SubscriptionJourneySessionParticipationArgs = {
