...
class CurrentlyPlaying < T::Struct
  ...
  # TODO: Trigger currently playing channel!
  ...
  def self.current=(currently_playing)
    ...
    CurrentlyPlayingChannel.broadcast(currently_playing)
  end
  ...
  def self.from_json(json)
    ...
    progress_ms = T.cast(json.fetch("progress_ms"), Integer)
  ...
  def ==(other)
    ...
    when CurrentlyPlaying
      track.id == other.track.id && progress_ms == other.progress_ms
    else
      super
    end
  end
