...
FriendlyId.defaults do |config|
  ...
  # exceptions.
  # When there is no good candidate, a UUID will be appended, matching the
  ...
  # == History ==
  #
  # FriendlyId's History module adds the ability to store a log of a model's
  # slugs, so that when its friendly id changes, it's still possible to perform
  # finds by the old id.
  #
  ...
  # overrides the `should_generate_new_friendly_id?` method from the anonymous
  # module.
  #
  # config.use :slugged
